Plex API: Listen for Notifications - Plexopedia
...
## URL
```
wss://{ip\_address}:32400/:/websockets/notifications?filters={filters}&X-Plex-Token={plex\_token}
```
### Parameters
|Name|Description|
...
|filters|The type of notification filter to apply. The available filter options are outlined in the [Filters](#filters) section.|
## Return Status
...
Notification Fields|Name|Description|
...
LogSentNotification Fields|Name|Description|
...
Event Notification Filter Values|Name|Description|
...
* [How to Access the Plex Server Logs in Real-Time](https://www.plexopedia.com/blog/access-plex-server-logs-real-time/)
[ Buy me a coffee](https://buymeacoffee.com/plexopedia)
Subscribe
Name:
Email:
