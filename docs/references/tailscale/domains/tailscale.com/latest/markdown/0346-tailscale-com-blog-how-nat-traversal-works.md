...
`2.2.2.2:1234` to `5.5.5.5:5678`, it’ll make a note that incoming
packets from `5.5.5.5:5678` to `2.2.2.2:1234` are also fine. The
trusted side of the world clearly intended to communicate with
`5.5.5.5:5678`, so we should let them talk back.
...
#### NAT Cone Types
||**Endpoint-Independent NATmapping**|**Endpoint-Dependent NATmapping (all types)**|
...
||Endpoint-Independent NATmapping|Endpoint-Dependent NATmapping (dest. IP only)|
