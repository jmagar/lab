...
[Blog](/blog)|insightsJuly 02, 2025
# The evasive evitability of enshittification
This post was originally published on Avery’s personal blog as his perspective on a topic that affects nearly every software company. But because it so closely reflects the philosophy we share across the leadership and team at Tailscale — and because it captures the approach we are committed to maintaining — we’re reposting it here as an official statement of our company values and direction.
Tailscale recently [announced](https://tailscale.com/blog/series-c) our Series C fundraise. We were grateful for all the community support, but the Internet also raised a few of its collective eyebrows, wondering whether this meant the dreaded “enshittification” was coming next.
...
### [**What is enshittification?**](#what-is-enshittification)
...
### [**Enshittification is not a success mechanism.**](#enshittification-is-not-a-success-mechanism)
...
Why would I do that? Whenever you switch strategies, there has to be a threshold moment, when something fundamental changes.
#### [**Threshold moments and control**](#threshold-moments-and-control)
...
#### [**The saturation trap**](#the-saturation-trap)
...
#### [**The devil’s bargain**](#the-devils-bargain)
...
### [**Defenses against enshittification**](#defenses-against-enshittification)
...
* **Believe in competition.** Google used to have this saying they lived by: "[the competition is only a click away](https://9to5google.com/2012/04/05/larry-page-posts-update-from-the-ceo-2012″-memo-detailing-googles-aspirations/)." That was excellent framing, because it was true, and it will remain true even if Google captures 99% of the search market. The key is to cultivate a healthy fear of competing products, not of your investors or the end of hypergrowth. Enshittification helps your competitors. That would be dumb.
...
### [**Side note: Things that aren't enshittification**](#side-note-things-that-arent-enshittification)
...
Enshittification is a real, and tragic, phenomenon. But let's protect a useful term and its definition! Those things aren't it.
#### [**Epilogue: a special note to founders**](#epilogue-a-special-note-to-founders)
...
I will too.
*To view the post in its original context, please visit [https://apenwarr.ca/log/20250530](https://apenwarr.ca/log/20250530)*
Share
Author
Avery Pennarun
Author
