...
## [Solution: end-to-end encryption](#solution-end-to-end-encryption)
...
## [Incremental Zero Trust](#incremental-zero-trust)
...
[subnet router](/docs/features/subnet-routers)
...
* Tailscale supports a mesh of [subnet routers](/docs/features/subnet-routers) using any
combination of IPv4 and [IPv6](/docs/concepts/ipv6). It minimizes latency by
...
* Tailscale integrates with your [corporate SSO](/docs/integrations/identity) and
handles all issues with login, key distribution, [key rotation](/blog/rotate-ssh-keys), packet
filtering, and [access control](/docs/features/access-control).
You can read more in [How Tailscale Works](/blog/how-tailscale-works).
On this page
* [History](#history)
* [Solution: end-to-end encryption](#solution-end-to-end-encryption)
* [Incremental Zero Trust](#incremental-zero-trust)
