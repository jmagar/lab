...
[Section titled “Using the bookmarklet on Android/Chrome”](#using-the-bookmarklet-on-androidchrome)
...
```
`
javascript:window.open(`http://\<YOUR\_INSTANCE\_HERE\>/bookmarks/new?url=${encodeURIComponent(window.location)}&auto\_close`)
`
```
...
For more info see here: [https://paul.kinlan.me/use-bookmarklets-on-chrome-on-android/](https://paul.kinlan.me/use-bookmarklets-on-chrome-on-android/)
## Using the PWA (Progressive Web App) to save links using the native share sheet on Android
[Section titled “Using the PWA (Progressive Web App) to save links using the native share sheet on Android”](#using-the-pwa-progressive-web-app-to-save-links-using-the-native-share-sheet-on-android)
...
[Section titled “Using HTTP Shortcuts app on Android”](#using-http-shortcuts-app-on-android)
...
* Copy the URL of [linkding\_shortcut.json](https://raw.githubusercontent.com/sissbruecker/linkding/master/docs/src/assets/linkding_shortcut.json).
...
* Edit the `values` of `linkding\_instance` and `linkding\_api\_key`.
...
[Section titled “Create a share action on iOS for adding bookmarks to linkding”](#create-a-share-action-on-ios-for-adding-bookmarks-to-linkding)
...
* Download the [Shortcut](<https://raw.githubusercontent.com/sissbruecker/linkding/master/docs/src/assets/Add To Linkding.shortcut>) on your iOS device
...
[Section titled “Increase the font size”](#increase-the-font-size)
