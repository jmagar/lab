...
## Full backup
[Section titled “Full backup”](#full-backup)
...
```
`
docker exec -it linkding python manage.py full\_backup /etc/linkding/data/backup.zip
`
```
...
[Section titled “Alternative backup methods”](#alternative-backup-methods)
...
[Section titled “SQLite database backup”](#sqlite-database-backup)
...
[Section titled “SQLite database SQL dump”](#sqlite-database-sql-dump)
Requires [SQLite](https://www.sqlite.org/) to be installed on your host system.
...
[Section titled “Exporting bookmarks from the UI”](#exporting-bookmarks-from-the-ui)
...
### Favicons
[Section titled “Favicons”](#favicons)
Doing a backup of the icons is optional, as they can be downloaded again.
If you choose not to back up the icons, you can just restore the database and then click the *Refresh Favicons* button in the general settings.
