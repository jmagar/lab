Web UI password locked on qBittorrent NO X (qbittorrent nox) · qbittorrent/qBittorrent Wiki · GitHub
...
Chocobo1 edited this page Dec 24, 2024
&middot;
[15 revisions](/qbittorrent/qBittorrent/wiki/Web-UI-password-locked-on-qBittorrent-NO-X-(qbittorrent-nox)/_history)
...
* If you're using qbittorrent version ≥ 4.2.0, locate the line starting with `WebUI\\Password\_PBKDF2` and remove the entire line.
* If you're using qbittorrent version \< 4.2.0, locate the line starting with `WebUI\\Password\_ha1` and remove the entire line.
