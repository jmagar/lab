Developing alternate WebUIs (WIP) · qbittorrent/qBittorrent Wiki · GitHub
...
&middot;
[3 revisions](/qbittorrent/qBittorrent/wiki/Developing-alternate-WebUIs-(WIP)/_history)
### **WIP**
[](#wip)
...
[](#public-and-private-webui-files-separation)
In order to increase security, a `public` (login process handling) and `private` (WebUI functionality) separation of files is implemented (see core WebUI files' segregation as ref: [https://github.com/qbittorrent/qBittorrent/tree/master/src/webui/www](https://github.com/qbittorrent/qBittorrent/tree/master/src/webui/www))
### First steps to an alternate WebUI:
[](#first-steps-to-an-alternate-webui)
Copy the files:
[https://github.com/qbittorrent/qBittorrent/tree/master/src/webui/www](https://github.com/qbittorrent/qBittorrent/tree/master/src/webui/www) to a `\<new folder\>`
[https://github.com/qbittorrent/qBittorrent/tree/master/src/icons](https://github.com/qbittorrent/qBittorrent/tree/master/src/icons) to `\<new folder\>/public`
[https://github.com/qbittorrent/qBittorrent/tree/master/src/icons](https://github.com/qbittorrent/qBittorrent/tree/master/src/icons) to `\<new folder\>/private`
...
### References:
[](#references)
* Main WebUI PR: [https://github.com/qbittorrent/qBittorrent/pull/7610](https://github.com/qbittorrent/qBittorrent/pull/7610)
