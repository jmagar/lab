Compilation CentOS 8.x · qbittorrent/qBittorrent Wiki · GitHub
...
&middot;
[2 revisions](/qbittorrent/qBittorrent/wiki/Compilation-CentOS-8.x/_history)
...
git clone -b RC\_1\_XXXXXXXXXXX https://github.com/arvidn/libtorrent/
cd libtorrent
./autotool.sh
./configure
make -j
...
# step 5
git clone -b v4\_2\_XXXXXXXXXXX https://github.com/qbittorrent/qBittorrent
cd qBittorrent
