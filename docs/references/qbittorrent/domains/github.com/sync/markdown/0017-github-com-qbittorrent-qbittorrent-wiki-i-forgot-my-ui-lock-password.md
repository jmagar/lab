I forgot my UI lock password · qbittorrent/qBittorrent Wiki · GitHub
...
&middot;
[14 revisions](/qbittorrent/qBittorrent/wiki/I-forgot-my-UI-lock-password/_history)
...
```
[Locking]
password=\<encrypted\_password\> # this only appear on qBittorrent version \< 4.2.0
password\_PBKDF2=\<encrypted\_password\> # this only appear on qBittorrent version ≥ 4.2.0
locked=true
```
4. Save the file
5. Start qBittorrent again
## Before qBittorrent v3.3.6 on macOS
[](#before-qbittorrent-v336-on-macos)
1. Exit or kill qBittorrent process
