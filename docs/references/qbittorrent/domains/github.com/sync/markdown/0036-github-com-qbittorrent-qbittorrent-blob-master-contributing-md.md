qBittorrent/CONTRIBUTING.md at master · qbittorrent/qBittorrent · GitHub
...
## History
[History](/qbittorrent/qBittorrent/commits/master/CONTRIBUTING.md)
[](/qbittorrent/qBittorrent/commits/master/CONTRIBUTING.md)
211 lines (144 loc) · 14.9 KB
 master
# CONTRIBUTING.md
Top
...
Blame
211 lines (144 loc) · 14.9 KB
[Raw](https://github.com/qbittorrent/qBittorrent/raw/refs/heads/master/CONTRIBUTING.md)
...
The following are *not* bug reports. **Check the [wiki](https://github.com/qbittorrent/qBittorrent/wiki), [forum](https://forum.qbittorrent.org/) or other places for help and support for issues like these**:
* Explanation of qBittorrent options (see [wiki](https://github.com/qbittorrent/qBittorrent/wiki)).
* Help with WebUI setup.
* Help with embedded tracker setup.
* Help about BitTorrent in general.
* Issues with specific search plugins.
* Asking for specific builds of qBittorrent other than the current one. You can install older releases at your own risk or for regression testing purposes. Previous Windows and macOS builds are available [here](https://sourceforge.net/projects/qbittorrent/files/).
* If you want older Linux builds, you will have to compile them yourself from the corresponding commits, or ask someone on the [forum](https://forum.qbittorrent.org/) to do it for you.
...
* **Check [forum](https://forum.qbittorrent.org/) and [wiki](https://github.com/qbittorrent/qBittorrent/wiki).** You might be able to find the cause of the problem and fix things yourself.
...
* **Make sure you have [`python`](https://www.python.org/) installed correctly (remember the search functionality requires a working python installation).**
...
* For search plugin issues, report on the respective search plugin support page, or at [qbittorrent/search-plugins](https://github.com/qbittorrent/search-plugins).
...
* **Report only if you run into the issue with an official stable release, a beta release, or with the most recent upstream changes (in this last case specify the specific commit you are on).** (beta testing is encouraged 😄). We do not provide support for bugs on unofficial Windows builds.
...
* Use **screenshots/animated GIFs to help describe the issue** whenever appropriate [(How?)](https://help.github.com/articles/file-attachments-on-issues-and-pull-requests).
...
Good read: [How to Report Bugs Effectively](https://www.chiark.greenend.org.uk/~sgtatham/bugs.html)
# Suggesting enhancements/feature requests
[](#suggesting-enhancementsfeature-requests)
...
[](#before-submitting-an-enhancementfeature-request)
* Check the [wiki](https://github.com/qbittorrent/qBittorrent/wiki) and [forum](https://forum.qbittorrent.org/) for tips — you might discover that the enhancement is already available.
...
* Check in the [releases](https://github.com/qbittorrent/qBittorrent/releases) page or on the [forum](https://forum.qbittorrent.org/), see if there's already a alpha/beta version with that enhancement.
* Perform a cursory search to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
## Steps to ensure a good enhancement/feature suggestion
[](#steps-to-ensure-a-good-enhancementfeature-suggestion)
...
[](#opening-a-pull-request)
* Consult [coding guidelines](https://github.com/qbittorrent/qBittorrent/blob/master/CODING_GUIDELINES.md) first. If you are working on translation/i18n, read ["How to translate qBittorrent"](https://github.com/qbittorrent/qBittorrent/wiki/How-to-translate-qBittorrent).
* Keep your git commit history clean.
* Refer to the section about ["Git commit messages"](https://github.com/qbittorrent/qBittorrent/blob/master/CODING_GUIDELINES.md#10-git-commit-message) in the coding guidelines.
* When merge conflicts arise, do `git rebase \<target\_branch\_name\>` and fix the conflicts, don't do `git pull`. Here is a good explanation: [merging-vs-rebasing](https://www.atlassian.com/git/tutorials/merging-vs-rebasing).
...
* If your commit addresses a reported issue (for example issue #8454), append the following text to the commit body `Closes #8454.`. Example [commit](https://github.com/qbittorrent/qBittorrent/commit/c07cd440cd46345297debb47cb260f8688975f50).
* Search [pull request list](https://github.com/qbittorrent/qBittorrent/pulls) first. Others might have already implemented your idea (or got rejected already).