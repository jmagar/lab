Compilation MSVC 2010 (x86\_64) (dynamic linkage) · qbittorrent/qBittorrent Wiki · GitHub
...
# Compilation MSVC 2010 (x86\_64) (dynamic linkage)
[Jump to bottom](#wiki-pages-box)
Chocobo1 edited this page May 1, 2024
&middot;
[3 revisions](/qbittorrent/qBittorrent/wiki/Compilation-MSVC-2010-(x86_64)-(dynamic-linkage)/_history)
...
>
> Note: It is possible to use 64-bit compiler collection included in WinSDK 7.1. But if you already have
***> ANY
***> edition of Visual Studio 2010 installed with SP1 applied you won't be able to install it. Thus, using WinSDK is out of this article's scope.
>
...
2. [Source Requirements](#sourcereq)
3. [Preparing Directory Structure](#diskprep)
4. [Build Zlib](#zlib)
5. [Build OpenSSL](#ossl)
6. [Build Boost](#boost)
7. [Build libtorrent](#torrent)
8. [Build Qt](#qt)
9. [Build qBittorrent](#qbt)
10. [Using resulting binaries on different computers](#other)
#
Software Requirements
[](#software-requirements)
1. At least Windows Vista 64-bit
2. At least Visual Studio 2010 Professional Edition.
...
2. Open `Visual Studio x64 Win64 Command Prompt (2010)` usually found in `Start-\>All Programs-\>Microsoft Visual Studio 2010-\>Visual Studio Tools`
...
* Find line `$(SHLIB\_EX\_OBJ) $(CRYPTOOBJ) zlib1.lib $(EX\_LIBS)`
...
2. Open `Visual Studio x64 Win64 Command Prompt (2010)`.
