How to use qBittorrent as a tracker · qbittorrent/qBittorrent Wiki · GitHub
...
FranciscoPombal edited this page May 4, 2020
&middot;
[1 revision](/qbittorrent/qBittorrent/wiki/How-to-use-qBittorrent-as-a-tracker/_history)
# Introduction
[](#introduction)
...
By default, the tracker URL is `http://your\_public\_ip:9000/announce`.
...
1. In "Tracker URLs" field, use the URL of the embedded tracker `http://your\_public\_ip:9000/announce`
...
5. Send this newly created `.torrent` file to your friends and they will be able to download the files you are sharing using any BitTorrent client.
