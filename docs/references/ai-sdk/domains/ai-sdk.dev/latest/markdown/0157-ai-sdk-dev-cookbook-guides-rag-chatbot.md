...
17. Copy the full `DATABASE\_URL` environment variable
...
For this guide, you will need a Vercel AI Gateway API key, which gives you access to hundreds of models from different providers with one API key. If you haven't obtained your Vercel AI Gateway API key, you can do so by [signing up](https://vercel.com/d?to=/[team]/~/ai&amp;title=Go+to+AI+Gateway) on the Vercel website.
