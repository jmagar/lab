...
Copy markdown
# [Flowise Provider](#flowise-provider)
...
### [Using a Reusable Provider](#using-a-reusable-provider)
Create a file called `.env.local` and add your Flowise configuration:
```
`
FLOWISE\_BASE\_URL=https://your-flowise-instance.com
FLOWISE\_API\_KEY=your\_api\_key\_optional
`
```
```
`
...
baseUrl: process.env.FLOWISE\_BASE\_URL!,
apiKey: process.env.FLOWISE\_API\_KEY,
});
...
`
```
### [Using a One-shot Model](#using-a-one-shot-model)
```
`
