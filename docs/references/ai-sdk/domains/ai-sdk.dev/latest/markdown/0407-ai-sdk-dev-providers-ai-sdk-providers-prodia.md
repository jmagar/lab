...
Copy markdown
# [Prodia Provider](#prodia-provider)
...
apiKey: 'your-api-key', // optional, defaults to PRODIA\_TOKEN environment variable
...
It defaults to the `PRODIA\_TOKEN` environment variable.
