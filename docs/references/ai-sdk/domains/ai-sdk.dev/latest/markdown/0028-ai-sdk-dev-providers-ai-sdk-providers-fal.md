...
* **useMultipleImages** - When true, converts multiple input images to `image\_urls` array for models that support multiple images (e.g., fal-ai/flux-2/edit)
**Deprecation Notice**: snake\_case parameter names (e.g., `image\_url`,
`guidance\_scale`) are deprecated and will be removed in a future version.
