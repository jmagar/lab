...
model: inflection('inflection\_3\_with\_tools'),
...
* `inflection\_3\_pi` - "the model powering our Pi experience, including a backstory, emotional intelligence, productivity, and safety. It excels in scenarios such as customer support chatbots."
* `inflection\_3\_productivity`- "the model optimized for following instructions. It is better for tasks requiring JSON output or precise adherence to provided guidelines."
* `inflection\_3\_with\_tools` - This model seems to be in preview and it lacks an official description as of the writing of this README in 1.0.0.
|Model|Text Generation|Streaming|Image Input|Object Generation|Tool Usage|Tool Streaming|
|`inflection\_3\_pi`|✓|✓|✗|✗|✗|✗|
|`inflection\_3\_productivity`|✓|✓|✗|✗|✗|✗|
|`inflection\_3\_with\_tools`|✓|✓|✗|✗|✗|✗|
