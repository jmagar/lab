...
#### [Configurable Reasoning](#configurable-reasoning)
...
and Zod, Valibot, or raw JSON Schema. The SDK sends your schema via Mistral's `response\_format: { type: 'json\_schema' }`.
```
`
import { mistral } from '@ai-sdk/mistral';
