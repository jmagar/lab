...
```
`
AZURE\_API\_ENDPOINT=https://\<your-resource\>.services.ai.azure.com/models
AZURE\_API\_KEY=\<your-api-key\>
`
```
...
endpoint: process.env.AZURE\_API\_ENDPOINT,
apiKey: process.env.AZURE\_API\_KEY,
});
`
```
