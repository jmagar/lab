...
`
```
###### [To be able to use a model, you need to [download it first](https://lmstudio.ai/docs/basics/download-model).](#to-be-able-to-use-a-model-you-need-to-download-it-first)
### [Example](#example)
