Latest stable release: v0.40.0 | Gemini CLI
...
* fix(core): honor GOOGLE\_GEMINI\_BASE\_URL and GOOGLE\_VERTEX\_BASE\_URL by
@chrisjcthomas in
...
* fix(evals): update eval tests for invoke\_agent telemetry and project-scoped
...
* fix(core): allow Cloud Shell users to use PRO\_MODEL\_NO\_ACCESS experiment by
...
* Allow dots on GEMINI\_API\_KEY by @DKbyo in
...
**Full Changelog**:
[https://github.com/google-gemini/gemini-cli/compare/v0.39.1…v0.40.0](https://github.com/google-gemini/gemini-cli/compare/v0.39.1...v0.40.0)
