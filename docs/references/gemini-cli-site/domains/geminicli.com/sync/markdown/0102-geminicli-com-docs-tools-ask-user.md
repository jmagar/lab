Ask User Tool | Gemini CLI
[Skip to content](#_top)
# Ask User Tool
Copy as Markdown Copied!
The `ask\_user` tool lets Gemini CLI ask you one or more questions to gather
...
confirmation.
## `ask\_user` (Ask User)
[Section titled “ask\_user (Ask User)”](#ask_user-ask-user)
* **Tool name:** `ask\_user`
...
[Section titled “Multiple Choice Question”](#multiple-choice-question)
```
`
{
"questions": [
...
```
### Text Input Question
[Section titled “Text Input Question”](#text-input-question)
```
`
{
"questions": [
...
```
### Yes/No Question
[Section titled “Yes/No Question”](#yesno-question)
```
`
{
"questions": [
