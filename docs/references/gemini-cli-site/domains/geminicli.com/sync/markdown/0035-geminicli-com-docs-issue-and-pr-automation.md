Automation and triage processes | Gemini CLI
...
[Section titled “5. Automatic unassignment of inactive contributors: Unassign Inactive Issue Assignees”](#5-automatic-unassignment-of-inactive-contributors-unassign-inactive-issue-assignees)
...
the issue.
* Each cross-referenced PR is fetched to verify it is **ready for review**:
open and non-draft, or already merged. Draft PRs do not count.
* If an assignee has been assigned for **more than 7 days** and no qualifying
PR is found, they are automatically unassigned and a comment is posted
explaining the reason and how to re-claim the issue.
* Assignees who have a non-draft, open or merged PR linked to the issue are
...
[Section titled “6. Release automation”](#6-release-automation)
