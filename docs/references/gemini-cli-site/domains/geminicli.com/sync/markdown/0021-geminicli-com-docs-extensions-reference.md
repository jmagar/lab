Extension reference | Gemini CLI
...
## Manage extensions
[Section titled “Manage extensions”](#manage-extensions)
...
[Section titled “Install an extension”](#install-an-extension)
...
[Section titled “Uninstall an extension”](#uninstall-an-extension)
...
[Section titled “Disable an extension”](#disable-an-extension)
...
### Enable an extension
[Section titled “Enable an extension”](#enable-an-extension)
...
### Update an extension
[Section titled “Update an extension”](#update-an-extension)
...
[Section titled “Create an extension from a template”](#create-an-extension-from-a-template)
...
```
## Extension format
[Section titled “Extension format”](#extension-format)
...
precedence.
### Extension settings
[Section titled “Extension settings”](#extension-settings)
...
[[rule]]
mcpName = "my\_server"
toolName = "dangerous\_tool"
decision = "ask\_user"
priority = 100
[[safety\_checker]]
mcpName = "my\_server"
toolName = "write\_data"
priority = 200
[safety\_checker.checker]
type = "in-process"
name = "allowed-path"
required\_context = ["environment"]
`
```
### Themes
