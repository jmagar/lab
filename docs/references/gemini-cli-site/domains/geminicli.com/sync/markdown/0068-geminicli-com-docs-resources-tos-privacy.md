Gemini CLI: License, Terms of Service, and Privacy Notices | Gemini CLI
...
[Section titled “1. If you have signed in with your Google account to Gemini Code Assist”](#1-if-you-have-signed-in-with-your-google-account-to-gemini-code-assist)
...
[Section titled “2. If you have signed in with a Gemini API key to the Gemini Developer API”](#2-if-you-have-signed-in-with-a-gemini-api-key-to-the-gemini-developer-api)
...
[Section titled “3. If you have signed in with a Gemini API key to the Vertex AI GenAI API”](#3-if-you-have-signed-in-with-a-gemini-api-key-to-the-vertex-ai-genai-api)
