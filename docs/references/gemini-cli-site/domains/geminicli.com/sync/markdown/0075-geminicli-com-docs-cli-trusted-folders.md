...
[Section titled “Understanding folder contents: The discovery phase”](#understanding-folder-contents-the-discovery-phase)
...
[Section titled “Security warnings and errors”](#security-warnings-and-errors)
...
[Section titled “Headless and automated environments”](#headless-and-automated-environments)
...
* **Environment variable:** Set the `GEMINI\_CLI\_TRUST\_WORKSPACE=true`
...
[Section titled “Overriding the trust file location”](#overriding-the-trust-file-location)
...
`GEMINI\_CLI\_TRUSTED\_FOLDERS\_PATH` environment variable to the desired absolute
file path.
