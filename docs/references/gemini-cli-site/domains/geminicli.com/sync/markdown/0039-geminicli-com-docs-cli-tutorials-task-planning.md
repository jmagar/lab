Plan tasks with todos | Gemini CLI
...
[Section titled “Why use task planning?”](#why-use-task-planning)
...
1. **Visibility:** You see exactly what the agent plans to do *before* it
starts.
...
[Section titled “How to ask for a plan”](#how-to-ask-for-a-plan)
...
Gemini will analyze your codebase and use the `write\_todos` tool to generate a
structured list.
**Example Plan:**
...
[Section titled “How to review and iterate”](#how-to-review-and-iterate)
...
`@types/node`.”
* **Wrong order?** Tell the agent: “Let’s verify the build *after* each file,
not just at the end.”
The agent will update the todo list dynamically.
## How to execute the plan
[Section titled “How to execute the plan”](#how-to-execute-the-plan)
...
`[IN\_PROGRESS] Create tsconfig.json`).
* **Progress:** Completed tasks are marked as done.
## How to monitor progress (`Ctrl+T`)
[Section titled “How to monitor progress (Ctrl+T)”](#how-to-monitor-progress-ctrlt)
...
[Section titled “How to handle unexpected changes”](#how-to-handle-unexpected-changes)
