Advanced Model Configuration | Gemini CLI
...
errors from the API.
## 1. System Overview
[Section titled “1. System Overview”](#1-system-overview)
...
[Section titled “2. Configuration Primitives”](#2-configuration-primitives)
These settings are located under the `modelConfigs` key in your configuration
file.
### Aliases (`customAliases`)
[Section titled “Aliases (customAliases)”](#aliases-customaliases)
...
```
### Overrides (`overrides`)
[Section titled “Overrides (overrides)”](#overrides-overrides)
...
[Section titled “3. Resolution Strategy”](#3-resolution-strategy)
The `ModelConfigService` resolves the final configuration through a two-step
process:
### Step 1: Alias Resolution
[Section titled “Step 1: Alias Resolution”](#step-1-alias-resolution)
...
[Section titled “Step 2: Override Application”](#step-2-override-application)
...
* **Merging**: The configurations from the sorted overrides are merged
sequentially onto the base configuration.
## 4. Configuration Reference
[Section titled “4. Configuration Reference”](#4-configuration-reference)
The configuration follows the `ModelConfigServiceConfig` interface.
### `ModelConfig` Object
[Section titled “ModelConfig Object”](#modelconfig-object)
...
[Section titled “GenerateContentConfig (Common Parameters)”](#generatecontentconfig-common-parameters)
...
[Section titled “5. Practical Examples”](#5-practical-examples)
### Defining a Deterministic Baseline
[Section titled “Defining a Deterministic Baseline”](#defining-a-deterministic-baseline)
...
[Section titled “Agent-Specific Parameter Injection”](#agent-specific-parameter-injection)
...
[Section titled “Experimental Model Evaluation”](#experimental-model-evaluation)
