Enterprise Admin Controls | Gemini CLI
...
[Section titled “Admin Controls vs. System Settings”](#admin-controls-vs-system-settings)
...
## Available Controls
[Section titled “Available Controls”](#available-controls)
### Strict Mode
...
[Section titled “Required MCP Servers (preview)”](#required-mcp-servers-preview)
**Default**: empty
...
* `authProviderType`: (Optional) Authentication provider (`dynamic\_discovery`,
`google\_credentials`, or `service\_account\_impersonation`).
...
[Section titled “Unmanaged Capabilities”](#unmanaged-capabilities)
**Enabled/Disabled** | Default: disabled
