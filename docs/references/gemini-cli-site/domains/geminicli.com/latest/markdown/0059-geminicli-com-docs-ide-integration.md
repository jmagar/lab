...
[Section titled “VS Code companion extension”](#vs-code-companion-extension)
...
[Section titled “Agent Client Protocol (ACP)”](#agent-client-protocol-acp)
...
[Section titled “The ACP Agent Registry”](#the-acp-agent-registry)
...
[Section titled “IDE-specific integration”](#ide-specific-integration)
...
[Section titled “Other ACP-compatible IDEs”](#other-acp-compatible-ides)
...
[Section titled “VS Code companion extension errors”](#vs-code-companion-extension-errors)
#### Connection errors
...
(`GEMINI\_CLI\_IDE\_WORKSPACE\_PATH` or `GEMINI\_CLI\_IDE\_SERVER\_PORT`) to connect
...
#### Manual PID override
[Section titled “Manual PID override”](#manual-pid-override)
...
instance, you can set the `GEMINI\_CLI\_IDE\_PID` environment variable to the
process ID (PID) of your IDE.
**macOS/Linux**
Terminal window
```
`
export GEMINI\_CLI\_IDE\_PID=12345
`
```
**Windows (PowerShell)**
Terminal window
```
`
$env:GEMINI\_CLI\_IDE\_PID=12345
`
```
...
[Section titled “ACP integration errors”](#acp-integration-errors)
