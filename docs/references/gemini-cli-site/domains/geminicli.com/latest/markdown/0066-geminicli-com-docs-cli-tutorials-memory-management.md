...
## Why manage context?
[Section titled “Why manage context?”](#why-manage-context)
...
[Section titled “How to define project-wide rules (GEMINI.md)”](#how-to-define-project-wide-rules-geminimd)
...
[Section titled “Scenario: Create a project context file”](#scenario-create-a-project-context-file)
...
[Section titled “Scenario: Using the hierarchy”](#scenario-using-the-hierarchy)
...
[Section titled “How to teach the agent facts (Memory)”](#how-to-teach-the-agent-facts-memory)
...
[Section titled “Scenario: Saving a memory”](#scenario-saving-a-memory)
Just tell the agent to remember something.
**Prompt:** `Remember that I prefer using 'const' over 'let' wherever possible.`
The agent will use the `save\_memory` tool to store this fact in your global
memory file.
**Prompt:** `Save the fact that the staging server IP is 10.0.0.5.`
### Scenario: Using memory in conversation
[Section titled “Scenario: Using memory in conversation”](#scenario-using-memory-in-conversation)
...
[Section titled “How to manage and inspect context”](#how-to-manage-and-inspect-context)
As your project grows, you might want to see exactly what instructions the agent
is following.
### Scenario: View active context
[Section titled “Scenario: View active context”](#scenario-view-active-context)
...
[Section titled “Scenario: Refresh context”](#scenario-refresh-context)
...
* **Use negative constraints:** Explicitly telling the agent what *not* to do
