Local development guide | Gemini CLI
...
### View traces
[Section titled “View traces”](#view-traces)
You can view traces using Genkit Developer UI, Jaeger, or Google Cloud.
#### Use Genkit
[Section titled “Use Genkit”](#use-genkit)
...
#### Use Jaeger
[Section titled “Use Jaeger”](#use-jaeger)
...
the traces.
#### Use Google Cloud
[Section titled “Use Google Cloud”](#use-google-cloud)
...
[Section titled “Instrument code with traces”](#instrument-code-with-traces)
...
attributes: {
[GEN\_AI\_AGENT\_NAME]: 'gemini-cli',
},
},
async ({ metadata }) =\> {
