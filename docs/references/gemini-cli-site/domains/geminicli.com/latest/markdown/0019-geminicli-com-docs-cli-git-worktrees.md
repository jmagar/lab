Git Worktrees (experimental) | Gemini CLI
...
[Section titled “How to enable Git worktrees”](#how-to-enable-git-worktrees)
...
[Section titled “How to use Git worktrees”](#how-to-use-git-worktrees)
...
[Section titled “How to exit a Git worktree session”](#how-to-exit-a-git-worktree-session)
...
[Section titled “Resuming work in a Git worktree”](#resuming-work-in-a-git-worktree)
...
gemini --resume \<session\_id\>
`
```
## Managing Git worktrees manually
[Section titled “Managing Git worktrees manually”](#managing-git-worktrees-manually)
