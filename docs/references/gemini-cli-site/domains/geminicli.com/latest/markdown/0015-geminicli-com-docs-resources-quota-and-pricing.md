Gemini CLI: Quotas and pricing | Gemini CLI
...
### Individuals
[Section titled “Individuals”](#individuals)
...
**Supported tiers:** *- Tiers not listed above, including Google AI Plus, are
not supported.*
...
[Section titled “Through your organization”](#through-your-organization)
...
in to your Google Workspace Account”.
**Supported tiers:** *- Tiers not listed above, including Workspace AI
Standard/Plus and AI Expanded, are not supported.*
...
[Section titled “Vertex AI (regular mode)”](#vertex-ai-regular-mode)
...
### Gemini API key
[Section titled “Gemini API key”](#gemini-api-key)
...
[Section titled “Check usage and limits”](#check-usage-and-limits)
