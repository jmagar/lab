Model steering (experimental) | Gemini CLI
...
[Section titled “Enabling model steering”](#enabling-model-steering)
...
[Section titled “Using model steering”](#using-model-steering)
...
* **Real-time update:** The hint is delivered to the agent at the beginning of
