...
[Section titled “Existing integrations using ACP”](#existing-integrations-using-acp)
...
[Section titled “Architecture and protocol basics”](#architecture-and-protocol-basics)
...
### Extending with MCP
[Section titled “Extending with MCP”](#extending-with-mcp)
...
[Section titled “Capabilities and supported methods”](#capabilities-and-supported-methods)
The ACP protocol exposes a number of methods for ACP clients (for example IDEs)
to control Gemini CLI.
### Core methods
[Section titled “Core methods”](#core-methods)
...
* `unstable\_setSessionModel`: Changes the model for the current session.
### File system proxy
[Section titled “File system proxy”](#file-system-proxy)
...
* `GEMINI\_TELEMETRY\_ENABLED=true`
* `GEMINI\_TELEMETRY\_TARGET=local`
* `GEMINI\_TELEMETRY\_OUTFILE=/path/to/your/log.json`
