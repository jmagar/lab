Gemini CLI extension best practices | Gemini CLI
...
[Section titled “Structure your extension”](#structure-your-extension)
...
### Iterate with `link`
[Section titled “Iterate with link”](#iterate-with-link)
...
[Section titled “Use GEMINI.md effectively”](#use-geminimd-effectively)
...
building extensions.
### Minimal permissions
[Section titled “Minimal permissions”](#minimal-permissions)
...
sufficient.
If your extension uses powerful tools like `run\_shell\_command`, restrict them in
your `gemini-extension.json` file:
```
`
{
"name": "my-safe-extension",
"excludeTools": ["run\_shell\_command(rm -rf \*)"]
}
`
```
...
[Section titled “Secure sensitive settings”](#secure-sensitive-settings)
...
```
### Clean artifacts
[Section titled “Clean artifacts”](#clean-artifacts)
...
`node\_modules/` and `src/` to minimize download size.
## Test and verify
[Section titled “Test and verify”](#test-and-verify)
...
### MCP server failures
[Section titled “MCP server failures”](#mcp-server-failures)
...
### Command conflicts
[Section titled “Command conflicts”](#command-conflicts)
