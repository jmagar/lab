...
When you approve a tool that modifies the file system (like `write\_file` or
...
located in your home directory (`\~/.gemini/history/\<project\_hash\>`). This
...
`\~/.gemini/tmp/\<project\_hash\>/checkpoints`.
...
`2025-06-22T10-00-00\_000Z-my-file.txt-write\_file`).
...
```
`
/restore \<checkpoint\_file\>
`
```
For example:
```
`
/restore 2025-06-22T10-00-00\_000Z-my-file.txt-write\_file
`
```
