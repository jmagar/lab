...
Happy watching!
- Joshua
## Key Release Notes/Breaking Changes[​](#key-release-notesbreaking-changes)
...
## The Big Changes[​](#the-big-changes)
...
### Core Server & Networking[​](#core-server--networking)
...
### Transcoding & FFmpeg[​](#transcoding--ffmpeg)
...
### Scanning, Library & Playlist Management[​](#scanning-library--playlist-management)
