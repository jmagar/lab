...
```
`
echo fs.inotify.max\_user\_watches=524288 | sudo tee -a /etc/sysctl.d/40-max-user-watches.conf && sudo sysctl -p
`
```
...
## Uninstalling Jellyfin on MacOS[​](#uninstalling-jellyfin-on-macos)
...
`
```
## Fix Admin User Permissions[​](#fix-admin-user-permissions)
...
`
```
## Text Not Rendering Properly[​](#text-not-rendering-properly)
...
## Not Showing Active Devices[​](#not-showing-active-devices)
...
### LXC specific issues[​](#lxc-specific-issues)
