Excluding Files and Directories | Jellyfin
...
## Excluding whole directories[​](#excluding-whole-directories)
...
`
```
## Excluding specific files or subdirectories[​](#excluding-specific-files-or-subdirectories)
