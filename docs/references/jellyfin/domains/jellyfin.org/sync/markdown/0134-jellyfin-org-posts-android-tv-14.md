Android TV version 0.14 | Jellyfin
...
- Niels
## Minimum server version changed to 10.8[​](#minimum-server-version-changed-to-108)
...
Go to the [download](https://jellyfin.org/downloads/) page or read the [installing](/docs/general/installation) documentation to start updating.
## Improved login[​](#improved-login)
...
## Support for external trailers[​](#support-for-external-trailers)
...
## Changes to the Live TV guide[​](#changes-to-the-live-tv-guide)
...
## Improved browsing grid[​](#improved-browsing-grid)
...
## New crash reporting[​](#new-crash-reporting)
...
## Markdown support for item & server descriptions[​](#markdown-support-for-item--server-descriptions)
...
## Rewrite of WebSocket code[​](#rewrite-of-websocket-code)
