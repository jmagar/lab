...
## The Library Database conversion to EF Core is complete![​](#the-library-database-conversion-to-ef-core-is-complete)
...
### Deduplication and Migrations[​](#deduplication-and-migrations)
...
### Startup UI and Log Viewer[​](#startup-ui-and-log-viewer)
...
### Internal Backup & Restore Support[​](#internal-backup--restore-support)
...
### Aggressive in-memory Database Caching[​](#aggressive-in-memory-database-caching)
...
### Improved Locking Behavior[​](#improved-locking-behavior)
...
## Removal of ARM32 (armhf) support[​](#removal-of-arm32-armhf-support)
...
## Deprecation of internal TLS/SSL support[​](#deprecation-of-internal-tlsssl-support)
...
## Free Space Checks[​](#free-space-checks)
...
### Administrator Experience[​](#administrator-experience)
...
### Transcoding and Media Handling[​](#transcoding-and-media-handling)
...
## Client Development Changes[​](#client-development-changes)
