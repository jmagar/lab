Jellyfin Web Configuration | Jellyfin
...
### Debian/Ubuntu/Fedora/CentOS Packages[​](#debianubuntufedoracentos-packages)
...
`
```
## Privacy-focused changes[​](#privacy-focused-changes)
...
### YouTube Trailers[​](#youtube-trailers)
