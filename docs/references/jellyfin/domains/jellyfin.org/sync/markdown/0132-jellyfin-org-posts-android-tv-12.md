Android TV v0.12 | Jellyfin
[Skip to main content](#__docusaurus_skipToContent_fallback)
Today we're bringing the Android TV app to 2021 with a modern design and tons of other changes.
Over 400[1](#user-content-fn-1-05262e) pull requests containing 2400+ commits, 750+ changed files with 54000+ changed lines of code by roughly 50 contributors[2](#user-content-fn-2-05262e). This is the biggest update to the app we ever worked on. I'll talk a bit about why it is this big and why it took so long later in the post. But let's start with the part you probably came for: **new features!**
...
## Updated user interface design[​](#updated-user-interface-design)
...
### Themes[​](#themes)
The web client supported theming since forever but the Android TV app did not. That changes today with the introduction of three themes: Muted Purple together with Dark (Default) and Classic Emerald are now available in the app to supports basic theming. We're planning to expand this feature in the future with more themes and more variety between them. *Maybe we should add a light theme?*
### New video player design[​](#new-video-player-design)
...
Together with all the visible changes we've made tons of fixes to the code. We're now using [Kotlin](https://kotlinlang.org) as our primary language to help us writing type-safe code, migrated completely to [AndroidX](https://developer.android.com/jetpack/androidx/) for better device compatibility and made a brand new [SDK](https://github.com/jellyfin/jellyfin-sdk-kotlin) that is slowly being integrated for a more secure and stable connetion with your server. All of these modernizations in the code allow us to more frequently release updates.
...
1. [v0.12.0 project filtered by merged pull requests](https://github.com/jellyfin/jellyfin-androidtv/projects/2?card_filter_query=is:pr+is:merged) [↩](#user-content-fnref-1-05262e)
2. [Git comparison between v0.11.5 and v0.12.0-beta.7](https://github.com/jellyfin/jellyfin-androidtv/compare/v0.11.5...v0.12.0-beta.7) [↩](#user-content-fnref-2-05262e)
* [New authentication flow](#new-authentication-flow)
* [Updated user interface design](#updated-user-interface-design)
* [Themes](#themes)
* [New video player design](#new-video-player-design)
