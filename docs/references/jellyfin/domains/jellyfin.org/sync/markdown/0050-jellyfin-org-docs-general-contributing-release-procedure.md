...
### X: Major Versions[​](#x-major-versions)
* Breaks compatibility with the HTTP or plugin APIs
### Y: Minor Versions[​](#y-minor-versions)
* Introduces new features
* Makes minor backwards-compatible API changes
### Z: Hotfix Versions[​](#z-hotfix-versions)
* Critical bug fixes or minor changes
## General Release Philosophy[​](#general-release-philosophy)
...
2. Once `master` is in a generally stable state after extensive work, announce a "golden nightly" is incoming via the [jellyfin-dev](https://matrix.to/#/#jellyfin-dev:matrix.org) Matrix/Riot channel and Forum.
3. Collect testing information and repeat as needed.
4. Once the release is considered stable and working, announce full PR freeze via the [jellyfin-dev](https://matrix.to/#/#jellyfin-dev:matrix.org) Matrix/Riot channel.
...
#### Release Web Client[​](#release-web-client)
...
### Hotfix Release Procedure[​](#hotfix-release-procedure)
...
5. For the main [jellyfin](https://github.com/jellyfin/jellyfin) repository, bump the version of the repository to the new hotfix version with the `bump\_version` script and commit the result with the message "Bump version for X.Y.Z".
6. Push the updated release branch to GitHub.
...
4. Announce the new release in the [jellyfin-announce](https://matrix.to/#/#jellyfin-announce:matrix.org) channel and anywhere else as required.
* [Versioning](#versioning)
* [X: Major Versions](#x-major-versions)
* [Y: Minor Versions](#y-minor-versions)
* [Z: Hotfix Versions](#z-hotfix-versions)
