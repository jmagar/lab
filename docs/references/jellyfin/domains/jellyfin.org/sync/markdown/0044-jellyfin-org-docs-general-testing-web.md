Testing Jellyfin Web Clients | Jellyfin
[Skip to main content](#__docusaurus_skipToContent_fallback)
On this page
## Weekly Unstable Builds[​](#weekly-unstable-builds)
...
## Testing pull requests from Cloudflare Pages Deployments[​](#testing-pull-requests-from-cloudflare-pages-deployments)
...
## Testing from source code[​](#testing-from-source-code)
...
### Installing dependencies and starting a development server[​](#installing-dependencies-and-starting-a-development-server)
