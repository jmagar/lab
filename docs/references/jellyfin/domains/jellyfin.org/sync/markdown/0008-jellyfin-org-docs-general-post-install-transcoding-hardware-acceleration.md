...
## Supported Acceleration Methods[​](#supported-acceleration-methods)
...
## Full & Partial Acceleration[​](#full--partial-acceleration)
...
built with gcc 12.2.0 (crosstool-NG 1.25.0.90\_cf9beb1)
...
`
```
caution
...
## Configure & Verify Hardware Acceleration[​](#configure--verify-hardware-acceleration)
...
|AMD|[AMF (Windows)](/docs/general/post-install/transcoding/hardware-acceleration/amd#windows-setups)|[VideoToolbox](/docs/general/post-install/transcoding/hardware-acceleration/apple)|[VAAPI (AMD)](/docs/general/post-install/transcoding/hardware-acceleration/amd#linux-setups)|
|Apple|N/A|[VideoToolbox](/docs/general/post-install/transcoding/hardware-acceleration/apple)|N/A|
|Intel|[QSV (Windows)](/docs/general/post-install/transcoding/hardware-acceleration/intel#windows-setups)|[VideoToolbox](/docs/general/post-install/transcoding/hardware-acceleration/apple)|[QSV (Linux)](/docs/general/post-install/transcoding/hardware-acceleration/intel#linux-setups)|
|Nvidia|[NVENC (Windows)](/docs/general/post-install/transcoding/hardware-acceleration/nvidia#windows-setups)|N/A|[NVENC (Linux)](/docs/general/post-install/transcoding/hardware-acceleration/nvidia#linux-setups)|
|Rockchip|N/A|N/A|[RKMPP](/docs/general/post-install/transcoding/hardware-acceleration/rockchip)|
## Remote Hardware Acceleration[​](#remote-hardware-acceleration)
...
## Hardware Accelerated Tone-mapping[​](#hardware-accelerated-tone-mapping)
...
## Tips For Hardware Acceleration[​](#tips-for-hardware-acceleration)
...
## Raspberry Pi Hardware Acceleration Support Deprecation[​](#raspberry-pi-hardware-acceleration-support-deprecation)
