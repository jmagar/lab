...
* Internet Connection: At least 20 Mbps upload bandwidth for remote access.2
...
### Hardware Encoder Quality[​](#hardware-encoder-quality)
...
### Server with Integrated Graphics[​](#server-with-integrated-graphics)
...
### Server with Dedicated Graphics[​](#server-with-dedicated-graphics)
...
### Servers without GPUs[​](#servers-without-gpus)
...
### Low Power Servers[​](#low-power-servers)
...
### Potentially Problematic Hardware[​](#potentially-problematic-hardware)
...
#### Software HDR to SDR Tone-mapping[​](#software-hdr-to-sdr-tone-mapping)
...
AMD graphics is not recommended for Jellyfin, this information is solely provided for reference. Further reading on AMD VCE supported codecs: [https://en.wikipedia.org/wiki/Video\_Coding\_Engine](https://en.wikipedia.org/wiki/Video_Coding_Engine).
...
1 Although the hardware does support AV1 decoding, [ffmpeg does not yet support it](https://trac.ffmpeg.org/ticket/10642).
caution
