Please refresh your Jellyfin Apt key on Debian/Ubuntu | Jellyfin
...
```
`
wget -O- https://repo.jellyfin.org/jellyfin\_team.gpg.key | sudo apt-key add -
`
```
...
Reddit thread for reference: [https://www.reddit.com/r/jellyfin/comments/jz6u9o/debian\_ubuntu\_repo\_users\_our\_key\_is\_expiring/](https://www.reddit.com/r/jellyfin/comments/jz6u9o/debian_ubuntu_repo_users_our_key_is_expiring/)
Thanks,
Joshua