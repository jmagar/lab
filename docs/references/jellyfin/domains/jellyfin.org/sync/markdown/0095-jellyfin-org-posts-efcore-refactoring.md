EFCore refactoring is here | Jellyfin
...
- JPVenson
## What exactly have we done[​](#what-exactly-have-we-done)
[Joshua’s blog post](/posts/efcore-refactoring-incoming) in November 2024 outlined much of what we aimed to achieve, and I want to take this opportunity to address the feedback and questions we've received, clarifying a few key points.
...
## What haven't we done[​](#what-havent-we-done)
While we are currently working on it, the current code does **not** add support for alternative database providers on its own.
