...
### Downloading the Jellyfin Image[​](#downloading-the-jellyfin-image)
...
#### Network and Port Settings[​](#network-and-port-settings)
...
Browse to `http://SERVER\_IP:8096` in a browser on a other device to finish setting up the Jellyfin server.
