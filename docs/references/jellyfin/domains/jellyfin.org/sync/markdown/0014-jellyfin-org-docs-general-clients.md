...
### Requirements for Inclusion in All Clients[​](#requirements-for-inclusion-in-all-clients)
...
### Requirements for Inclusion as a Recommended Client[​](#requirements-for-inclusion-as-a-recommended-client)
...
### Removal from the clients list[​](#removal-from-the-clients-list)
...
## Additional Client Documentation[​](#additional-client-documentation)
[## 📄️Codec Support
