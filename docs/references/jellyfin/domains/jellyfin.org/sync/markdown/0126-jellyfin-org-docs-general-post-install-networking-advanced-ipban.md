...
```
`
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/DigitalRuby/IPBan/master/IPBanCore/Windows/Scripts/install\_latest.ps1'))
`
```
Config
```
...
\<PathAndMask\>
C:/ProgramData/Jellyfin/Server/log/log\_{year-local}{month-local}{day-local}.log
\</PathAndMask\>
\<FailedLoginRegex\>
\<![CDATA[
