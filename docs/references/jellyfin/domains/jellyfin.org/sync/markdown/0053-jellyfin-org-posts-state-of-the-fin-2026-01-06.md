...
### Jellyfin Turns 7[​](#jellyfin-turns-7)
...
### 10.11 Release Status[​](#1011-release-status)
...
### Jellyfin Web vNext (aka 10.12 / 12.0)[​](#jellyfin-web-vnext-aka-1012--120)
...
### Jellyfin for Android TV[​](#jellyfin-for-android-tv)
...
### Jellyfin for Xbox[​](#jellyfin-for-xbox)
...
### Jellyfin for Roku[​](#jellyfin-for-roku)
...
### Swiftfin[​](#swiftfin)
#### Swiftfin 1.4 is out now![​](#swiftfin-14-is-out-now)
...
#### Swiftfin Roadmap[​](#swiftfin-roadmap)
...
* *Issues that impact tvOS but are part of 1.4 or 1.5 will end up in the version milestone instead of this one. Once tvOS is released, it should mirror our existing 1.X structure and iOS.*
...
### Other TV Platforms[​](#other-tv-platforms)
