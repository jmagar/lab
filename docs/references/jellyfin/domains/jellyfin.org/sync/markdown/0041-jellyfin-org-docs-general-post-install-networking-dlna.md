...
Make sure to open this port to your local network. You will find more information about how to do this in the [Firewall guide](/docs/general/post-install/networking/#firewall--port-forwarding).
