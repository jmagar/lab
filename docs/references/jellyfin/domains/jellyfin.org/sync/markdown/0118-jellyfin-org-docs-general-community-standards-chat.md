...
* If you are using Jellyfin for commercial purposes or within a business setting, please review our [Commercial Support Policy](/docs/general/community-standards/commercial-support).
* Considering that the chat rooms are more likely to see users less experienced with tech, there are additional rules about technical misinformation. Please see the [Technical Misinformation Rules](#technical-misinformation-rules) below.
...
## Chat Rooms Specifics[​](#chat-rooms-specifics)
...
* On Matrix, you will see many accounts with the IDs `@jfdiscord\_\<some numbers\>:im.jellyfin.org`. These are bridged users from Discord.
...
* Do NOT directly message team members or fellow users or send them friend requests unless you have been asked to do so. Please ask all questions in the wider community channels instead. If you wish to contact the team privately, please refer to the [Contact and Punishments](#contact-and-punishments) section
## Technical Misinformation Rules[​](#technical-misinformation-rules)
...
## Contact and Punishments[​](#contact-and-punishments)
