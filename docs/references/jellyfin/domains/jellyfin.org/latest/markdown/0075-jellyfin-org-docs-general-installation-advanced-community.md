Community Maintained Packages | Jellyfin
...
## Fedora, CentOS and other RPM distributions[​](#fedora-centos-and-other-rpm-distributions)
...
`
```
### Manual installation via the .rpm packages[​](#manual-installation-via-the-rpm-packages)
