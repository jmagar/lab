...
* Password: *The password for the user created previously* (for example: Jellyfin\_password)
* Press Save
note
...
1. Adjust the Jellyfin TVHeadend plugin to establish the connection.
...
* Username: *The user created previously* (for example: Jellyfin)
* Password: *The password created previously* (for example: Jellyfin\_password)
note
