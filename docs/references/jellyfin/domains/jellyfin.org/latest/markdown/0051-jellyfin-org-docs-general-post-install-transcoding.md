...
## Bitrate and Resolution[​](#bitrate-and-resolution)
...
If your hardware supports this you can enable [hardware acceleration](/docs/general/post-install/transcoding/hardware-acceleration/) for much faster transcoding. Jellyfin
...
## Types of Transcoding[​](#types-of-transcoding)
...
## HDR to SDR Tone-mapping[​](#hdr-to-sdr-tone-mapping)
