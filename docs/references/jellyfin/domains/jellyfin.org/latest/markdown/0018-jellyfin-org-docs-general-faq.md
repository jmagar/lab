...
On this page
## Why fork Emby? Why did you start this project?[​](#why-fork-emby-why-did-you-start-this-project)
We explain the rationale for our fork on our [about page](/docs/general/about).
## Why don't you support my favorite client or feature?[​](#why-dont-you-support-my-favorite-client-or-feature)
...
## When will release {X} happen? When will feature {X} be available?[​](#when-will-release-x-happen-when-will-feature-x-be-available)
...
## I'm having problems with Jellyfin, how do I get help?[​](#im-having-problems-with-jellyfin-how-do-i-get-help)
Please see our [getting help](/docs/general/getting-help) page for details on where to engage the community.
## Why is my media not showing up in Jellyfin?[​](#why-is-my-media-not-showing-up-in-jellyfin)
...
## How do I support this project?[​](#how-do-i-support-this-project)
