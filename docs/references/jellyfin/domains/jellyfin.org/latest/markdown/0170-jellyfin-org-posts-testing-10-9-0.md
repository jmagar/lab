...
- Joshua
## What's Different and The Release Plan[​](#whats-different-and-the-release-plan)
...
Once 10.9.0 is fully released, you can switch back easily by reinstalling the new stable version, and changing back to the stable plugin manifest (URL "[https://repo.jellyfin.org/files/plugin/manifest.json](https://repo.jellyfin.org/files/plugin/manifest.json)").
...
## Information for 3rd Party Clients[​](#information-for-3rd-party-clients)
