...
### Enable chapter image extraction[​](#enable-chapter-image-extraction)
This will enable the Chapter image feature.
### Extract chapter images during the library scan[​](#extract-chapter-images-during-the-library-scan)
