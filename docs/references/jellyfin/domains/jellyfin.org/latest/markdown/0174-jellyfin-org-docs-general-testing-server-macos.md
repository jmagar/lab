...
`
```
## Get Unstable Server[​](#get-unstable-server)
...
## Get Jellyfin FFmpeg[​](#get-jellyfin-ffmpeg)
...
## Prepare The Unstable Server and FFmpeg[​](#prepare-the-unstable-server-and-ffmpeg)
...
`
```
## Run The Unstable Server[​](#run-the-unstable-server)
