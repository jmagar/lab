...
`
```
The official repository manifest for [stable plugins](https://repo.jellyfin.org/releases/plugin/manifest-stable.json) can be used for more examples.
You can also find the [deprecated manifest](https://repo.jellyfin.org/releases/plugin/manifest.json) on the same domain for the old format.
...
Plugins do have [official documentation](https://jellyfin.org/docs/plugin-api/MediaBrowser.Model.Updates.html) on our DocFX instance.
...
# Tools
One excellent tool that might help with repository management is [jellyfin-plugin-repository-manager](https://github.com/oddstr13/jellyfin-plugin-repository-manager) by Oddstr13, a frequent contributor.
He did mention that his tool works much better with nginx than GitHub releases, but feel free to check it out!
Another useful tool might be the [jellyfin-build](https://github.com/jellyfin/jellyfin-build) repository, which used to be the method used for updates on the official repository.
...
There was one for [select menus](https://github.com/jellyfin/jellyfin-web/blob/release-10.5.z/src/legacy/selectmenu.js) and yet another for [checkbox](https://github.com/jellyfin/jellyfin-web/blob/release-10.5.z/src/legacy/fnchecked.js) elements.
