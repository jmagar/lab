Warning for Unstable - EFCore refactoring is coming | Jellyfin
...
- Joshua
## What is EFCore, and why are we migrating to it?[​](#what-is-efcore-and-why-are-we-migrating-to-it)
...
## There Will Be Bugs[​](#there-will-be-bugs)
...
## What we will be focusing on[​](#what-we-will-be-focusing-on)
...
## What this actually means for you[​](#what-this-actually-means-for-you)
