Live TV Setup Guide | Jellyfin
[Skip to main content](#__docusaurus_skipToContent_fallback)
On this page
## Add a TV Tuner to Jellyfin (Automatic Discovery)[​](#add-a-tv-tuner-to-jellyfin-automatic-discovery)
...
## Add a TV Tuner to Jellyfin (Manual Setup)[​](#add-a-tv-tuner-to-jellyfin-manual-setup)
...
### HDHomeRun Specific Options[​](#hdhomerun-specific-options)
...
### M3U Tuner Specific Options[​](#m3u-tuner-specific-options)
...
## Adding Guide Data[​](#adding-guide-data)
