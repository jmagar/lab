...
On this page
## Usage of the Jellyfin name[​](#usage-of-the-jellyfin-name)
...
## Usage of the Jellyfin logo[​](#usage-of-the-jellyfin-logo)
...
* Git repositories and files using the name should use lowercase `jellyfin` for convenience on case-sensitive filesystems. `build-jellyfin.ps1`, `jellyfin\_3.5.2-1\_all.deb`, etc.
* Configuration directories can use either depending on operating system conventions. `/var/lib/jellyfin`, `AppData/Jellyfin`
## Icons and Other Assets[​](#icons-and-other-assets)
warning
