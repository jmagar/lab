...
On this page:
* [
Share on X](<https://twitter.com/intent/tweet?url=https://qdrant.tech/blog/case-study-bloop/&amp;text=Powering Bloop semantic code search>)
* [
Share on LinkedIn](https://www.linkedin.com/sharing/share-offsite/?url=https://qdrant.tech/blog/case-study-bloop/)
...
[https://github.com/qdrant/qdrant](https://github.com/qdrant/qdrant) or managed cloud solution [https://cloud.qdrant.io/](https://cloud.qdrant.io/).
## The Problem
...
complexity, there is still plenty of intrinsic complexity[1](#fn:1) in the problems we solve, and with software eating
...
intrinsic complexity is the sort that we face when trying to describe, let alone solve the problem.[&#8617;&#xfe0e;](#fnref:1)
