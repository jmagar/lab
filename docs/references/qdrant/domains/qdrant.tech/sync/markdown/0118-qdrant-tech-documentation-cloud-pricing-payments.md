...
*
* Billing & Payments# Qdrant Cloud Billing & Payments
...
Your payment method is charged at the beginning of each month for the previous month&rsquo;s usage. There is no difference in pricing between the different payment methods.
...
You will be redirected to the Billing Details screen in the [Qdrant Cloud Console](https://cloud.qdrant.io/). From there you can start to create Qdrant database clusters.
### Azure Marketplace
Our [Azure Marketplace](<https://portal.azure.com/#view/Microsoft_Azure_Marketplace/GalleryItemDetailsBladeNopdl/id/qdrantsolutionsgmbh1698769709989.qdrant-db/selectionMode~/false/resourceGroupId//resourceGroupLocation//dontDiscardJourney~/false/selectedMenuId/home/launchingContext~/{"galleryItemId":"qdrantsolutionsgmbh1698769709989.qdrant-dbqdrant_cloud_unit","source":["GalleryFeaturedMenuItemPart","VirtualizedTileDetails"],"menuItemId":"home","subMenuItemId":"Search results","telemetryId":"1df5537b-8b29-4200-80ce-0cd38c7e0e56"}/searchTelemetryId/6b44fb90-7b9c-4286-aad8-59f88f3cc2ff>) listing streamlines access to Qdrant for users who rely on Microsoft Azure for hosting and application development.
To subscribe:
1. Go to Billing Details screen in the [Qdrant Cloud Console](https://cloud.qdrant.io/)
...
On this page:
* [
View as Markdown](https://qdrant.tech/documentation/cloud-pricing-payments/index.md)
* [
