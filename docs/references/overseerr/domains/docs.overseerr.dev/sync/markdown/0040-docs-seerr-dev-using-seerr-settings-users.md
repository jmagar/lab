...
On this page
## Enable Local Sign-In[​](#enable-local-sign-in)
...
## Enable Jellyfin/Emby/Plex Sign-In[​](#enable-jellyfinembyplex-sign-in)
...
This setting is **enabled** by default.
## Enable New Jellyfin/Emby/Plex Sign-In[​](#enable-new-jellyfinembyplex-sign-in)
...
This setting is **enabled** by default.
## Global Movie Request Limit & Global Series Request Limit[​](#global-movie-request-limit--global-series-request-limit)
