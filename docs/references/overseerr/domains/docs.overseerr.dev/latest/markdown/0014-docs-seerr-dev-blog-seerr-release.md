...
## What's new in Seerr for Overseerr users[​](#whats-new-in-seerr-for-overseerr-users)
...
## What's new since the previous Jellyseerr release[​](#whats-new-since-the-previous-jellyseerr-release)
...
### PNPM v10 Upgrade[​](#pnpm-v10-upgrade)
...
### TVDB Metadata Provider (Experimental)[​](#tvdb-metadata-provider-experimental)
...
### DNS Caching (Experimental)[​](#dns-caching-experimental)
...
### AniDB for Jellyfin Libraries[​](#anidb-for-jellyfin-libraries)
...
### Dynamic Placeholders in Webhook URLs[​](#dynamic-placeholders-in-webhook-urls)
...
### Optional Images in Notifications[​](#optional-images-in-notifications)
...
important
## Note for PostgreSQL users (optional)[​](#note-for-postgresql-users-optional)
