...
### Administrator Permissions (Required)[​](#administrator-permissions-required)
...
### User Activation (Required)[​](#user-activation-required)
...
* **Auto-Request Movies** (for movie auto-requests)
* **Auto-Request Series** (for TV series auto-requests)
* Optionally enable **Auto-Approve** permissions for automatic approval
