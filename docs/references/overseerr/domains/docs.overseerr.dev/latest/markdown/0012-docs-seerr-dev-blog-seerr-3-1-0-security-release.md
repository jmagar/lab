Seerr v3.1.0: Critical Security Release | Seerr
...
### [CVE-2026-27707](https://github.com/seerr-team/seerr/security/advisories/GHSA-rc4w-7m3r-c2f7) — Unauthenticated Account Registration via Jellyfin Endpoint (High)[​](#cve-2026-27707--unauthenticated-account-registration-via-jellyfin-endpoint-high)
...
### [CVE-2026-27793](https://github.com/seerr-team/seerr/security/advisories/GHSA-f7xw-jcqr-57hp) — Broken Object-Level Authorization in User Profile Endpoint (Medium)[​](#cve-2026-27793--broken-object-level-authorization-in-user-profile-endpoint-medium)
...
### [CVE-2026-27792](https://github.com/seerr-team/seerr/security/advisories/GHSA-gx3h-3jg5-q65f) — Missing Authentication on Push Subscription Endpoints (Medium)[​](#cve-2026-27792--missing-authentication-on-push-subscription-endpoints-medium)
...
* [Security Vulnerabilities](#security-vulnerabilities)
* [CVE-2026-27707 — Unauthenticated Account Registration via Jellyfin Endpoint (High)](#cve-2026-27707--unauthenticated-account-registration-via-jellyfin-endpoint-high)
* [CVE-2026-27793 — Broken Object-Level Authorization in User Profile Endpoint (Medium)](#cve-2026-27793--broken-object-level-authorization-in-user-profile-endpoint-medium)
* [CVE-2026-27792 — Missing Authentication on Push Subscription Endpoints (Medium)](#cve-2026-27792--missing-authentication-on-push-subscription-endpoints-medium)
* [Bug Fixes](#bug-fixes)
* [New Contributors](#new-contributors)
* [What's Next](#whats-next)