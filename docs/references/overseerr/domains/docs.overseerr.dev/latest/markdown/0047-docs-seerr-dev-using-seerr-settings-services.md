...
Seerr checks these linked servers to determine whether or not media has already been requested or is available, so two servers of each type are required *if you keep separate non-4K and 4K copies of media.*
...
#### URL Base[​](#url-base)
If you have configured a URL base for your Radarr/Sonarr server, you *must* enter it here in order for Jellyeerr to connect to those services!
...
#### Profiles, Root Folder, Minimum Availability[​](#profiles-root-folder-minimum-availability)
...
#### External URL (optional)[​](#external-url-optional)
...
#### Enable Scan (optional)[​](#enable-scan-optional)
...
#### Enable Automatic Search (optional)[​](#enable-automatic-search-optional)
