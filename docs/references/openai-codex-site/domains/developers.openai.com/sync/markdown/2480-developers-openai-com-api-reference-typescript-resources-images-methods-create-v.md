...
client.images.createVariation(ImageCreateVariationParams { image, model, n, 3 more } body, RequestOptionsoptions?): [ImagesResponse](</api/reference/typescript/resources/images#(resource) images > (model) images_response > (schema)>) { created, background, data, 4 more }
POST/images/variations
Creates a variation of a given image. This endpoint only supports `dall-e-2`.
##### ParametersExpand Collapse
body: ImageCreateVariationParams { image, model, n, 3 more }
image: [Uploadable](</api/reference/typescript/resources/images/methods/create_variation#(resource) images > (method) create_variation > (params) default > (param) image > (schema)>)
