...
[](<#(resource) admin.organization.certificates > (method) create > (params) 0 > (param) content > (schema)>)
name: optional string
An optional name for the certificate
[](<#(resource) admin.organization.certificates > (method) create > (params) 0 > (param) name > (schema)>)
