...
[](<#(resource) admin.organization.users.roles > (method) create > (params) 0 > (param) role_id > (schema)>)
...
Terraform
```
`curl -X POST https://api.openai.com/v1/organization/users/user\_abc123/roles \\
