...
string
[](<#(resource) vector_stores.files > (method) update > (params) 0 > (param) attributes > (schema) > (items) > (variant) 0>)
number
[](<#(resource) vector_stores.files > (method) update > (params) 0 > (param) attributes > (schema) > (items) > (variant) 1>)
boolean
[](<#(resource) vector_stores.files > (method) update > (params) 0 > (param) attributes > (schema) > (items) > (variant) 2>)
[](<#(resource) vector_stores.files > (method) update > (params) 0 > (param) attributes > (schema)>)
...
Terraform
```
`curl https://api.openai.com/v1/vector\_stores/{vector\_store\_id}/files/{file\_id} \\
