...
[InputTokenCountResponse](</api/reference/java/resources/responses#(resource) responses.input_tokens > (model) InputTokenCountResponse > (schema)>) responses().inputTokens().count(InputTokenCountParamsparams = InputTokenCountParams.none(), RequestOptionsrequestOptions = RequestOptions.none())
...
String
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) conversation > (variant) 0>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) conversation>)
Optional\<Input\> input
Text, image, or file inputs to the model, used to generate a response
String
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) input > (variant) 0>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) input > (variant) 1>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) input>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) instructions>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) model>)
Optional\<Boolean\> parallelToolCalls
Whether to allow the model to run tool calls in parallel.
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) parallel_tool_calls>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) previous_response_id>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) reasoning>)
Optional\<Text\> text
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) $shared > (model) response_format_text > (schema) > (property) type>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) $shared > (model) response_format_text > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) responses > (model) response_format_text_json_schema_config > (schema) > (property) name>)
Schema schema
The schema for the response format, described as a JSON Schema object.
Learn how to build JSON schemas [here](https://json-schema.org/).
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) responses > (model) response_format_text_json_schema_config > (schema) > (property) schema>)
JsonValue; type "json\_schema"constant"json\_schema"constant
The type of response format being defined. Always `json\_schema`.
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) responses > (model) response_format_text_json_schema_config > (schema) > (property) type>)
Optional\<String\> description
A description of what the response format is for, used by the model to
determine how to respond in the format.
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) responses > (model) response_format_text_json_schema_config > (schema) > (property) description>)
Optional\<Boolean\> strict
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) responses > (model) response_format_text_json_schema_config > (schema) > (property) strict>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) responses > (model) response_format_text_json_schema_config > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) $shared > (model) response_format_json_object > (schema) > (property) type>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format + (resource) $shared > (model) response_format_json_object > (schema)>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) format>)
...
One of the following:
LOW("low")
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) verbosity > (member) 0>)
MEDIUM("medium")
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) verbosity > (member) 1>)
HIGH("high")
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) verbosity > (member) 2>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text > (property) verbosity>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) text>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) tool_choice>)
...
[](<#(resource) responses > (model) apply_patch_tool > (schema) > (property) type>)
[](<#(resource) responses > (model) apply_patch_tool > (schema)>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) tools>)
Optional\<Truncation\> truncation
The truncation strategy to use for the model response. - `auto`: If the input to this Response exceeds the model’s context window size, the model will truncate the response to fit the context window by dropping items from the beginning of the conversation. - `disabled` (default): If the input size will exceed the context window size for a model, the request will fail with a 400 error.
AUTO("auto")
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) truncation > (member) 0>)
DISABLED("disabled")
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) truncation > (member) 1>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) body > (schema) > (property) truncation>)
