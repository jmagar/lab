...
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/chatgpt/gpt_actions_library/gpt_action_salesforce_gong.md)
## Introduction
...
const GONG\_API\_BASE\_URL = "https://api.gong.io/v2";
const GONG\_API\_KEY = process.env.GONG\_API\_KEY;
...
const transcriptResponse = await axios.post(`${GONG\_API\_BASE\_URL}/calls/transcript`, transcriptPayload, {
headers: {
'Authorization': `Basic ${GONG\_API\_KEY}`,
...
const extensiveResponse = await axios.post(`${GONG\_API\_BASE\_URL}/calls/extensive`, extensivePayload, {
headers: {
'Authorization': `Basic ${GONG\_API\_KEY}`,
'Content-Type': 'application/json'
}
...
FROM Gong\_\_Gong\_Call\_\_c
WHERE Gong\_\_Primary\_Account\_\_c = '\<AccountId\>'
ORDER BY Gong\_\_Call\_Start\_\_c DESC
LIMIT 2
`
