...
Order param.Field[[ChatCompletionListParamsOrder](</api/reference/go/resources/chat/subresources/completions/methods/list#(resource) chat.completions > (method) list > (params) default > (param) order > (schema)>)]Optional
Sort order for Chat Completions by timestamp. Use `asc` for ascending order or `desc` for descending order. Defaults to `asc`.
const ChatCompletionListParamsOrderAsc [ChatCompletionListParamsOrder](</api/reference/go/resources/chat/subresources/completions/methods/list#(resource) chat.completions > (method) list > (params) default > (param) order > (schema)>) = "asc"
[](<#(resource) chat.completions > (method) list > (params) default > (param) order > (schema) > (member) 0>)
const ChatCompletionListParamsOrderDesc [ChatCompletionListParamsOrder](</api/reference/go/resources/chat/subresources/completions/methods/list#(resource) chat.completions > (method) list > (params) default > (param) order > (schema)>) = "desc"
