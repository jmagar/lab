...
**View as Markdown**
# List input items
responses.input\_items.list(strresponse\_id, InputItemListParams\*\*kwargs) -\> SyncCursorPage[[ResponseItem](</api/reference/python/resources/responses#(resource) responses > (model) response_item > (schema)>)]
...
[ResponseItem](</api/reference/python/resources/responses#(resource) responses > (model) response_item > (schema)>)
