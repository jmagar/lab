...
[](<#(resource) admin.organization.projects.groups > (method) create > (params) default > (param) body > (schema) > (property) group_id>)
String role
Identifier of the project role to grant to the group.
[](<#(resource) admin.organization.projects.groups > (method) create > (params) default > (param) body > (schema) > (property) role>)
