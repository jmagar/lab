Cancel a run | OpenAI API Reference
...
thread\_id: string
[](<#(resource) beta.threads.runs > (method) cancel > (params) default > (param) thread_id > (schema)>)
run\_id: string
[](<#(resource) beta.threads.runs > (method) cancel > (params) default > (param) run_id > (schema)>)
...
Terraform
```
`curl https://api.openai.com/v1/threads/thread\_abc123/runs/run\_abc123/cancel \\
...
"id": "run\_abc123",
"object": "thread.run",
"created\_at": 1699076126,
"assistant\_id": "asst\_abc123",
"thread\_id": "thread\_abc123",
"status": "cancelling",
"started\_at": 1699076126,
"expires\_at": 1699076726,
"cancelled\_at": null,
"failed\_at": null,
"completed\_at": null,
"last\_error": null,
