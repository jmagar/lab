...
[](<#(resource) admin.organization.projects.certificates > (method) deactivate > (params) default > (param) body > (schema) > (property) certificate_ids>)
[](<#(resource) admin.organization.projects.certificates > (method) deactivate > (params) default>)
