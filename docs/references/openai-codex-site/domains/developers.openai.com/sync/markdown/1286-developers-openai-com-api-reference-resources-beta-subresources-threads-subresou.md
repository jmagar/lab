...
[](<#(resource) beta.threads.messages > (method) list > (params) default > (param) after > (schema)>)
before: optional string
A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with obj\_foo, your subsequent call can include before=obj\_foo in order to fetch the previous page of the list.
[](<#(resource) beta.threads.messages > (method) list > (params) default > (param) before > (schema)>)
limit: optional number
A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20.
[](<#(resource) beta.threads.messages > (method) list > (params) default > (param) limit > (schema)>)
...
[](<#(resource) beta.threads.messages > (method) list > (params) default > (param) order > (schema)>)
run\_id: optional string
Filter messages by the run ID that generated them.
[](<#(resource) beta.threads.messages > (method) list > (params) default > (param) run_id > (schema)>)
##### ReturnsExpand Collapse
data: array of [Message](</api/reference/resources/beta#(resource) beta.threads.messages > (model) message > (schema)>) { id, assistant\_id, attachments, 11 more }
id: string
...
[](<#(resource) beta.threads.messages > (method) list > (network schema) > (property) data>)
first\_id: string
[](<#(resource) beta.threads.messages > (method) list > (network schema) > (property) first_id>)
has\_more: boolean
[](<#(resource) beta.threads.messages > (method) list > (network schema) > (property) has_more>)
last\_id: string
[](<#(resource) beta.threads.messages > (method) list > (network schema) > (property) last_id>)
object: string
[](<#(resource) beta.threads.messages > (method) list > (network schema) > (property) object>)
### List messages
HTTP
HTTP
HTTP
