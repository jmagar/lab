OpenAI TypeScript and JavaScript API Library | OpenAI API Reference
...
The REST API documentation can be found on [platform.openai.com](https://platform.openai.com/docs). The full API of this library can be found in [api.md](https://github.com/openai/openai-node/tree/master/api.md).
## Installation
```
`npm install openai`
```
...
```
## Usage
The full API of this library can be found in [api.md](https://github.com/openai/openai-node/tree/master/api.md).
```
...
Note that requests which time out will be [retried twice by default](https://github.com/openai/openai-node/tree/master/#retries).
## Auto-pagination
...
1. Via the `OPENAI\_LOG` environment variable
...
## Contributing
See [the contributing documentation](https://github.com/openai/openai-node/tree/master/./CONTRIBUTING.md).