...
[](<#(resource) evals > (method) list > (params) default > (param) after>)
limit?: number
Number of evals to retrieve.
[](<#(resource) evals > (method) list > (params) default > (param) limit>)
order?: "asc" | "desc"
...
[](<#(resource) evals > (method) list > (params) default > (param) order>)
...
[](<#(resource) evals > (method) list > (params) default > (param) order_by>)
