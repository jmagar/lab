...
Nov 26, 2024
# GPT Actions library - Tray.ai APIM
[ KC ](https://github.com/kylecote-tray)
...
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/chatgpt/gpt_actions_library/gpt_action_trayai_apim.md)
## Introduction
...
* Application Website: [https://tray.ai/universal-automation-cloud/api-management](https://tray.ai/universal-automation-cloud/api-management)
* Application API Documentation: [https://tray.ai/documentation/tray-uac/api-management/api-management-overview/](https://tray.ai/documentation/tray-uac/api-management/api-management-overview/)
