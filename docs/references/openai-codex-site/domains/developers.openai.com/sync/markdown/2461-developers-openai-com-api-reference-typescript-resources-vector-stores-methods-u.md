...
expires\_after?: [ExpiresAfter](</api/reference/typescript/resources/vector_stores/methods/update#(resource) vector_stores > (method) update > (params) default > (param) expires_after > (schema)>) | null
