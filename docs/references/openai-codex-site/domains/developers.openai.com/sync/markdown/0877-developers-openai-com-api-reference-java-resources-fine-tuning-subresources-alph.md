...
**View as Markdown**
# Validate grader
[GraderValidateResponse](</api/reference/java/resources/fine_tuning#(resource) fine_tuning.alpha.graders > (model) GraderValidateResponse > (schema)>) fineTuning().alpha().graders().validate(GraderValidateParamsparams, RequestOptionsrequestOptions = RequestOptions.none())
...
[](<#(resource) fine_tuning.alpha.graders > (method) validate > (params) default > (param) body > (schema) > (property) grader>)
...
[](<#(resource) graders.grader_models > (model) multi_grader > (schema) > (property) type>)
[](<#(resource) graders.grader_models > (model) multi_grader > (schema)>)
[](<#(resource) fine_tuning.alpha.graders > (model) GraderValidateResponse > (schema) > (property) grader>)
[](<#(resource) fine_tuning.alpha.graders > (model) GraderValidateResponse > (schema)>)
### Validate grader
Java
HTTP
HTTP
