...
client.responses.inputTokens.count(InputTokenCountParams { conversation, input, instructions, 8 more } body?, RequestOptionsoptions?): [InputTokenCountResponse](</api/reference/typescript/resources/responses#(resource) responses.input_tokens > (model) input_token_count_response > (schema)>) { input\_tokens, object }
...
body: InputTokenCountParams { conversation, input, instructions, 8 more }
conversation?: string | [ResponseConversationParam](</api/reference/typescript/resources/responses#(resource) responses > (model) response_conversation_param > (schema)>) { id } | null
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) effort>)
...
One of the following:
"auto"
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary > (member) 0>)
"concise"
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary > (member) 1>)
"detailed"
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary > (member) 2>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary>)
...
One of the following:
"auto"
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) summary > (member) 0>)
"concise"
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) summary > (member) 1>)
"detailed"
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) summary > (member) 2>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning + (resource) $shared > (model) reasoning > (schema) > (property) summary>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning>)
text?: [Text](</api/reference/typescript/resources/responses/subresources/input_tokens/methods/count#(resource) responses.input_tokens > (method) count > (params) default > (param) text > (schema)>) | null
...
tools?: Array\<[Tool](</api/reference/typescript/resources/responses#(resource) responses > (model) tool > (schema)>)\> | null
