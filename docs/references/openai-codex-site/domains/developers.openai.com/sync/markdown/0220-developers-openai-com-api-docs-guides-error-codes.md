...
**Solution:** Please see [this page](/api/docs/supported-countries) for more information.|
|429 - Rate limit reached for requests|**Cause:** You are sending requests too quickly.
**Solution:** Pace your requests. Read the [Rate limit guide](/api/docs/guides/rate-limits).|
...
**Solution:** The error message should advise you on the specific error made. Check the [documentation](/api/docs/api-reference/) for the specific API method you are calling and make sure you are sending valid and complete parameters. You may also need to check the encoding, format, or size of your request data.|
...
**Solution:** Pace your requests. Read more in our [Rate limit guide](/api/docs/guides/rate-limits).|
