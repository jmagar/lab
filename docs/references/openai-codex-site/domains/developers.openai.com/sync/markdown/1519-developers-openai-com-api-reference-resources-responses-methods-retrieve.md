Get a model response | OpenAI API Reference
...
response\_id: string
[](<#(resource) responses > (method) retrieve > (params) default.non_streaming > (param) response_id > (schema)>)
...
[](<#(resource) responses > (method) retrieve > (params) default.non_streaming > (param) include > (schema)>)
...
[](<#(resource) responses > (method) retrieve > (params) default.non_streaming > (param) include_obfuscation > (schema)>)
starting\_after: optional number
The sequence number of the event after which to start streaming.
[](<#(resource) responses > (method) retrieve > (params) default.non_streaming > (param) starting_after > (schema)>)
stream: optional false
If set to true, the model response data will be streamed to the client
as it is generated using [server-sent events](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events#Event_stream_format).
See the [Streaming section below](/docs/api-reference/responses-streaming)
for more information.
[](<#(resource) responses > (method) retrieve > (params) default.non_streaming > (param) stream > (schema)>)
