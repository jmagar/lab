Validate grader | OpenAI API Reference
...
**View as Markdown**
# Validate grader
client.FineTuning.Alpha.Graders.Validate(ctx, body) (\*[FineTuningAlphaGraderValidateResponse](</api/reference/go/resources/fine_tuning#(resource) fine_tuning.alpha.graders > (model) FineTuningAlphaGraderValidateResponse > (schema)>), error)
POST/fine\_tuning/alpha/graders/validate
Validate a grader.
##### ParametersExpand Collapse
body FineTuningAlphaGraderValidateParams
Grader param.Field[[FineTuningAlphaGraderValidateParamsGraderUnion](</api/reference/go/resources/fine_tuning/subresources/alpha/subresources/graders/methods/validate#(resource) fine_tuning.alpha.graders > (method) validate > (params) default > (param) grader > (schema)>)]
...
[](<#(resource) fine_tuning.alpha.graders > (method) validate > (params) default > (param) grader>)
[](<#(resource) fine_tuning.alpha.graders > (method) validate > (params) default>)
...
[](<#(resource) graders.grader_models > (model) multi_grader > (schema) > (property) type>)
[](<#(resource) graders.grader_models > (model) multi_grader > (schema)>)
[](<#(resource) fine_tuning.alpha.graders > (model) FineTuningAlphaGraderValidateResponse > (schema) > (property) grader>)
[](<#(resource) fine_tuning.alpha.graders > (model) FineTuningAlphaGraderValidateResponse > (schema)>)
### Validate grader
Go
HTTP
HTTP
