...
[](<#(resource) admin.organization.certificates > (method) create > (params) default > (param) body > (schema) > (property) content>)
Optional\<String\> name
An optional name for the certificate
[](<#(resource) admin.organization.certificates > (method) create > (params) default > (param) body > (schema) > (property) name>)
[](<#(resource) admin.organization.certificates > (method) create > (params) default>)
