...
InputReference param.Field[[VideoNewParamsInputReferenceUnion](</api/reference/go/resources/videos/methods/create#(resource) videos > (method) create > (params) default > (param) input_reference > (schema)>)]Optional
...
Seconds param.Field[[VideoSeconds](</api/reference/go/resources/videos#(resource) videos > (model) video_seconds > (schema)>)]Optional
Clip duration in seconds (allowed values: 4, 8, 12). Defaults to 4 seconds.
[](<#(resource) videos > (method) create > (params) default > (param) seconds>)
Size param.Field[[VideoSize](</api/reference/go/resources/videos#(resource) videos > (model) video_size > (schema)>)]Optional
