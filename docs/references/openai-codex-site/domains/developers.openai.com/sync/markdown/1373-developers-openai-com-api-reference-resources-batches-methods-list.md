List batches | OpenAI API Reference
...
[](<#(resource) batches > (method) list > (params) default > (param) after > (schema)>)
limit: optional number
A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20.
[](<#(resource) batches > (method) list > (params) default > (param) limit > (schema)>)
##### ReturnsExpand Collapse
data: array of [Batch](</api/reference/resources/batches#(resource) batches > (model) batch > (schema)>) { id, completion\_window, created\_at, 19 more }
id: string
...
[](<#(resource) batches > (method) list > (network schema) > (property) data>)
has\_more: boolean
[](<#(resource) batches > (method) list > (network schema) > (property) has_more>)
object: "list"
[](<#(resource) batches > (method) list > (network schema) > (property) object>)
first\_id: optional string
[](<#(resource) batches > (method) list > (network schema) > (property) first_id>)
last\_id: optional string
[](<#(resource) batches > (method) list > (network schema) > (property) last_id>)
### List batches
HTTP
HTTP
HTTP
...
"batch\_description": "Nightly job",
}
},
{ ... },
],
"first\_id": "batch\_abc123",
"last\_id": "batch\_abc456",
"has\_more": true
}
`
```
