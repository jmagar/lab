...
TranslationCreateResponse = [Translation](</api/reference/resources/audio#(resource) audio.translations > (model) translation > (schema)>) { text } or [TranslationVerbose](</api/reference/resources/audio#(resource) audio.translations > (model) translation_verbose > (schema)>) { duration, language, text, segments }
One of the following:
Translation object { text }
text: string
[](<#(resource) audio.translations > (model) translation > (schema) > (property) text>)
