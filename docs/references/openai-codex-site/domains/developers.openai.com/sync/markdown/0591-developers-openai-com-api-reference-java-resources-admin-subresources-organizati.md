...
`owner` or `member`
OWNER("owner")
[](<#(resource) admin.organization.projects.users > (method) update > (params) default > (param) body > (schema) > (property) role > (member) 0>)
MEMBER("member")
[](<#(resource) admin.organization.projects.users > (method) update > (params) default > (param) body > (schema) > (property) role > (member) 1>)
[](<#(resource) admin.organization.projects.users > (method) update > (params) default > (param) body > (schema) > (property) role>)
