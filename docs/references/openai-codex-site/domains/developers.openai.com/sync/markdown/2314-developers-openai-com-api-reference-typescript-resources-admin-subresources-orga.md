...
[](<#(resource) admin.organization.projects.users > (method) update > (params) default > (param) project_id>)
role: "owner" | "member"
...
const projectUser = await client.admin.organization.projects.users.update('user\_id', {
