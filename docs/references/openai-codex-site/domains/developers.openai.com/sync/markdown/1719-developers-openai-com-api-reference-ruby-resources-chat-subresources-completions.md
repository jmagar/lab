...
messages: Array[[ChatCompletionMessageParam](</api/reference/ruby/resources/chat#(resource) chat.completions > (model) chat_completion_message_param > (schema)>)]
...
audio: [ChatCompletionAudioParam](</api/reference/ruby/resources/chat#(resource) chat.completions > (model) chat_completion_audio_param > (schema)>) { format\_, voice }
...
Deprecatedfunction\_call: :none | :auto | [ChatCompletionFunctionCallOption](</api/reference/ruby/resources/chat#(resource) chat.completions > (model) chat_completion_function_call_option > (schema)>) { name }
...
prediction: [ChatCompletionPredictionContent](</api/reference/ruby/resources/chat#(resource) chat.completions > (model) chat_completion_prediction_content > (schema)>) { content, type }
...
stream\_options: [ChatCompletionStreamOptions](</api/reference/ruby/resources/chat#(resource) chat.completions > (model) chat_completion_stream_options > (schema)>) { include\_obfuscation, include\_usage }
...
tool\_choice: [ChatCompletionToolChoiceOption](</api/reference/ruby/resources/chat#(resource) chat.completions > (model) chat_completion_tool_choice_option > (schema)>)
...
tools: Array[[ChatCompletionTool](</api/reference/ruby/resources/chat#(resource) chat.completions > (model) chat_completion_tool > (schema)>)]
...
chat\_completion = openai.chat.completions.create(messages: [{content: "string", role: :developer}], model: :"gpt-5.4")
puts(chat\_completion)`
```
```
`{
