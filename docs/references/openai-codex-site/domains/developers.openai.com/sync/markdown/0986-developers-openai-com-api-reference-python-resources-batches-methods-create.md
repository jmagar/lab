...
**View as Markdown**
# Create batch
batches.create(BatchCreateParams\*\*kwargs) -\> [Batch](</api/reference/python/resources/batches#(resource) batches > (model) batch > (schema)>)
POST/batches
Creates and executes a batch from an uploaded file of requests
##### ParametersExpand Collapse
completion\_window: Literal["24h"]
The time frame within which the batch should be processed. Currently only `24h` is supported.
[](<#(resource) batches > (method) create > (params) default > (param) completion_window > (schema)>)
...
[](<#(resource) batches > (method) create > (params) default > (param) endpoint > (schema)>)
input\_file\_id: str
...
[](<#(resource) batches > (method) create > (params) default > (param) input_file_id > (schema)>)
...
[](<#(resource) batches > (method) create > (params) default > (param) metadata > (schema)>)
output\_expires\_after: Optional[[OutputExpiresAfter](</api/reference/python/resources/batches/methods/create#(resource) batches > (method) create > (params) default > (param) output_expires_after > (schema)>)]
...
[](<#(resource) batches > (method) create > (params) default > (param) output_expires_after > (schema)>)
