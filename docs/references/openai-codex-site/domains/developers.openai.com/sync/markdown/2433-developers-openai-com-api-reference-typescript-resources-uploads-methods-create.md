...
"assistants"
[](<#(resource) uploads > (method) create > (params) default > (param) purpose + (resource) files > (model) file_purpose > (schema) > (member) 0>)
"batch"
[](<#(resource) uploads > (method) create > (params) default > (param) purpose + (resource) files > (model) file_purpose > (schema) > (member) 1>)
"fine-tune"
[](<#(resource) uploads > (method) create > (params) default > (param) purpose + (resource) files > (model) file_purpose > (schema) > (member) 2>)
"vision"
[](<#(resource) uploads > (method) create > (params) default > (param) purpose + (resource) files > (model) file_purpose > (schema) > (member) 3>)
"user\_data"
[](<#(resource) uploads > (method) create > (params) default > (param) purpose + (resource) files > (model) file_purpose > (schema) > (member) 4>)
"evals"
[](<#(resource) uploads > (method) create > (params) default > (param) purpose + (resource) files > (model) file_purpose > (schema) > (member) 5>)
[](<#(resource) uploads > (method) create > (params) default > (param) purpose>)
expires\_after?: [ExpiresAfter](</api/reference/typescript/resources/uploads/methods/create#(resource) uploads > (method) create > (params) default > (param) expires_after > (schema)>)
