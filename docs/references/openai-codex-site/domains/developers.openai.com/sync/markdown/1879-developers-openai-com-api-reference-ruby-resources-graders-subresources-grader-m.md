...
GraderInputItem = String | [ResponseInputText](</api/reference/ruby/resources/responses#(resource) responses > (model) response_input_text > (schema)>) { text, type } | OutputText{ text, type} | 2 more
...
[](<#(resource) graders.grader_models > (model) eval_content_item > (schema)>)
