List fine-tuning jobs | OpenAI API Reference
...
[](<#(resource) fine_tuning.jobs > (method) list > (params) default > (param) after>)
limit?: number
Number of fine-tuning jobs to retrieve.
[](<#(resource) fine_tuning.jobs > (method) list > (params) default > (param) limit>)
metadata?: Record\<string, string\> | null
Optional metadata filter. To filter, use the syntax `metadata[k]=v`. Alternatively, set `metadata=null` to indicate no metadata.
[](<#(resource) fine_tuning.jobs > (method) list > (params) default > (param) metadata>)
[](<#(resource) fine_tuning.jobs > (method) list > (params) default>)
