...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) type > (schema)>)
...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) audio > (schema) + (resource) realtime > (model) realtime_audio_config > (schema) > (property) input>)
...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) audio > (schema) + (resource) realtime > (model) realtime_audio_config > (schema) > (property) output>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) audio > (schema)>)
...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) include > (schema)>)
...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) instructions > (schema)>)
...
One of the following:
number
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) max_output_tokens > (schema) > (variant) 0>)
"inf"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) max_output_tokens > (schema) > (variant) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) max_output_tokens > (schema)>)
model: optional string or "gpt-realtime" or "gpt-realtime-1.5" or "gpt-realtime-2025-08-28" or 13 more
The Realtime model used for this session.
One of the following:
string
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 0>)
"gpt-realtime" or "gpt-realtime-1.5" or "gpt-realtime-2025-08-28" or 13 more
The Realtime model used for this session.
One of the following:
"gpt-realtime"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 0>)
"gpt-realtime-1.5"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 1>)
"gpt-realtime-2025-08-28"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 2>)
"gpt-4o-realtime-preview"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 3>)
"gpt-4o-realtime-preview-2024-10-01"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 4>)
"gpt-4o-realtime-preview-2024-12-17"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 5>)
"gpt-4o-realtime-preview-2025-06-03"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 6>)
"gpt-4o-mini-realtime-preview"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 7>)
"gpt-4o-mini-realtime-preview-2024-12-17"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 8>)
"gpt-realtime-mini"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 9>)
"gpt-realtime-mini-2025-10-06"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 10>)
"gpt-realtime-mini-2025-12-15"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 11>)
"gpt-audio-1.5"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 12>)
"gpt-audio-mini"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 13>)
"gpt-audio-mini-2025-10-06"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 14>)
"gpt-audio-mini-2025-12-15"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1 > (member) 15>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema) > (variant) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) model > (schema)>)
...
One of the following:
"text"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) output_modalities > (schema) > (items) > (member) 0>)
"audio"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) output_modalities > (schema) > (items) > (member) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) output_modalities > (schema)>)
...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_prompt > (schema) > (property) id>)
...
One of the following:
string
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_prompt > (schema) > (property) variables > (items) > (variant) 0>)
ResponseInputText object { text, type }
A text input to the model.
text: string
The text input to the model.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_text > (schema) > (property) text>)
type: "input\_text"
The type of the input item. Always `input\_text`.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_text > (schema) > (property) type>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_text > (schema)>)
...
One of the following:
"low"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) detail > (member) 0>)
"high"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) detail > (member) 1>)
"auto"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) detail > (member) 2>)
"original"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) detail > (member) 3>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) detail>)
type: "input\_image"
The type of the input item. Always `input\_image`.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) type>)
file\_id: optional string
The ID of the file to be sent to the model.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) file_id>)
image\_url: optional string
The URL of the image to be sent to the model. A fully qualified URL or base64 encoded image in a data URL.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema) > (property) image_url>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_image > (schema)>)
ResponseInputFile object { type, detail, file\_data, 3 more }
A file input to the model.
type: "input\_file"
The type of the input item. Always `input\_file`.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) type>)
detail: optional "low" or "high"
The detail level of the file to be sent to the model. Use `low` for the default rendering behavior, or `high` to render the file at higher quality. Defaults to `low`.
One of the following:
"low"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) detail > (member) 0>)
"high"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) detail > (member) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) detail>)
file\_data: optional string
The content of the file to be sent to the model.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) file_data>)
file\_id: optional string
The ID of the file to be sent to the model.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) file_id>)
file\_url: optional string
The URL of the file to be sent to the model.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) file_url>)
filename: optional string
The name of the file to be sent to the model.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema) > (property) filename>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_input_file > (schema)>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_prompt > (schema) > (property) variables>)
version: optional string
Optional version of the prompt template.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema) + (resource) responses > (model) response_prompt > (schema) > (property) version>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) prompt > (schema)>)
...
One of the following:
"none"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_options > (schema) > (member) 0>)
"auto"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_options > (schema) > (member) 1>)
"required"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_options > (schema) > (member) 2>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_options > (schema)>)
ToolChoiceFunction object { name, type }
Use this option to force the model to call a specific function.
name: string
The name of the function to call.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_function > (schema) > (property) name>)
type: "function"
For function calling, the type is always `function`.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_function > (schema) > (property) type>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_function > (schema)>)
ToolChoiceMcp object { server\_label, type, name }
Use this option to force the model to call a specific tool on a remote MCP server.
server\_label: string
The label of the MCP server to use.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_mcp > (schema) > (property) server_label>)
type: "mcp"
For MCP tools, the type is always `mcp`.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_mcp > (schema) > (property) type>)
name: optional string
The name of the tool to call on the server.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_mcp > (schema) > (property) name>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema) + (resource) responses > (model) tool_choice_mcp > (schema)>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tool_choice > (schema)>)
...
(if anything).
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_function_tool > (schema) > (property) description>)
name: optional string
The name of the function.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_function_tool > (schema) > (property) name>)
parameters: optional unknown
Parameters of the function in JSON Schema.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_function_tool > (schema) > (property) parameters>)
type: optional "function"
The type of the tool, i.e. `function`.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_function_tool > (schema) > (property) type>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_function_tool > (schema)>)
McpTool object { server\_label, type, allowed\_tools, 7 more }
Give the model access to additional tools via remote Model Context Protocol
(MCP) servers. [Learn more about MCP](/docs/guides/tools-remote-mcp).
server\_label: string
A label for this MCP server, used to identify it in tool calls.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) server_label>)
type: "mcp"
The type of the MCP tool. Always `mcp`.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) type>)
allowed\_tools: optional array of string or object { read\_only, tool\_names }
List of allowed tool names or a filter object.
One of the following:
McpAllowedTools = array of string
A string array of allowed tool names
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) allowed_tools > (variant) 0>)
...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) allowed_tools > (variant) 1 > (property) read_only>)
tool\_names: optional array of string
List of allowed tool names.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) allowed_tools > (variant) 1 > (property) tool_names>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) allowed_tools > (variant) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) allowed_tools>)
authorization: optional string
An OAuth access token that can be used with a remote MCP server, either
with a custom MCP server URL or a service connector. Your application
must handle the OAuth authorization flow and provide the token here.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) authorization>)
...
One of the following:
"connector\_dropbox"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 0>)
"connector\_gmail"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 1>)
"connector\_googlecalendar"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 2>)
"connector\_googledrive"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 3>)
"connector\_microsoftteams"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 4>)
"connector\_outlookcalendar"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 5>)
"connector\_outlookemail"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 6>)
"connector\_sharepoint"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id > (member) 7>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) connector_id>)
defer\_loading: optional boolean
Whether this MCP tool is deferred and discovered via tool search.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) defer_loading>)
headers: optional map[string]
Optional HTTP headers to send to the MCP server. Use for authentication
or other purposes.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) headers>)
...
MCP server is [annotated with `readOnlyHint`](https://modelcontextprotocol.io/specification/2025-06-18/schema#toolannotations-readonlyhint),
it will match this filter.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 0 > (property) always > (property) read_only>)
tool\_names: optional array of string
List of allowed tool names.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 0 > (property) always > (property) tool_names>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 0 > (property) always>)
...
MCP server is [annotated with `readOnlyHint`](https://modelcontextprotocol.io/specification/2025-06-18/schema#toolannotations-readonlyhint),
it will match this filter.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 0 > (property) never > (property) read_only>)
tool\_names: optional array of string
List of allowed tool names.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 0 > (property) never > (property) tool_names>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 0 > (property) never>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 0>)
...
One of the following:
"always"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 1 > (member) 0>)
"never"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 1 > (member) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval > (variant) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) require_approval>)
server\_description: optional string
Optional description of the MCP server, used to provide more context.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) server_description>)
server\_url: optional string
The URL for the MCP server. One of `server\_url` or `connector\_id` must be
provided.
formaturi
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1 > (property) server_url>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema) + (resource) realtime > (model) realtime_tools_config_union > (schema) > (variant) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tools > (schema)>)
...
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tracing > (schema) + (resource) realtime > (model) realtime_tracing_config > (schema) > (variant) 0>)
TracingConfiguration object { group\_id, metadata, workflow\_name }
Granular configuration for tracing.
group\_id: optional string
The group id to attach to this trace to enable filtering and
grouping in the Traces Dashboard.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tracing > (schema) + (resource) realtime > (model) realtime_tracing_config > (schema) > (variant) 1 > (property) group_id>)
metadata: optional unknown
The arbitrary metadata to attach to this trace to enable
filtering in the Traces Dashboard.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tracing > (schema) + (resource) realtime > (model) realtime_tracing_config > (schema) > (variant) 1 > (property) metadata>)
workflow\_name: optional string
The name of the workflow to attach to this trace. This is used to
name the trace in the Traces Dashboard.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tracing > (schema) + (resource) realtime > (model) realtime_tracing_config > (schema) > (variant) 1 > (property) workflow_name>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tracing > (schema) + (resource) realtime > (model) realtime_tracing_config > (schema) > (variant) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) tracing > (schema)>)
...
One of the following:
"auto"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 0 > (member) 0>)
"disabled"
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 0 > (member) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 0>)
...
minimum0
maximum1
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 1 > (property) retention_ratio>)
type: "retention\_ratio"
Use retention ratio truncation.
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 1 > (property) type>)
...
minimum0
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 1 > (property) token_limits > (property) post_instructions>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 1 > (property) token_limits>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema) + (resource) realtime > (model) realtime_truncation > (schema) > (variant) 1>)
[](<#(resource) realtime.calls > (method) accept > (params) 0 > (param) truncation > (schema)>)
### Accept call
HTTP
HTTP
HTTP
...
Terraform
```
`curl -X POST https://api.openai.com/v1/realtime/calls/$CALL\_ID/accept \\
