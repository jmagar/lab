...
[](<#(resource) admin.organization.certificates > (method) deactivate > (params) 0 > (param) certificate_ids > (schema)>)
...
[](<#(resource) admin.organization.certificates > (method) deactivate > (network schema) > (property) data>)
has\_more: boolean
[](<#(resource) admin.organization.certificates > (method) deactivate > (network schema) > (property) has_more>)
object: "list"
[](<#(resource) admin.organization.certificates > (method) deactivate > (network schema) > (property) object>)
first\_id: optional string
[](<#(resource) admin.organization.certificates > (method) deactivate > (network schema) > (property) first_id>)
last\_id: optional string
[](<#(resource) admin.organization.certificates > (method) deactivate > (network schema) > (property) last_id>)
### Deactivate certificates for organization
HTTP
HTTP
HTTP
