...
**View as Markdown**
# Cancel a response
responses.cancel(strresponse\_id) -\> [Response](</api/reference/python/resources/responses#(resource) responses > (model) response > (schema)>)
...
instructions: Union[str, List[[ResponseInputItem](</api/reference/python/resources/responses#(resource) responses > (model) response_input_item > (schema)>)], null]
...
List[[ResponseInputItem](</api/reference/python/resources/responses#(resource) responses > (model) response_input_item > (schema)>)]
...
model: [ResponsesModel](</api/reference/python/resources/$shared#(resource) $shared > (model) responses_model > (schema)>)
