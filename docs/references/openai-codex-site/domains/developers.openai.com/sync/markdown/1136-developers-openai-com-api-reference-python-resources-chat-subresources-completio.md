...
messages: Iterable[[ChatCompletionMessageParam](</api/reference/python/resources/chat#(resource) chat.completions > (model) chat_completion_message_param > (schema)>)]
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) messages > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) model > (schema) > (variant) 1>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) model > (schema)>)
...
One of the following:
"wav"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) format > (member) 0>)
"aac"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) format > (member) 1>)
"mp3"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) format > (member) 2>)
"flac"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) format > (member) 3>)
"opus"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) format > (member) 4>)
"pcm16"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) format > (member) 5>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) format>)
voice: Voice
...
One of the following:
str
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 0>)
Literal["alloy", "ash", "ballad", 7 more]
One of the following:
"alloy"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 0>)
"ash"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 1>)
"ballad"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 2>)
"coral"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 3>)
"echo"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 4>)
"sage"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 5>)
"shimmer"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 6>)
"verse"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 7>)
"marin"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 8>)
"cedar"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1 > (member) 9>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 1>)
class VoiceID: …
Custom voice reference.
id: str
The custom voice ID, e.g. `voice\_1234`.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 2 > (property) id>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice > (variant) 2>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema) + (resource) chat.completions > (model) chat_completion_audio_param > (schema) > (property) voice>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) audio > (schema)>)
...
minimum-2
maximum2
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) frequency_penalty > (schema)>)
Deprecatedfunction\_call: Optional[[FunctionCall](</api/reference/python/resources/chat/subresources/completions/methods/create#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) function_call > (schema)>)]
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) function_call > (schema)>)
...
parameters: Optional[[FunctionParameters](</api/reference/python/resources/$shared#(resource) $shared > (model) function_parameters > (schema)>)]
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) functions > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) logit_bias > (schema)>)
logprobs: Optional[bool]
Whether to return log probabilities of the output tokens or not. If true,
returns the log probabilities of each output token returned in the
`content` of `message`.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) logprobs > (schema)>)
max\_completion\_tokens: Optional[int]
An upper bound for the number of tokens that can be generated for a completion, including visible output tokens and [reasoning tokens](https://platform.openai.com/docs/guides/reasoning).
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) max_completion_tokens > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) max_tokens > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) metadata > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) modalities > (schema)>)
n: Optional[int]
How many chat completion choices to generate for each input message. Note that you will be charged based on the number of generated tokens across all of the choices. Keep `n` as `1` to minimize costs.
minimum1
maximum128
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) n > (schema)>)
parallel\_tool\_calls: Optional[[bool](</api/reference/python/resources/chat/subresources/completions/methods/create#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) parallel_tool_calls > (schema)>)]
Whether to enable [parallel function calling](https://platform.openai.com/docs/guides/function-calling#configuring-parallel-function-calling) during tool use.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) parallel_tool_calls > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prediction > (schema) + (resource) chat.completions > (model) chat_completion_prediction_content > (schema) > (property) content > (variant) 0>)
List[[ChatCompletionContentPartText](</api/reference/python/resources/chat#(resource) chat.completions > (model) chat_completion_content_part_text > (schema)>)]
...
text: str
The text content.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prediction > (schema) + (resource) chat.completions > (model) chat_completion_content_part_text > (schema) > (property) text>)
type: Literal["text"]
The type of the content part.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prediction > (schema) + (resource) chat.completions > (model) chat_completion_content_part_text > (schema) > (property) type>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prediction > (schema) + (resource) chat.completions > (model) chat_completion_prediction_content > (schema) > (property) content > (variant) 1>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prediction > (schema) + (resource) chat.completions > (model) chat_completion_prediction_content > (schema) > (property) content>)
type: Literal["content"]
The type of the predicted content you want to provide. This type is
currently always `content`.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prediction > (schema) + (resource) chat.completions > (model) chat_completion_prediction_content > (schema) > (property) type>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prediction > (schema)>)
...
minimum-2
maximum2
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) presence_penalty > (schema)>)
prompt\_cache\_key: Optional[str]
Used by OpenAI to cache responses for similar requests to optimize your cache hit rates. Replaces the `user` field. [Learn more](https://platform.openai.com/docs/guides/prompt-caching).
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prompt_cache_key > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) prompt_cache_retention > (schema)>)
...
One of the following:
"none"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 0>)
"minimal"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 1>)
"low"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 2>)
"medium"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 3>)
"high"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 4>)
"xhigh"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 5>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) reasoning_effort > (schema)>)
response\_format: Optional[[ResponseFormat](</api/reference/python/resources/chat/subresources/completions/methods/create#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) response_format > (schema)>)]
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) response_format > (schema)>)
...
maxLength64
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) safety_identifier > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) seed > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) service_tier > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) stop > (schema)>)
store: Optional[bool]
Whether or not to store the output of this chat completion request for
use in our [model distillation](https://platform.openai.com/docs/guides/distillation) or
[evals](https://platform.openai.com/docs/guides/evals) products.
Supports text and image inputs. Note: image inputs over 8MB will be dropped.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) store > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) stream > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) stream_options > (schema) + (resource) chat.completions > (model) chat_completion_stream_options > (schema) > (property) include_obfuscation>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) stream_options > (schema) + (resource) chat.completions > (model) chat_completion_stream_options > (schema) > (property) include_usage>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) stream_options > (schema)>)
temperature: Optional[float]
What sampling temperature to use, between 0 and 2. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic.
We generally recommend altering this or `top\_p` but not both.
minimum0
maximum2
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) temperature > (schema)>)
tool\_choice: Optional[[ChatCompletionToolChoiceOptionParam](</api/reference/python/resources/chat#(resource) chat.completions > (model) chat_completion_tool_choice_option > (schema)>)]
...
One of the following:
"none"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_tool_choice_option > (schema) > (variant) 0 > (member) 0>)
"auto"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_tool_choice_option > (schema) > (variant) 0 > (member) 1>)
"required"
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_tool_choice_option > (schema) > (variant) 0 > (member) 2>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_tool_choice_option > (schema) > (variant) 0>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_allowed_tool_choice > (schema) > (property) allowed_tools>)
type: Literal["allowed\_tools"]
Allowed tool configuration type. Always `allowed\_tools`.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_allowed_tool_choice > (schema) > (property) type>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_allowed_tool_choice > (schema)>)
class ChatCompletionNamedToolChoice: …
Specifies a tool the model should use. Use to force the model to call a specific function.
function: Function
name: str
The name of the function to call.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice > (schema) > (property) function > (property) name>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice > (schema) > (property) function>)
type: Literal["function"]
For function calling, the type is always `function`.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice > (schema) > (property) type>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice > (schema)>)
class ChatCompletionNamedToolChoiceCustom: …
Specifies a tool the model should use. Use to force the model to call a specific custom tool.
custom: Custom
name: str
The name of the custom tool to call.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice_custom > (schema) > (property) custom > (property) name>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice_custom > (schema) > (property) custom>)
type: Literal["custom"]
For custom tool calling, the type is always `custom`.
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice_custom > (schema) > (property) type>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema) + (resource) chat.completions > (model) chat_completion_named_tool_choice_custom > (schema)>)
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tool_choice > (schema)>)
tools: Optional[Iterable[[ChatCompletionToolUnionParam](</api/reference/python/resources/chat#(resource) chat.completions > (model) chat_completion_tool > (schema)>)]]
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) tools > (schema)>)
...
minimum0
maximum20
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) top_logprobs > (schema)>)
...
minimum0
maximum1
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) top_p > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) user > (schema)>)
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) verbosity > (schema)>)
web\_search\_options: Optional[[WebSearchOptions](</api/reference/python/resources/chat/subresources/completions/methods/create#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) web_search_options > (schema)>)]
...
[](<#(resource) chat.completions > (method) create > (params) default.non_streaming > (param) web_search_options > (schema)>)
