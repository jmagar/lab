...
maxLength32000
minLength1
[](<#(resource) videos > (method) edit > (params) default > (param) body > (schema) > (property) prompt>)
Video video
Reference to the completed video to edit.
String
[](<#(resource) videos > (method) edit > (params) default > (param) body > (schema) > (property) video > (variant) 0>)
class VideoReferenceInputParam:
Reference to the completed video.
String id
The identifier of the completed video.
[](<#(resource) videos > (method) edit > (params) default > (param) body > (schema) > (property) video > (variant) 1 > (property) id>)
[](<#(resource) videos > (method) edit > (params) default > (param) body > (schema) > (property) video > (variant) 1>)
[](<#(resource) videos > (method) edit > (params) default > (param) body > (schema) > (property) video>)
[](<#(resource) videos > (method) edit > (params) default>)
