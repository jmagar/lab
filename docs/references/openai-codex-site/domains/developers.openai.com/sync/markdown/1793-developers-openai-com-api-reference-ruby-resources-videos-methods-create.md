...
input\_reference: String | [ImageInputReferenceParam](</api/reference/ruby/resources/videos#(resource) videos > (model) image_input_reference_param > (schema)>) { file\_id, image\_url }
...
seconds: [VideoSeconds](</api/reference/ruby/resources/videos#(resource) videos > (model) video_seconds > (schema)>)
