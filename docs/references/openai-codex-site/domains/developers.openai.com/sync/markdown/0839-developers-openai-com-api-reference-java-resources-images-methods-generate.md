...
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) prompt>)
...
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) background > (member) 0>)
OPAQUE("opaque")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) background > (member) 1>)
AUTO("auto")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) background > (member) 2>)
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) background>)
...
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) model>)
...
LOW("low")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) moderation > (member) 0>)
AUTO("auto")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) moderation > (member) 1>)
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) moderation>)
Optional\<Long\> n
The number of images to generate. Must be between 1 and 10. For `dall-e-3`, only `n=1` is supported.
minimum1
maximum10
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) n>)
...
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) output_compression>)
...
PNG("png")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) output_format > (member) 0>)
JPEG("jpeg")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) output_format > (member) 1>)
WEBP("webp")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) output_format > (member) 2>)
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) output_format>)
...
maximum3
minimum0
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) partial_images>)
...
STANDARD("standard")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) quality > (member) 0>)
HD("hd")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) quality > (member) 1>)
LOW("low")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) quality > (member) 2>)
MEDIUM("medium")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) quality > (member) 3>)
HIGH("high")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) quality > (member) 4>)
AUTO("auto")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) quality > (member) 5>)
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) quality>)
...
URL("url")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) response_format > (member) 0>)
B64\_JSON("b64\_json")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) response_format > (member) 1>)
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) response_format>)
Optional\<Size\> size
...
AUTO("auto")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 0>)
\_1024X1024("1024x1024")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 1>)
\_1536X1024("1536x1024")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 2>)
\_1024X1536("1024x1536")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 3>)
\_256X256("256x256")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 4>)
\_512X512("512x512")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 5>)
\_1792X1024("1792x1024")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 6>)
\_1024X1792("1024x1792")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size > (member) 7>)
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) size>)
Optional\<Style\> style
The style of the generated images. This parameter is only supported for `dall-e-3`. Must be one of `vivid` or `natural`. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images.
VIVID("vivid")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) style > (member) 0>)
NATURAL("natural")
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) style > (member) 1>)
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) style>)
Optional\<String\> user
A unique identifier representing your end-user, which can help OpenAI to monitor and detect abuse. [Learn more](https://platform.openai.com/docs/guides/safety-best-practices#end-user-ids).
[](<#(resource) images > (method) generate > (params) default.non_streaming > (param) body > (schema) > (property) user>)
