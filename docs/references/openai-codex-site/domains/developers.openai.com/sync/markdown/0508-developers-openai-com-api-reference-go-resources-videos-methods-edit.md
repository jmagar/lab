...
maxLength32000
minLength1
[](<#(resource) videos > (method) edit > (params) default > (param) prompt>)
Video param.Field[[VideoEditParamsVideoUnion](</api/reference/go/resources/videos/methods/edit#(resource) videos > (method) edit > (params) default > (param) video > (schema)>)]
...
[](<#(resource) videos > (method) edit > (params) default > (param) video>)
