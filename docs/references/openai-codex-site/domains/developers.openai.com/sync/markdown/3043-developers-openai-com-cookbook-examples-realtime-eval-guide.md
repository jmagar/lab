...
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/Realtime_eval_guide.ipynb)
## Introduction
...
>
**> Customer Example:
**> one large company had execs spend
**> ~3 hours/day
**> just listening to sessions and scanning traces. They surfaced “hidden” issues, early cutoffs, phantom interruptions, awkward prosody, that would’ve sailed past offline evals.
>
