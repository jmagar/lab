...
AllModels = (string & {}) | [ChatModel](</api/reference/typescript/resources/$shared#(resource) $shared > (model) chat_model > (schema)>) | "o1-pro" | "o1-pro-2025-03-19" | "o3-pro" | 11 more
...
Reasoning { effort, generate\_summary, summary }
...
ResponsesModel = (string & {}) | [ChatModel](</api/reference/typescript/resources/$shared#(resource) $shared > (model) chat_model > (schema)>) | "o1-pro" | "o1-pro-2025-03-19" | "o3-pro" | 11 more
One of the following:
(string & {})
