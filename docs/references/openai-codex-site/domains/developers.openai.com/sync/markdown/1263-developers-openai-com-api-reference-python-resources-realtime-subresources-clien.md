...
expires\_after: Optional[[ExpiresAfter](</api/reference/python/resources/realtime/subresources/client_secrets/methods/create#(resource) realtime.client_secrets > (method) create > (params) default > (param) expires_after > (schema)>)]
...
session: Optional[[Session](</api/reference/python/resources/realtime/subresources/client_secrets/methods/create#(resource) realtime.client_secrets > (method) create > (params) default > (param) session > (schema)>)]
...
client\_secret = client.realtime.client\_secrets.create()
print(client\_secret.expires\_at)`
```
```
`{
