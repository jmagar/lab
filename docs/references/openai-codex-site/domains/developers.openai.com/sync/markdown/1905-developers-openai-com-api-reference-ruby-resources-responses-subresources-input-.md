...
responses.input\_tokens.count(\*\*kwargs) -\> [InputTokenCountResponse](</api/reference/ruby/resources/responses#(resource) responses.input_tokens > (model) input_token_count_response > (schema)>) { input\_tokens, object }
...
conversation: String | [ResponseConversationParam](</api/reference/ruby/resources/responses#(resource) responses > (model) response_conversation_param > (schema)>) { id }
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) conversation > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) input > (schema)>)
instructions: String
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) instructions > (schema)>)
model: String
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) model > (schema)>)
parallel\_tool\_calls: bool
Whether to allow the model to run tool calls in parallel.
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) parallel_tool_calls > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) previous_response_id > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) effort>)
...
One of the following:
:auto
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary > (member) 0>)
:concise
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary > (member) 1>)
:detailed
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary > (member) 2>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) generate_summary>)
...
One of the following:
:auto
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) summary > (member) 0>)
:concise
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) summary > (member) 1>)
:detailed
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) summary > (member) 2>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema) + (resource) $shared > (model) reasoning > (schema) > (property) summary>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) reasoning > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) text > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) tool_choice > (schema)>)
tools: Array[[Tool](</api/reference/ruby/resources/responses#(resource) responses > (model) tool > (schema)>)]
...
[](<#(resource) responses > (model) apply_patch_tool > (schema) > (property) type>)
[](<#(resource) responses > (model) apply_patch_tool > (schema)>)
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) tools > (schema)>)
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) truncation > (schema)>)
...
[](<#(resource) responses.input_tokens > (model) input_token_count_response > (schema)>)
### Get input token counts
Ruby
HTTP
HTTP
...
response = openai.responses.input\_tokens.count(model: "gpt-5", input: "Tell me a joke.")
puts(response)
`
```
```
