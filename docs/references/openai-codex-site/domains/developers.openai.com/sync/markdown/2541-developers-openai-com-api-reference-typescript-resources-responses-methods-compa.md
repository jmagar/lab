...
**View as Markdown**
# Compact a response
client.responses.compact(ResponseCompactParams { model, input, instructions, 3 more } body, RequestOptionsoptions?): [CompactedResponse](</api/reference/typescript/resources/responses#(resource) responses > (model) compacted_response > (schema)>) { id, created\_at, object, 2 more }
...
body: ResponseCompactParams { model, input, instructions, 3 more }
...
input?: string | Array\<[ResponseInputItem](</api/reference/typescript/resources/responses#(resource) responses > (model) response_input_item > (schema)>)\> | null
...
{
id: "msg\_030d085c0b53e67e0069332e3a72d4819c96c6f2c4adc15d33",
type: "message",
status: "completed",
content: [
{
