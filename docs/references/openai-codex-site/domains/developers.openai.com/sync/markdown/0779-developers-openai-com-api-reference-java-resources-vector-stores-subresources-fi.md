...
String
[](<#(resource) vector_stores.files > (method) update > (params) default > (param) body > (schema) > (property) attributes > (items) > (variant) 0>)
double
[](<#(resource) vector_stores.files > (method) update > (params) default > (param) body > (schema) > (property) attributes > (items) > (variant) 1>)
boolean
[](<#(resource) vector_stores.files > (method) update > (params) default > (param) body > (schema) > (property) attributes > (items) > (variant) 2>)
[](<#(resource) vector_stores.files > (method) update > (params) default > (param) body > (schema) > (property) attributes>)
