...
ExpiresAfter param.Field[[VectorStoreUpdateParamsExpiresAfter](</api/reference/go/resources/vector_stores/methods/update#(resource) vector_stores > (method) update > (params) default > (param) expires_after > (schema)>)]Optional
The expiration policy for a vector store.
Anchor LastActiveAt
Anchor timestamp after which the expiration policy applies. Supported anchors: `last\_active\_at`.
[](<#(resource) vector_stores > (method) update > (params) default > (param) expires_after > (schema) > (property) anchor>)
Days int64
The number of days after the anchor time that the vector store will expire.
minimum1
maximum365
[](<#(resource) vector_stores > (method) update > (params) default > (param) expires_after > (schema) > (property) days>)
[](<#(resource) vector_stores > (method) update > (params) default > (param) expires_after>)
...
[](<#(resource) vector_stores > (method) update > (params) default > (param) metadata>)
Name param.Field[string]Optional
The name of the vector store.
[](<#(resource) vector_stores > (method) update > (params) default > (param) name>)
[](<#(resource) vector_stores > (method) update > (params) default>)
