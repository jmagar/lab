...
Sep 17, 2024
# GPT Actions library - Canvas Learning Management System
[ KS ](https://www.linkedin.com/in/keelanschule/)[ JC ](https://github.com/joecasson-openai)
[ Keelan Schule
(OpenAI)
, ](https://www.linkedin.com/in/keelanschule/)[ Joe Casson
(OpenAI)
](https://github.com/joecasson-openai)
[
View on GitHub
](https://github.com/openai/openai-cookbook/blob/main/examples/chatgpt/gpt_actions_library/gpt_action_canvas.md) [
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/chatgpt/gpt_actions_library/gpt_action_canvas.md)
...
* Canvas uses the term `redirect\_uri` where ChatGPT uses the term `Callback URL` for URL to complete the redirect process after successful authentication.
...
'404':
description: Course not found, possibly due to an invalid course ID.
/courses/{course\_id}/modules/{module\_id}/items:
get:
