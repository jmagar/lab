...
maxLength32000
minLength1
[](<#(resource) videos > (method) extend > (params) 0 > (param) prompt > (schema)>)
seconds: [VideoSeconds](</api/reference/resources/videos#(resource) videos > (model) video_seconds > (schema)>)
Length of the newly generated extension segment in seconds (allowed values: 4, 8, 12, 16, 20).
One of the following:
"4"
[](<#(resource) videos > (method) extend > (params) 0 > (param) seconds > (schema) + (resource) videos > (model) video_seconds > (schema) > (member) 0>)
"8"
[](<#(resource) videos > (method) extend > (params) 0 > (param) seconds > (schema) + (resource) videos > (model) video_seconds > (schema) > (member) 1>)
"12"
[](<#(resource) videos > (method) extend > (params) 0 > (param) seconds > (schema) + (resource) videos > (model) video_seconds > (schema) > (member) 2>)
[](<#(resource) videos > (method) extend > (params) 0 > (param) seconds > (schema)>)
video: object { id }
Reference to the completed video to extend.
id: string
The identifier of the completed video.
[](<#(resource) videos > (method) extend > (params) 0 > (param) video > (schema) > (property) id>)
[](<#(resource) videos > (method) extend > (params) 0 > (param) video > (schema)>)
