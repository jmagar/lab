...
[](<#(resource) batches > (method) create > (params) 0 > (param) completion_window > (schema)>)
...
"/v1/responses"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 0>)
"/v1/chat/completions"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 1>)
"/v1/embeddings"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 2>)
"/v1/completions"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 3>)
"/v1/moderations"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 4>)
"/v1/images/generations"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 5>)
"/v1/images/edits"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 6>)
"/v1/videos"
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema) > (member) 7>)
[](<#(resource) batches > (method) create > (params) 0 > (param) endpoint > (schema)>)
input\_file\_id: string
The ID of an uploaded file that contains requests for the new batch.
See [upload file](/docs/api-reference/files/create) for how to upload a file.
Your input file must be formatted as a [JSONL file](/docs/api-reference/batch/request-input), and must be uploaded with the purpose `batch`. The file can contain up to 50,000 requests, and can be up to 200 MB in size.
[](<#(resource) batches > (method) create > (params) 0 > (param) input_file_id > (schema)>)
...
[](<#(resource) batches > (method) create > (params) 0 > (param) metadata > (schema)>)
...
[](<#(resource) batches > (method) create > (params) 0 > (param) output_expires_after > (schema) > (property) anchor>)
seconds: number
The number of seconds after the anchor time that the file will expire. Must be between 3600 (1 hour) and 2592000 (30 days).
formatint64
minimum3600
maximum2592000
[](<#(resource) batches > (method) create > (params) 0 > (param) output_expires_after > (schema) > (property) seconds>)
[](<#(resource) batches > (method) create > (params) 0 > (param) output_expires_after > (schema)>)
