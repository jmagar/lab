...
responses.input\_tokens.count(InputTokenCountParams\*\*kwargs) -\> [InputTokenCountResponse](</api/reference/python/resources/responses#(resource) responses.input_tokens > (model) input_token_count_response > (schema)>)
...
conversation: Optional[[Conversation](</api/reference/python/resources/responses/subresources/input_tokens/methods/count#(resource) responses.input_tokens > (method) count > (params) default > (param) conversation > (schema)>)]
...
text: Optional[[Text](</api/reference/python/resources/responses/subresources/input_tokens/methods/count#(resource) responses.input_tokens > (method) count > (params) default > (param) text > (schema)>)]
...
tool\_choice: Optional[[ToolChoice](</api/reference/python/resources/responses/subresources/input_tokens/methods/count#(resource) responses.input_tokens > (method) count > (params) default > (param) tool_choice > (schema)>)]
...
[](<#(resource) responses.input_tokens > (method) count > (params) default > (param) tool_choice > (schema) > (variant) 0>)
