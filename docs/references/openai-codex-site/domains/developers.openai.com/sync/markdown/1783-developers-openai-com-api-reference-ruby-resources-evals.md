...
evals.create(\*\*kwargs) -\> [EvalCreateResponse](</api/reference/ruby/resources/evals#(resource) evals > (model) eval_create_response > (schema)>) { id, created\_at, data\_source\_config, 4 more }
POST/evals
...
evals.update(eval\_id, \*\*kwargs) -\> [EvalUpdateResponse](</api/reference/ruby/resources/evals#(resource) evals > (model) eval_update_response > (schema)>) { id, created\_at, data\_source\_config, 4 more }
POST/evals/{eval\_id}
...
evals.runs.list(eval\_id, \*\*kwargs) -\> CursorPage\<[RunListResponse](</api/reference/ruby/resources/evals#(resource) evals.runs > (model) run_list_response > (schema)>) { id, created\_at, data\_source, 11 more } \>
GET/evals/{eval\_id}/runs
##### [Create eval run](/api/reference/ruby/resources/evals/subresources/runs/methods/create)
evals.runs.create(eval\_id, \*\*kwargs) -\> [RunCreateResponse](</api/reference/ruby/resources/evals#(resource) evals.runs > (model) run_create_response > (schema)>) { id, created\_at, data\_source, 11 more }
POST/evals/{eval\_id}/runs
##### [Get an eval run](/api/reference/ruby/resources/evals/subresources/runs/methods/retrieve)
evals.runs.retrieve(run\_id, \*\*kwargs) -\> [RunRetrieveResponse](</api/reference/ruby/resources/evals#(resource) evals.runs > (model) run_retrieve_response > (schema)>) { id, created\_at, data\_source, 11 more }
...
evals.runs.output\_items.list(run\_id, \*\*kwargs) -\> CursorPage\<[OutputItemListResponse](</api/reference/ruby/resources/evals#(resource) evals.runs.output_items > (model) output_item_list_response > (schema)>) { id, created\_at, datasource\_item, 7 more } \>
