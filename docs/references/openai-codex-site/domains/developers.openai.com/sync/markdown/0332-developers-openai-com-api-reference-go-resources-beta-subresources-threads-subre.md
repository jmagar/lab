...
[](<#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) after>)
Before param.Field[string]Optional
A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with obj\_foo, your subsequent call can include before=obj\_foo in order to fetch the previous page of the list.
[](<#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) before>)
...
[](<#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) include>)
Limit param.Field[int64]Optional
A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20.
[](<#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) limit>)
Order param.Field[[BetaThreadRunStepListParamsOrder](</api/reference/go/resources/beta/subresources/threads/subresources/runs/subresources/steps/methods/list#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) order > (schema)>)]Optional
Sort order by the `created\_at` timestamp of the objects. `asc` for ascending order and `desc` for descending order.
const BetaThreadRunStepListParamsOrderAsc [BetaThreadRunStepListParamsOrder](</api/reference/go/resources/beta/subresources/threads/subresources/runs/subresources/steps/methods/list#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) order > (schema)>) = "asc"
[](<#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) order > (schema) > (member) 0>)
const BetaThreadRunStepListParamsOrderDesc [BetaThreadRunStepListParamsOrder](</api/reference/go/resources/beta/subresources/threads/subresources/runs/subresources/steps/methods/list#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) order > (schema)>) = "desc"
[](<#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) order > (schema) > (member) 1>)
[](<#(resource) beta.threads.runs.steps > (method) list > (params) default > (param) order>)
