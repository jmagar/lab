...
**View as Markdown**
# List input items
responses.input\_items.list(response\_id, \*\*kwargs) -\> CursorPage\<[ResponseItem](</api/reference/ruby/resources/responses#(resource) responses > (model) response_item > (schema)>)\>
...
include: Array[[ResponseIncludable](</api/reference/ruby/resources/responses#(resource) responses > (model) response_includable > (schema)>)]
...
ResponseItem = [ResponseInputMessageItem](</api/reference/ruby/resources/responses#(resource) responses > (model) response_input_message_item > (schema)>) { id, content, role, 2 more } | [ResponseOutputMessage](</api/reference/ruby/resources/responses#(resource) responses > (model) response_output_message > (schema)>) { id, content, role, 3 more } | [ResponseFileSearchToolCall](</api/reference/ruby/resources/responses#(resource) responses > (model) response_file_search_tool_call > (schema)>) { id, queries, status, 2 more } | 23 more
...
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) id>)
result: String
The generated image encoded in base64.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) result>)
status: :in\_progress | :completed | :generating | :failed
The status of the image generation call.
One of the following:
:in\_progress
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) status > (member) 0>)
:completed
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) status > (member) 1>)
:generating
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) status > (member) 2>)
:failed
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) status > (member) 3>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) status>)
type: :image\_generation\_call
The type of the image generation call. Always `image\_generation\_call`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12 > (property) type>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 12>)
...
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) id>)
action: Action{ command, env, type, 3 more}
Execute a shell command on the server.
command: Array[String]
The command to run.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) action > (property) command>)
env: Hash[Symbol, String]
Environment variables to set for the command.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) action > (property) env>)
type: :exec
The type of the local shell action. Always `exec`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) action > (property) type>)
timeout\_ms: Integer
Optional timeout in milliseconds for the command.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) action > (property) timeout_ms>)
user: String
Optional user to run the command as.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) action > (property) user>)
working\_directory: String
Optional working directory to run the command in.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) action > (property) working_directory>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) action>)
call\_id: String
The unique ID of the local shell tool call generated by the model.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) call_id>)
status: :in\_progress | :completed | :incomplete
The status of the local shell call.
One of the following:
:in\_progress
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) status > (member) 0>)
:completed
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) status > (member) 1>)
:incomplete
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) status > (member) 2>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) status>)
type: :local\_shell\_call
The type of the local shell call. Always `local\_shell\_call`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14 > (property) type>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 14>)
class LocalShellCallOutput { id, output, type, status }
The output of a local shell tool call.
id: String
The unique ID of the local shell tool call generated by the model.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15 > (property) id>)
output: String
A JSON string of the output of the local shell tool call.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15 > (property) output>)
type: :local\_shell\_call\_output
The type of the local shell tool call output. Always `local\_shell\_call\_output`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15 > (property) type>)
status: :in\_progress | :completed | :incomplete
The status of the item. One of `in\_progress`, `completed`, or `incomplete`.
One of the following:
:in\_progress
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15 > (property) status > (member) 0>)
:completed
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15 > (property) status > (member) 1>)
:incomplete
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15 > (property) status > (member) 2>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15 > (property) status>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 15>)
...
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) id>)
server\_label: String
The label of the MCP server.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) server_label>)
tools: Array[Tool{ input\_schema, name, annotations, description}]
The tools available on the server.
input\_schema: untyped
The JSON schema describing the tool’s input.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) tools > (items) > (property) input_schema>)
name: String
The name of the tool.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) tools > (items) > (property) name>)
annotations: untyped
Additional annotations about the tool.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) tools > (items) > (property) annotations>)
description: String
The description of the tool.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) tools > (items) > (property) description>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) tools>)
type: :mcp\_list\_tools
The type of the item. Always `mcp\_list\_tools`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) type>)
error: String
Error message if the server could not list tools.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20 > (property) error>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 20>)
class McpApprovalRequest { id, arguments, name, 2 more }
A request for human approval of a tool invocation.
id: String
The unique ID of the approval request.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 21 > (property) id>)
arguments: String
A JSON string of arguments for the tool.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 21 > (property) arguments>)
name: String
The name of the tool to run.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 21 > (property) name>)
server\_label: String
The label of the MCP server making the request.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 21 > (property) server_label>)
type: :mcp\_approval\_request
The type of the item. Always `mcp\_approval\_request`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 21 > (property) type>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 21>)
class McpApprovalResponse { id, approval\_request\_id, approve, 2 more }
A response to an MCP approval request.
id: String
The unique ID of the approval response
[](<#(resource) responses > (model) response_item > (schema) > (variant) 22 > (property) id>)
approval\_request\_id: String
The ID of the approval request being answered.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 22 > (property) approval_request_id>)
approve: bool
Whether the request was approved.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 22 > (property) approve>)
type: :mcp\_approval\_response
The type of the item. Always `mcp\_approval\_response`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 22 > (property) type>)
reason: String
Optional reason for the decision.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 22 > (property) reason>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 22>)
class McpCall { id, arguments, name, 6 more }
An invocation of a tool on an MCP server.
id: String
The unique ID of the tool call.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) id>)
arguments: String
A JSON string of the arguments passed to the tool.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) arguments>)
name: String
The name of the tool that was run.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) name>)
server\_label: String
The label of the MCP server running the tool.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) server_label>)
type: :mcp\_call
The type of the item. Always `mcp\_call`.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) type>)
approval\_request\_id: String
...
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) approval_request_id>)
error: String
The error from the tool call, if any.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) error>)
output: String
The output from the tool call.
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) output>)
status: :in\_progress | :completed | :incomplete | 2 more
The status of the tool call. One of `in\_progress`, `completed`, `incomplete`, `calling`, or `failed`.
One of the following:
:in\_progress
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) status > (member) 0>)
:completed
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) status > (member) 1>)
:incomplete
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) status > (member) 2>)
:calling
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) status > (member) 3>)
:failed
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) status > (member) 4>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23 > (property) status>)
[](<#(resource) responses > (model) response_item > (schema) > (variant) 23>)
class ResponseCustomToolCallItem { id, status, created\_by }
A call to a custom tool created by the model.
id: String
The unique ID of the custom tool call item.
[](<#(resource) responses > (model) response_custom_tool_call_item > (schema) > (entry) 1 > (property) id>)
status: :in\_progress | :completed | :incomplete
The status of the item. One of `in\_progress`, `completed`, or
`incomplete`. Populated when items are returned via API.
One of the following:
:in\_progress
[](<#(resource) responses > (model) response_custom_tool_call_item > (schema) > (entry) 1 > (property) status > (member) 0>)
:completed
[](<#(resource) responses > (model) response_custom_tool_call_item > (schema) > (entry) 1 > (property) status > (member) 1>)
:incomplete
[](<#(resource) responses > (model) response_custom_tool_call_item > (schema) > (entry) 1 > (property) status > (member) 2>)
[](<#(resource) responses > (model) response_custom_tool_call_item > (schema) > (entry) 1 > (property) status>)
created\_by: String
The identifier of the actor that created the item.
[](<#(resource) responses > (model) response_custom_tool_call_item > (schema) > (entry) 1 > (property) created_by>)
[](<#(resource) responses > (model) response_custom_tool_call_item > (schema)>)
...
[](<#(resource) responses > (model) response_item > (schema)>)
### List input items
Ruby
HTTP
HTTP
...
page = openai.responses.input\_items.list("response\_id")
puts(page)`
```
```
`{
