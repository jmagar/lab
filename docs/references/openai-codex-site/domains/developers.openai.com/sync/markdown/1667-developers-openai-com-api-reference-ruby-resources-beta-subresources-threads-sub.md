...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) content > (schema)>)
role: :user | :assistant
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) role > (schema)>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) attachments > (schema)>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) metadata > (schema)>)
...
message = openai.beta.threads.messages.create("thread\_id", content: "string", role: :user)
puts(message)`
```
```
`{
