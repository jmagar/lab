...
Optional\<[Metadata](</api/reference/java/resources/chat/subresources/completions/methods/list#(resource) chat.completions > (method) list > (params) default > (param) metadata > (schema)>)\> metadata
...
Optional\<[Order](</api/reference/java/resources/chat/subresources/completions/methods/list#(resource) chat.completions > (method) list > (params) default > (param) order > (schema)>)\> order
