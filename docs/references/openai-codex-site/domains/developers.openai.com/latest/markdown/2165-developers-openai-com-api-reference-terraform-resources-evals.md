...
#### resource openai\_eval
##### required Expand Collapse
data\_source\_config: Attributes
The configuration for the data source used for the evaluation runs. Dictates the schema of the data used in the evaluation.
item\_schema?: Map[JSON]
The json schema for each row in the data source.
[](<#(resource) evals > (terraform resource) > (attribute) data_source_config > (attribute) item_schema>)
type?: String
The type of data source. Always `custom`.
[](<#(resource) evals > (terraform resource) > (attribute) data_source_config > (attribute) type>)
include\_sample\_schema?: Bool
Whether the eval should expect you to populate the sample namespace (ie, by generating responses off of your data source)
[](<#(resource) evals > (terraform resource) > (attribute) data_source_config > (attribute) include_sample_schema>)
metadata?: Map[JSON]
Metadata filters for the logs data source.
[](<#(resource) evals > (terraform resource) > (attribute) data_source_config > (attribute) metadata>)
[](<#(resource) evals > (terraform resource) > (attribute) data_source_config>)
testing\_criteria: List[Attributes]
...
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) input > (attribute) content>)
role: String
The role of the message (e.g. “system”, “assistant”, “user”).
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) input > (attribute) role>)
type?: String
The type of the message input. Always `message`.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) input > (attribute) type>)
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) input>)
labels?: List[String]
The labels to classify to each item in the evaluation.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) labels>)
model?: String
The model to use for the evaluation. Must support structured outputs.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) model>)
name: String
The name of the grader.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) name>)
passing\_labels?: List[String]
The labels that indicate a passing result. Must be a subset of labels.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) passing_labels>)
type?: String
The object type, which is always `label\_model`.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) type>)
operation?: String
The string check operation to perform. One of `eq`, `ne`, `like`, or `ilike`.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) operation>)
reference?: String
The reference text. This may include template strings.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) reference>)
...
or `rouge\_l`.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) evaluation_metric>)
pass\_threshold?: Float64
The threshold for the score.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) pass_threshold>)
source?: String
The source code of the python script.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) source>)
image\_tag?: String
The image tag to use for the python script.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) image_tag>)
range?: List[Float64]
The range of the score. Defaults to `[0, 1]`.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) range>)
sampling\_params?: Attributes
The sampling parameters for the model.
max\_completions\_tokens?: Int64
The maximum number of tokens the grader model may generate in its response.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) max_completions_tokens>)
...
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) reasoning_effort>)
seed?: Int64
A seed value to initialize the randomness, during sampling.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) seed>)
temperature?: Float64
A higher temperature increases randomness in the outputs.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) temperature>)
top\_p?: Float64
An alternative to temperature for nucleus sampling; 1.0 includes all tokens.
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) top_p>)
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria > (attribute) sampling_params>)
[](<#(resource) evals > (terraform resource) > (attribute) testing_criteria>)
##### optional Expand Collapse
name?: String
The name of the evaluation.
[](<#(resource) evals > (terraform resource) > (attribute) name>)
metadata?: Map[String]
...
[](<#(resource) evals > (terraform resource) > (attribute) metadata>)
##### computed Expand Collapse
id: String
Unique identifier for the evaluation.
[](<#(resource) evals > (terraform resource) > (attribute) id>)
created\_at: Int64
The Unix timestamp (in seconds) for when the eval was created.
[](<#(resource) evals > (terraform resource) > (attribute) created_at>)
object: String
The object type.
[](<#(resource) evals > (terraform resource) > (attribute) object>)
#### data openai\_eval
##### optional Expand Collapse
eval\_id?: String
[](<#(resource) evals > (terraform datasource-single) > (attribute) eval_id>)
find\_one\_by?: Attributes
order?: String
Sort order for evals by timestamp. Use `asc` for ascending order or `desc` for descending order.
[](<#(resource) evals > (terraform datasource-single) > (attribute) find_one_by > (attribute) order>)
order\_by?: String
...
[](<#(resource) evals > (terraform datasource-single) > (attribute) find_one_by > (attribute) order_by>)
[](<#(resource) evals > (terraform datasource-single) > (attribute) find_one_by>)
##### computed Expand Collapse
id: String
[](<#(resource) evals > (terraform datasource-single) > (attribute) id>)
created\_at: Int64
The Unix timestamp (in seconds) for when the eval was created.
[](<#(resource) evals > (terraform datasource-single) > (attribute) created_at>)
name: String
The name of the evaluation.
[](<#(resource) evals > (terraform datasource-single) > (attribute) name>)
object: String
The object type.
[](<#(resource) evals > (terraform datasource-single) > (attribute) object>)
metadata: Map[String]
Set of 16 key-value pairs that can be attached to an object. This can be
useful for storing additional information about the object in a structured
format, and querying for objects via API or the dashboard.
Keys are strings with a maximum length of 64 characters. Values are strings
with a maximum length of 512 characters.
[](<#(resource) evals > (terraform datasource-single) > (attribute) metadata>)
data\_source\_config: Attributes
Configuration of data sources used in runs of the evaluation.
schema: Map[JSON]
The json schema for the run data source items.
Learn how to build JSON schemas [here](https://json-schema.org/).
[](<#(resource) evals > (terraform datasource-single) > (attribute) data_source_config > (attribute) schema>)
type: String
The type of data source. Always `custom`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) data_source_config > (attribute) type>)
metadata: Map[String]
Set of 16 key-value pairs that can be attached to an object. This can be
useful for storing additional information about the object in a structured
format, and querying for objects via API or the dashboard.
Keys are strings with a maximum length of 64 characters. Values are strings
with a maximum length of 512 characters.
[](<#(resource) evals > (terraform datasource-single) > (attribute) data_source_config > (attribute) metadata>)
[](<#(resource) evals > (terraform datasource-single) > (attribute) data_source_config>)
testing\_criteria: List[Attributes]
A list of testing criteria.
input: List[Attributes]
content: String
Inputs to the model - can contain template strings. Supports text, output text, input images, and input audio, either as a single item or an array of items.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) input > (attribute) content>)
role: String
The role of the message input. One of `user`, `assistant`, `system`, or
`developer`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) input > (attribute) role>)
type: String
The type of the message input. Always `message`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) input > (attribute) type>)
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) input>)
labels: List[String]
The labels to assign to each item in the evaluation.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) labels>)
model: String
The model to use for the evaluation. Must support structured outputs.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) model>)
name: String
The name of the grader.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) name>)
passing\_labels: List[String]
The labels that indicate a passing result. Must be a subset of labels.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) passing_labels>)
type: String
The object type, which is always `label\_model`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) type>)
operation: String
The string check operation to perform. One of `eq`, `ne`, `like`, or `ilike`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) operation>)
reference: String
The reference text. This may include template strings.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) reference>)
evaluation\_metric: String
The evaluation metric to use. One of `cosine`, `fuzzy\_match`, `bleu`,
`gleu`, `meteor`, `rouge\_1`, `rouge\_2`, `rouge\_3`, `rouge\_4`, `rouge\_5`,
or `rouge\_l`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) evaluation_metric>)
pass\_threshold: Float64
The threshold for the score.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) pass_threshold>)
source: String
The source code of the python script.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) source>)
image\_tag: String
The image tag to use for the python script.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) image_tag>)
range: List[Float64]
The range of the score. Defaults to `[0, 1]`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) range>)
sampling\_params: Attributes
The sampling parameters for the model.
max\_completions\_tokens: Int64
The maximum number of tokens the grader model may generate in its response.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) max_completions_tokens>)
reasoning\_effort: String
Constrains effort on reasoning for
[reasoning models](https://platform.openai.com/docs/guides/reasoning).
Currently supported values are `none`, `minimal`, `low`, `medium`, `high`, and `xhigh`. Reducing
...
* The `gpt-5-pro` model defaults to (and only supports) `high` reasoning effort.
* `xhigh` is supported for all models after `gpt-5.1-codex-max`.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) reasoning_effort>)
seed: Int64
A seed value to initialize the randomness, during sampling.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) seed>)
temperature: Float64
A higher temperature increases randomness in the outputs.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) temperature>)
top\_p: Float64
An alternative to temperature for nucleus sampling; 1.0 includes all tokens.
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) sampling_params > (attribute) top_p>)
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria > (attribute) sampling_params>)
[](<#(resource) evals > (terraform datasource-single) > (attribute) testing_criteria>)
#### data openai\_evals
##### optional Expand Collapse
order?: String
Sort order for evals by timestamp. Use `asc` for ascending order or `desc` for descending order.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) order>)
order\_by?: String
Evals can be ordered by creation time or last updated time. Use
`created\_at` for creation time or `updated\_at` for last updated time.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) order_by>)
max\_items?: Int64
Max items to fetch, default: 1000
[](<#(resource) evals > (terraform datasource-plural) > (attribute) max_items>)
##### computed Expand Collapse
items: List[Attributes]
The items returned by the data source
id: String
Unique identifier for the evaluation.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) id>)
created\_at: Int64
The Unix timestamp (in seconds) for when the eval was created.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) created_at>)
data\_source\_config: Attributes
Configuration of data sources used in runs of the evaluation.
schema: Map[JSON]
The json schema for the run data source items.
Learn how to build JSON schemas [here](https://json-schema.org/).
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) data_source_config > (attribute) schema>)
type: String
The type of data source. Always `custom`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) data_source_config > (attribute) type>)
metadata: Map[String]
Set of 16 key-value pairs that can be attached to an object. This can be
useful for storing additional information about the object in a structured
format, and querying for objects via API or the dashboard.
Keys are strings with a maximum length of 64 characters. Values are strings
with a maximum length of 512 characters.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) data_source_config > (attribute) metadata>)
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) data_source_config>)
metadata: Map[String]
Set of 16 key-value pairs that can be attached to an object. This can be
useful for storing additional information about the object in a structured
format, and querying for objects via API or the dashboard.
Keys are strings with a maximum length of 64 characters. Values are strings
with a maximum length of 512 characters.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) metadata>)
name: String
The name of the evaluation.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) name>)
object: String
The object type.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) object>)
testing\_criteria: List[Attributes]
A list of testing criteria.
input: List[Attributes]
content: String
Inputs to the model - can contain template strings. Supports text, output text, input images, and input audio, either as a single item or an array of items.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) input > (attribute) content>)
role: String
The role of the message input. One of `user`, `assistant`, `system`, or
`developer`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) input > (attribute) role>)
type: String
The type of the message input. Always `message`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) input > (attribute) type>)
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) input>)
labels: List[String]
The labels to assign to each item in the evaluation.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) labels>)
model: String
The model to use for the evaluation. Must support structured outputs.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) model>)
name: String
The name of the grader.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) name>)
passing\_labels: List[String]
The labels that indicate a passing result. Must be a subset of labels.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) passing_labels>)
type: String
The object type, which is always `label\_model`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) type>)
operation: String
The string check operation to perform. One of `eq`, `ne`, `like`, or `ilike`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) operation>)
reference: String
The reference text. This may include template strings.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) reference>)
evaluation\_metric: String
The evaluation metric to use. One of `cosine`, `fuzzy\_match`, `bleu`,
`gleu`, `meteor`, `rouge\_1`, `rouge\_2`, `rouge\_3`, `rouge\_4`, `rouge\_5`,
or `rouge\_l`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) evaluation_metric>)
pass\_threshold: Float64
The threshold for the score.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) pass_threshold>)
source: String
The source code of the python script.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) source>)
image\_tag: String
The image tag to use for the python script.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) image_tag>)
range: List[Float64]
The range of the score. Defaults to `[0, 1]`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) range>)
sampling\_params: Attributes
The sampling parameters for the model.
max\_completions\_tokens: Int64
The maximum number of tokens the grader model may generate in its response.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) sampling_params > (attribute) max_completions_tokens>)
reasoning\_effort: String
Constrains effort on reasoning for
[reasoning models](https://platform.openai.com/docs/guides/reasoning).
Currently supported values are `none`, `minimal`, `low`, `medium`, `high`, and `xhigh`. Reducing
...
* The `gpt-5-pro` model defaults to (and only supports) `high` reasoning effort.
* `xhigh` is supported for all models after `gpt-5.1-codex-max`.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) sampling_params > (attribute) reasoning_effort>)
seed: Int64
A seed value to initialize the randomness, during sampling.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) sampling_params > (attribute) seed>)
temperature: Float64
A higher temperature increases randomness in the outputs.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) sampling_params > (attribute) temperature>)
top\_p: Float64
An alternative to temperature for nucleus sampling; 1.0 includes all tokens.
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) sampling_params > (attribute) top_p>)
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria > (attribute) sampling_params>)
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items > (attribute) testing_criteria>)
[](<#(resource) evals > (terraform datasource-plural) > (attribute) items>)
#### EvalsRuns
Manage and run evals in the OpenAI platform.
