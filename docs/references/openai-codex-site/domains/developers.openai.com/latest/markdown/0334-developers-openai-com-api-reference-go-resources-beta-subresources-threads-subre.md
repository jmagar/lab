Create message | OpenAI API Reference
...
threadID string
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) thread_id > (schema)>)
body BetaThreadMessageNewParams
Content param.Field[[BetaThreadMessageNewParamsContentUnion](</api/reference/go/resources/beta/subresources/threads/subresources/messages/methods/create#(resource) beta.threads.messages > (method) create > (params) default > (param) content > (schema)>)]
The text contents of the message.
string
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) content > (schema) > (variant) 0>)
type BetaThreadMessageNewParamsContentArrayOfContentParts [][MessageContentPartParamUnionResp](</api/reference/go/resources/beta#(resource) beta.threads.messages > (model) message_content_part_param > (schema)>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) content > (schema) > (variant) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) content>)
Role param.Field[[BetaThreadMessageNewParamsRole](</api/reference/go/resources/beta/subresources/threads/subresources/messages/methods/create#(resource) beta.threads.messages > (method) create > (params) default > (param) role > (schema)>)]
The role of the entity that is creating the message. Allowed values include:
* `user`: Indicates the message is sent by an actual user and should be used in most cases to represent user-generated messages.
* `assistant`: Indicates the message is generated by the assistant. Use this value to insert messages from the assistant into the conversation.
const BetaThreadMessageNewParamsRoleUser [BetaThreadMessageNewParamsRole](</api/reference/go/resources/beta/subresources/threads/subresources/messages/methods/create#(resource) beta.threads.messages > (method) create > (params) default > (param) role > (schema)>) = "user"
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) role > (schema) > (member) 0>)
const BetaThreadMessageNewParamsRoleAssistant [BetaThreadMessageNewParamsRole](</api/reference/go/resources/beta/subresources/threads/subresources/messages/methods/create#(resource) beta.threads.messages > (method) create > (params) default > (param) role > (schema)>) = "assistant"
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) role > (schema) > (member) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) role>)
Attachments param.Field[[]BetaThreadMessageNewParamsAttachment]Optional
A list of files attached to the message, and the tools they should be added to.
FileID stringOptional
The ID of the file to attach to the message.
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) attachments > (schema) > (items) > (property) file_id>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) attachments > (schema) > (items) > (property) tools > (items) > (variant) 1 > (property) type>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) attachments > (schema) > (items) > (property) tools > (items) > (variant) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) attachments > (schema) > (items) > (property) tools>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) attachments>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) metadata>)
[](<#(resource) beta.threads.messages > (method) create > (params) default>)
