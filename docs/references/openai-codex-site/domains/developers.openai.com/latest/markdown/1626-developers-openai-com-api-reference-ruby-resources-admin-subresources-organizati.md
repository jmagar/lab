...
name: String
[](<#(resource) admin.organization.admin_api_keys > (method) create > (params) default > (param) name > (schema)>)
...
admin\_api\_key = openai.admin.organization.admin\_api\_keys.create(name: "New Admin Key")
