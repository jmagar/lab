...
**View as Markdown**
# Cancel a response
responses.cancel(response\_id) -\> [Response](</api/reference/ruby/resources/responses#(resource) responses > (model) response > (schema)>) { id, created\_at, error, 29 more }
...
class Response { id, created\_at, error, 29 more }
id: String
...
error: [ResponseError](</api/reference/ruby/resources/responses#(resource) responses > (model) response_error > (schema)>) { code, message }
...
instructions: String | Array[[ResponseInputItem](</api/reference/ruby/resources/responses#(resource) responses > (model) response_input_item > (schema)>)]
...
InputItemList = Array[[ResponseInputItem](</api/reference/ruby/resources/responses#(resource) responses > (model) response_input_item > (schema)>)]
...
model: [ResponsesModel](</api/reference/ruby/resources/$shared#(resource) $shared > (model) responses_model > (schema)>)
...
reasoning: [Reasoning](</api/reference/ruby/resources/$shared#(resource) $shared > (model) reasoning > (schema)>) { effort, generate\_summary, summary }
**gpt-5 and o-series models only**
Configuration options for
[reasoning models](https://platform.openai.com/docs/guides/reasoning).
effort: [ReasoningEffort](</api/reference/ruby/resources/$shared#(resource) $shared > (model) reasoning_effort > (schema)>)
...
status: [ResponseStatus](</api/reference/ruby/resources/responses#(resource) responses > (model) response_status > (schema)>)
...
text: [ResponseTextConfig](</api/reference/ruby/resources/responses#(resource) responses > (model) response_text_config > (schema)>) { format\_, verbosity }
...
response = openai.responses.cancel("resp\_677efb5139a88190b512bc3fef8e535d")
puts(response)`
```
```
`{
