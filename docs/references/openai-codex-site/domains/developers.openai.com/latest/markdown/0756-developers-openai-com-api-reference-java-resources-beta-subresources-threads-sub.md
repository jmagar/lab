...
[](<#(resource) beta.threads.runs > (method) submit_tool_outputs > (params) default.non_streaming > (param) body > (schema) > (property) tool_outputs > (items) > (property) output>)
...
[](<#(resource) beta.threads.runs > (method) submit_tool_outputs > (params) default.non_streaming > (param) body > (schema) > (property) tool_outputs > (items) > (property) tool_call_id>)
[](<#(resource) beta.threads.runs > (method) submit_tool_outputs > (params) default.non_streaming > (param) body > (schema) > (property) tool_outputs>)
