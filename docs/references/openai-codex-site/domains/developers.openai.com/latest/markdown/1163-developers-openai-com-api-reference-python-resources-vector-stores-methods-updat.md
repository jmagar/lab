...
expires\_after: Optional[[ExpiresAfter](</api/reference/python/resources/vector_stores/methods/update#(resource) vector_stores > (method) update > (params) default > (param) expires_after > (schema)>)]
...
[](<#(resource) vector_stores > (method) update > (params) default > (param) expires_after > (schema)>)
...
[](<#(resource) vector_stores > (method) update > (params) default > (param) metadata > (schema)>)
name: Optional[str]
The name of the vector store.
[](<#(resource) vector_stores > (method) update > (params) default > (param) name > (schema)>)
...
client = OpenAI()
vector\_store = client.vector\_stores.update(
