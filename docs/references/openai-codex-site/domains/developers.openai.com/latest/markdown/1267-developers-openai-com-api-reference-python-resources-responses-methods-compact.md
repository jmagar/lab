...
**View as Markdown**
# Compact a response
responses.compact(ResponseCompactParams\*\*kwargs) -\> [CompactedResponse](</api/reference/python/resources/responses#(resource) responses > (model) compacted_response > (schema)>)
...
input: Optional[Union[str, Iterable[[ResponseInputItemParam](</api/reference/python/resources/responses#(resource) responses > (model) response_input_item > (schema)>)], null]]
Text, image, or file inputs to the model, used to generate a response
One of the following:
str
A text input to the model, equivalent to a text input with the `user` role.
[](<#(resource) responses > (method) compact > (params) default > (param) input > (schema) > (variant) 0>)
Iterable[[ResponseInputItemParam](</api/reference/python/resources/responses#(resource) responses > (model) response_input_item > (schema)>)]
...
output: List[[ResponseOutputItem](</api/reference/python/resources/responses#(resource) responses > (model) response_output_item > (schema)>)]
...
usage: [ResponseUsage](</api/reference/python/resources/responses#(resource) responses > (model) response_usage > (schema)>)
