...
[](<#(resource) admin.organization.projects.groups.roles > (method) create > (params) default > (param) project_id>)
role\_id: string
...
const role = await client.admin.organization.projects.groups.roles.create('group\_id', {
