OpenAI Java API Library | OpenAI API Reference
[Skip to content](#_top)
# OpenAI Java API Library
# OpenAI Java API Library
[](https://central.sonatype.com/artifact/com.openai/openai-java/4.33.0)
[](https://javadoc.io/doc/com.openai/openai-java/4.33.0)
The OpenAI Java SDK provides convenient access to the [OpenAI REST API](https://platform.openai.com/docs) from applications written in Java.
The REST API documentation can be found on [platform.openai.com](https://platform.openai.com/docs). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.openai/openai-java/4.33.0).
## Installation
...
// Configures using the `OPENAI\_API\_KEY`, `OPENAI\_ORG\_ID` and `OPENAI\_PROJECT\_ID` environment variables
OpenAIClient client = OpenAIOkHttpClient.fromEnv();
ResponseCreateParams params = ResponseCreateParams.builder()
.input("Say this is a test")
.model(ChatModel.GPT\_5\_2)
.build();
...
// Or configures using the `OPENAI\_API\_KEY`, `OPENAI\_ORG\_ID`, `OPENAI\_PROJECT\_ID`, `OPENAI\_WEBHOOK\_SECRET` and `OPENAI\_BASE\_URL` environment variables
OpenAIClient client = OpenAIOkHttpClient.fromEnv();
...
|`apiKey`|`openai.apiKey`|`OPENAI\_API\_KEY`|true|-|
|`organization`|`openai.orgId`|`OPENAI\_ORG\_ID`|false|-|
|`project`|`openai.projectId`|`OPENAI\_PROJECT\_ID`|false|-|
|`webhookSecret`|`openai.webhookSecret`|`OPENAI\_WEBHOOK\_SECRET`|false|-|
|`baseUrl`|`openai.baseUrl`|`OPENAI\_BASE\_URL`|true|`"https://api.openai.com/v1"`|
...
.model(ChatModel.GPT\_3\_5\_TURBO)
...
.purpose(FilePurpose.FINE\_TUNE)
...
import java.util.Optional;
OpenAIClient client = OpenAIOkHttpClient.fromEnv(); // OPENAI\_WEBHOOK\_SECRET env var used by default
...
Enable logging by setting the `OPENAI\_LOG` environment variable to `info`:
```
`export OPENAI\_LOG=info`
```
Or to `debug` for more verbose logging:
```
`export OPENAI\_LOG=debug`
```
## ProGuard and R8
...
#### Gradle
```
`implementation("com.openai:openai-java-spring-boot-starter:4.33.0")`
```
#### Maven
```
`\<dependency\>
...
```
`OpenAIClient client = OpenAIOkHttpClient.builder()
// Gets the API key and endpoint from the `AZURE\_OPENAI\_KEY` and `OPENAI\_BASE\_URL` environment variables, respectively
.fromEnv()
...
.putAdditionalQueryParam("secret\_query\_param", "42")
