...
**View as Markdown**
# Cancel a response
[Response](</api/reference/java/resources/responses#(resource) responses > (model) response > (schema)>) responses().cancel(ResponseCancelParamsparams = ResponseCancelParams.none(), RequestOptionsrequestOptions = RequestOptions.none())
...
[](<#(resource) responses > (method) cancel > (params) default>)
...
Optional\<[ResponseError](</api/reference/java/resources/responses#(resource) responses > (model) response_error > (schema)>)\> error
...
[ResponsesModel](</api/reference/java/resources/$shared#(resource) $shared > (model) responses_model > (schema)>) model
...
Optional\<[Reasoning](</api/reference/java/resources/$shared#(resource) $shared > (model) reasoning > (schema)>)\> reasoning
**gpt-5 and o-series models only**
Configuration options for
[reasoning models](https://platform.openai.com/docs/guides/reasoning).
Optional\<[ReasoningEffort](</api/reference/java/resources/$shared#(resource) $shared > (model) reasoning_effort > (schema)>)\> effort
...
Optional\<[ResponseStatus](</api/reference/java/resources/responses#(resource) responses > (model) response_status > (schema)>)\> status
...
Optional\<[ResponseTextConfig](</api/reference/java/resources/responses#(resource) responses > (model) response_text_config > (schema)>)\> text
...
Optional\<[ResponseUsage](</api/reference/java/resources/responses#(resource) responses > (model) response_usage > (schema)>)\> usage
...
Response response = client.responses().cancel("resp\_677efb5139a88190b512bc3fef8e535d");
}
}`
```
```
