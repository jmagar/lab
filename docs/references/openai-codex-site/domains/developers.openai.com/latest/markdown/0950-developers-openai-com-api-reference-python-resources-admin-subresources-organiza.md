...
batch: Optional[[bool](</api/reference/python/resources/admin/subresources/organization/subresources/usage/methods/completions#(resource) admin.organization.usage > (method) completions > (params) default > (param) batch > (schema)>)]
