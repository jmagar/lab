...
[](<#(resource) skills.versions > (method) retrieve > (params) default > (param) skill_id>)
...
const skillVersion = await client.skills.versions.retrieve('version', { skill\_id: 'skill\_123' });
