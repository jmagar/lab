...
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/vector_databases/weaviate/getting-started-with-weaviate-and-openai.ipynb)
...
```
`def query\_weaviate(query, collection\_name):
nearText = {
"concepts": [query],
"distance": 0.7,
}
