...
input: Union[str, Sequence[str], Iterable[[ModerationMultiModalInputParam](</api/reference/python/resources/moderations#(resource) moderations > (model) moderation_multi_modal_input > (schema)>)]]
...
Iterable[[ModerationMultiModalInputParam](</api/reference/python/resources/moderations#(resource) moderations > (model) moderation_multi_modal_input > (schema)>)]
...
model: Optional[Union[str, [ModerationModel](</api/reference/python/resources/moderations#(resource) moderations > (model) moderation_model > (schema)>)]]
...
[](<#(resource) moderations > (method) create > (params) default > (param) model > (schema) > (variant) 1>)
