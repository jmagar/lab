...
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/vector_databases/qdrant/QA_with_Langchain_Qdrant_and_OpenAI.ipynb)
This notebook presents how to implement a Question Answering system with Langchain, Qdrant as a knowledge based and OpenAI embeddings. If you are not familiar with Qdrant, it’s better to check out the [Getting\_started\_with\_Qdrant\_and\_OpenAI.ipynb](Getting_started_with_Qdrant_and_OpenAI.ipynb) notebook.
...
```
```
`Starting qdrant\_qdrant\_1 ...
[1Bting qdrant\_qdrant\_1 ... [32mdone[0m`
```
