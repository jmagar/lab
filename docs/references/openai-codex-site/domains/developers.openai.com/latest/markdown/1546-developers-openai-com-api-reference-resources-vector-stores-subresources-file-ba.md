...
[](<#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) after > (schema)>)
before: optional string
A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with obj\_foo, your subsequent call can include before=obj\_foo in order to fetch the previous page of the list.
[](<#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) before > (schema)>)
...
[](<#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) filter > (schema)>)
limit: optional number
A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20.
[](<#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) limit > (schema)>)
...
[](<#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) order > (schema)>)
...
[](<#(resource) vector_stores.file_batches > (method) list_files > (network schema) > (property) data>)
first\_id: string
[](<#(resource) vector_stores.file_batches > (method) list_files > (network schema) > (property) first_id>)
has\_more: boolean
[](<#(resource) vector_stores.file_batches > (method) list_files > (network schema) > (property) has_more>)
last\_id: string
[](<#(resource) vector_stores.file_batches > (method) list_files > (network schema) > (property) last_id>)
object: string
[](<#(resource) vector_stores.file_batches > (method) list_files > (network schema) > (property) object>)
### List vector store files in a batch
HTTP
HTTP
HTTP
...
Terraform
```
`curl https://api.openai.com/v1/vector\_stores/vs\_abc123/files\_batches/vsfb\_abc123/files \\
