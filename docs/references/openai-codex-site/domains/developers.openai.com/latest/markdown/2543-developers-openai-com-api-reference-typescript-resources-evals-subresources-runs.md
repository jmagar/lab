...
[](<#(resource) evals.runs > (method) list > (params) default > (param) after>)
limit?: number
Number of runs to retrieve.
[](<#(resource) evals.runs > (method) list > (params) default > (param) limit>)
order?: "asc" | "desc"
...
[](<#(resource) evals.runs > (method) list > (params) default > (param) order>)
...
[](<#(resource) evals.runs > (method) list > (params) default > (param) status>)
