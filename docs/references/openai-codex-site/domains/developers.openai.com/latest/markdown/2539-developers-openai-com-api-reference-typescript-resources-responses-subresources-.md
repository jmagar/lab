...
**View as Markdown**
# List input items
client.responses.inputItems.list(stringresponseID, InputItemListParams { after, include, limit, order } query?, RequestOptionsoptions?): CursorPage\<[ResponseItem](</api/reference/typescript/resources/responses#(resource) responses > (model) response_item > (schema)>)\>
...
[](<#(resource) responses.input_items > (method) list > (params) default > (param) after>)
include?: Array\<[ResponseIncludable](</api/reference/typescript/resources/responses#(resource) responses > (model) response_includable > (schema)>)\>
...
[](<#(resource) responses.input_items > (method) list > (params) default > (param) include>)
limit?: number
A limit on the number of objects to be returned. Limit can range between
1 and 100, and the default is 20.
[](<#(resource) responses.input_items > (method) list > (params) default > (param) limit>)
order?: "asc" | "desc"
...
[](<#(resource) responses.input_items > (method) list > (params) default > (param) order>)
[](<#(resource) responses.input_items > (method) list > (params) default>)
##### ReturnsExpand Collapse
ResponseItem = [ResponseInputMessageItem](</api/reference/typescript/resources/responses#(resource) responses > (model) response_input_message_item > (schema)>) { id, content, role, 2 more } | [ResponseOutputMessage](</api/reference/typescript/resources/responses#(resource) responses > (model) response_output_message > (schema)>) { id, content, role, 3 more } | [ResponseFileSearchToolCall](</api/reference/typescript/resources/responses#(resource) responses > (model) response_file_search_tool_call > (schema)>) { id, queries, status, 2 more } | 23 more
...
ResponseCustomToolCallItem extends [ResponseCustomToolCall](</api/reference/typescript/resources/responses#(resource) responses > (model) response_custom_tool_call > (schema)>) { call\_id, input, name, 3 more } { id, status, created\_by }
...
const response = await client.responses.inputItems.list("resp\_123");
