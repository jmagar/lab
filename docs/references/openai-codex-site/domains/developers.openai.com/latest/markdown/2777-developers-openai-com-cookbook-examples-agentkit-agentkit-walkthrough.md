...
Oct 17, 2025
# Build, deploy, and optimize agentic workflows with AgentKit
[ NS ](https://www.linkedin.com/in/nsrivast/)
...
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/agentkit/agentkit_walkthrough.ipynb)
## Introduction
...
export const PLACEHOLDER\_INPUT = "Describe your dream job, and don't forget to attach your resume!"; `
```
...
When we’re happy with the design, we can download the .widget file. (The file used in the screenshot below is located [here](<https://cdn.openai.com/cookbook/agent_walkthrough/Course recommendation.widget>).)
