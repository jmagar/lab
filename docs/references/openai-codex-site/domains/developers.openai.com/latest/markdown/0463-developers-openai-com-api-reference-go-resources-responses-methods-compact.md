...
**View as Markdown**
# Compact a response
client.Responses.Compact(ctx, body) (\*[CompactedResponse](</api/reference/go/resources/responses#(resource) responses > (model) compacted_response > (schema)>), error)
...
[](<#(resource) responses > (method) compact > (params) default > (param) model>)
Input param.Field[[ResponseCompactParamsInputUnion](</api/reference/go/resources/responses/methods/compact#(resource) responses > (method) compact > (params) default > (param) input > (schema)>)]Optional
Text, image, or file inputs to the model, used to generate a response
string
[](<#(resource) responses > (method) compact > (params) default > (param) input > (schema) > (variant) 0>)
type ResponseCompactParamsInputArray [][ResponseInputItemUnion](</api/reference/go/resources/responses#(resource) responses > (model) response_input_item > (schema)>)
...
[](<#(resource) responses > (method) compact > (params) default > (param) input>)
...
[](<#(resource) responses > (method) compact > (params) default > (param) instructions>)
...
[](<#(resource) responses > (method) compact > (params) default > (param) previous_response_id>)
PromptCacheKey param.Field[string]Optional
A key to use when reading from or writing to the prompt cache.
maxLength64
[](<#(resource) responses > (method) compact > (params) default > (param) prompt_cache_key>)
PromptCacheRetention param.Field[[ResponseCompactParamsPromptCacheRetention](</api/reference/go/resources/responses/methods/compact#(resource) responses > (method) compact > (params) default > (param) prompt_cache_retention > (schema)>)]Optional
How long to retain a prompt cache entry created by this request.
const ResponseCompactParamsPromptCacheRetentionInMemory [ResponseCompactParamsPromptCacheRetention](</api/reference/go/resources/responses/methods/compact#(resource) responses > (method) compact > (params) default > (param) prompt_cache_retention > (schema)>) = "in\_memory"
[](<#(resource) responses > (method) compact > (params) default > (param) prompt_cache_retention > (schema) > (member) 0>)
const ResponseCompactParamsPromptCacheRetention24h [ResponseCompactParamsPromptCacheRetention](</api/reference/go/resources/responses/methods/compact#(resource) responses > (method) compact > (params) default > (param) prompt_cache_retention > (schema)>) = "24h"
[](<#(resource) responses > (method) compact > (params) default > (param) prompt_cache_retention > (schema) > (member) 1>)
[](<#(resource) responses > (method) compact > (params) default > (param) prompt_cache_retention>)
...
Usage [ResponseUsage](</api/reference/go/resources/responses#(resource) responses > (model) response_usage > (schema)>)
...
Model: responses.ResponseCompactParamsModelGPT5\_4,
})
if err != nil {
panic(err.Error())
}
