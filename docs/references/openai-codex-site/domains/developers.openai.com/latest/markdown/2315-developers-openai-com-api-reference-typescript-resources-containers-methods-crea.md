...
expires\_after?: [ExpiresAfter](</api/reference/typescript/resources/containers/methods/create#(resource) containers > (method) create > (params) default > (param) expires_after > (schema)>)
