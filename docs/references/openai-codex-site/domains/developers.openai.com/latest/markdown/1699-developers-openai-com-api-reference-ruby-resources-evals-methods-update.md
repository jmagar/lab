...
[](<#(resource) evals > (method) update > (params) default > (param) metadata > (schema)>)
name: String
Rename the evaluation.
[](<#(resource) evals > (method) update > (params) default > (param) name > (schema)>)
...
eval\_ = openai.evals.update("eval\_id")
puts(eval\_)`
```
```
`{
