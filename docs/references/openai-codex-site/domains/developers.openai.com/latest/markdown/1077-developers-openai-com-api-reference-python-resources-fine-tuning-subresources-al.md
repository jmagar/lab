...
grader: [Grader](</api/reference/python/resources/fine_tuning/subresources/alpha/subresources/graders/methods/validate#(resource) fine_tuning.alpha.graders > (method) validate > (params) default > (param) grader > (schema)>)
...
[](<#(resource) fine_tuning.alpha.graders > (method) validate > (params) default > (param) grader > (schema)>)
...
response = client.fine\_tuning.alpha.graders.validate(
grader={
"input": "input",
"name": "name",
"operation": "eq",
