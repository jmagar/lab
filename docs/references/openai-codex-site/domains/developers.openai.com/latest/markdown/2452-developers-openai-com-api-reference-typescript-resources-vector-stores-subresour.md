...
[](<#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) vector_store_id>)
after?: string
...
Query param: Filter by file status. One of `in\_progress`, `completed`, `failed`, `cancelled`.
