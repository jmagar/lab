...
Aug 28, 2024
# GPT Actions library - Retool Workflow
[ LS ](https://github.com/lspacagna-oai)
[ Lee Spacagna
(OpenAI)
](https://github.com/lspacagna-oai)
[
View on GitHub
](https://github.com/openai/openai-cookbook/blob/main/examples/chatgpt/gpt_actions_library/gpt_action_retool_workflow.md) [
Download raw
](https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/chatgpt/gpt_actions_library/gpt_action_retool_workflow.md)
## Introduction
...
* Application Website: [https://retool.com/products/workflows](https://retool.com/products/workflows)
* Application API Documentation: [https://docs.retool.com/workflows](https://docs.retool.com/workflows)
...
paths:
/workflows/\<WORKFLOW\_ID\>/startTrigger:
post:
operationId: add\_numbers
