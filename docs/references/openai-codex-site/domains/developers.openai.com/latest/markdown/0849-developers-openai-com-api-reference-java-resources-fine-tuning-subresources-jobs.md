...
Optional\<[Metadata](</api/reference/java/resources/fine_tuning/subresources/jobs/methods/list#(resource) fine_tuning.jobs > (method) list > (params) default > (param) metadata > (schema)>)\> metadata
