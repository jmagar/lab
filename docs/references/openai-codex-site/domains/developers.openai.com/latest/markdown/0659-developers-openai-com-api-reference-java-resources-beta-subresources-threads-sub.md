...
String
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) content > (variant) 0>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) content > (variant) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) content>)
Role role
The role of the entity that is creating the message. Allowed values include:
* `user`: Indicates the message is sent by an actual user and should be used in most cases to represent user-generated messages.
* `assistant`: Indicates the message is generated by the assistant. Use this value to insert messages from the assistant into the conversation.
USER("user")
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) role > (member) 0>)
ASSISTANT("assistant")
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) role > (member) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) role>)
Optional\<List\<Attachment\>\> attachments
A list of files attached to the message, and the tools they should be added to.
Optional\<String\> fileId
The ID of the file to attach to the message.
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) attachments > (items) > (property) file_id>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) attachments > (items) > (property) tools > (items) > (variant) 1 > (property) type>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) attachments > (items) > (property) tools > (items) > (variant) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) attachments > (items) > (property) tools>)
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) attachments>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) default > (param) body > (schema) > (property) metadata>)
