...
Enable this feature by setting `idle\_timeout\_ms` on the `server\_vad` settings for turn detection.
...
"type": "realtime",
"prompt": {
"id": "pmpt\_123", // your stored prompt ID
