...
tool\_resources?: [ToolResources](</api/reference/typescript/resources/beta/subresources/threads/methods/create#(resource) beta.threads > (method) create > (params) default > (param) tool_resources > (schema)>) | null
