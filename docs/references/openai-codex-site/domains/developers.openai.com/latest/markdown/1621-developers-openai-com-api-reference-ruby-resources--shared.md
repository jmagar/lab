...
AllModels = String | [ChatModel](</api/reference/ruby/resources/$shared#(resource) $shared > (model) chat_model > (schema)>) | :"o1-pro" | :"o1-pro-2025-03-19" | :"o3-pro" | 11 more
...
One of the following:
:invalid\_grant
[](<#(resource) $shared > (model) oauth_error_code > (schema) > (variant) 0 > (member) 0>)
:invalid\_subject\_token
[](<#(resource) $shared > (model) oauth_error_code > (schema) > (variant) 0 > (member) 1>)
[](<#(resource) $shared > (model) oauth_error_code > (schema) > (variant) 0>)
String = String
[](<#(resource) $shared > (model) oauth_error_code > (schema) > (variant) 1>)
[](<#(resource) $shared > (model) oauth_error_code > (schema)>)
class Reasoning { effort, generate\_summary, summary }
...
ResponsesModel = String | [ChatModel](</api/reference/ruby/resources/$shared#(resource) $shared > (model) chat_model > (schema)>) | :"o1-pro" | :"o1-pro-2025-03-19" | :"o3-pro" | 11 more
One of the following:
String = String
