...
Optional\<[Filter](</api/reference/java/resources/vector_stores/subresources/file_batches/methods/list_files#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) filter > (schema)>)\> filter
...
Optional\<[Order](</api/reference/java/resources/vector_stores/subresources/file_batches/methods/list_files#(resource) vector_stores.file_batches > (method) list_files > (params) default > (param) order > (schema)>)\> order
