...
input: string | Array\<string\> | Array\<[ModerationMultiModalInput](</api/reference/typescript/resources/moderations#(resource) moderations > (model) moderation_multi_modal_input > (schema)>)\>
...
Array\<[ModerationMultiModalInput](</api/reference/typescript/resources/moderations#(resource) moderations > (model) moderation_multi_modal_input > (schema)>)\>
...
model?: (string & {}) | [ModerationModel](</api/reference/typescript/resources/moderations#(resource) moderations > (model) moderation_model > (schema)>)
