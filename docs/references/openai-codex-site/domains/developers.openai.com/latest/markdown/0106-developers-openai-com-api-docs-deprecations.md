...
There are a few key differences between the interfaces in the Realtime beta API and the released GA API. See [the migration guide](/api/docs/guides/realtime#beta-to-ga-migration) to learn more about how to migrate your current beta integration.
|Shutdown date|Model / system|Recommended replacement|
