...
**View as Markdown**
# List input items
client.Responses.InputItems.List(ctx, responseID, query) (\*CursorPage[[ResponseItemUnion](</api/reference/go/resources/responses#(resource) responses > (model) response_item > (schema)>)], error)
...
Order param.Field[[InputItemListParamsOrder](</api/reference/go/resources/responses/subresources/input_items/methods/list#(resource) responses.input_items > (method) list > (params) default > (param) order > (schema)>)]Optional
The order to return the input items in. Default is `desc`.
* `asc`: Return the input items in ascending order.
* `desc`: Return the input items in descending order.
const InputItemListParamsOrderAsc [InputItemListParamsOrder](</api/reference/go/resources/responses/subresources/input_items/methods/list#(resource) responses.input_items > (method) list > (params) default > (param) order > (schema)>) = "asc"
[](<#(resource) responses.input_items > (method) list > (params) default > (param) order > (schema) > (member) 0>)
const InputItemListParamsOrderDesc [InputItemListParamsOrder](</api/reference/go/resources/responses/subresources/input_items/methods/list#(resource) responses.input_items > (method) list > (params) default > (param) order > (schema)>) = "desc"
