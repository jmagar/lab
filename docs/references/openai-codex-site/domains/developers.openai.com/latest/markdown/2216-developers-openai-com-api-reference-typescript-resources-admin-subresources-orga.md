...
body: CertificateCreateParams { content, name }
content: string
The certificate content in PEM format
[](<#(resource) admin.organization.certificates > (method) create > (params) default > (param) content>)
name?: string
An optional name for the certificate
[](<#(resource) admin.organization.certificates > (method) create > (params) default > (param) name>)
