...
client.batches.retrieve(stringbatchID, RequestOptionsoptions?): [Batch](</api/reference/typescript/resources/batches#(resource) batches > (model) batch > (schema)>) { id, completion\_window, created\_at, 19 more }
GET/batches/{batch\_id}
##### [Cancel batch](/api/reference/typescript/resources/batches/methods/cancel)
client.batches.cancel(stringbatchID, RequestOptionsoptions?): [Batch](</api/reference/typescript/resources/batches#(resource) batches > (model) batch > (schema)>) { id, completion\_window, created\_at, 19 more }
POST/batches/{batch\_id}/cancel
##### [List batches](/api/reference/typescript/resources/batches/methods/list)
client.batches.list(BatchListParams { after, limit } query?, RequestOptionsoptions?): CursorPage\<[Batch](</api/reference/typescript/resources/batches#(resource) batches > (model) batch > (schema)>) { id, completion\_window, created\_at, 19 more } \>
GET/batches
