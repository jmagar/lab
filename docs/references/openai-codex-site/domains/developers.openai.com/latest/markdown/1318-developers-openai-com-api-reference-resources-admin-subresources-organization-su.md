...
[](<#(resource) admin.organization.roles > (method) create > (params) 0 > (param) permissions > (schema)>)
role\_name: string
Unique name for the role.
[](<#(resource) admin.organization.roles > (method) create > (params) 0 > (param) role_name > (schema)>)
description: optional string
Optional description of the role.
[](<#(resource) admin.organization.roles > (method) create > (params) 0 > (param) description > (schema)>)
