...
[](<#(resource) admin.organization.projects.certificates > (method) activate > (params) 0 > (param) certificate_ids > (schema)>)
...
[](<#(resource) admin.organization.projects.certificates > (method) activate > (network schema) > (property) data>)
has\_more: boolean
[](<#(resource) admin.organization.projects.certificates > (method) activate > (network schema) > (property) has_more>)
object: "list"
[](<#(resource) admin.organization.projects.certificates > (method) activate > (network schema) > (property) object>)
first\_id: optional string
[](<#(resource) admin.organization.projects.certificates > (method) activate > (network schema) > (property) first_id>)
last\_id: optional string
[](<#(resource) admin.organization.projects.certificates > (method) activate > (network schema) > (property) last_id>)
### Activate certificates for project
HTTP
HTTP
HTTP
...
Terraform
```
`curl https://api.openai.com/v1/organization/projects/proj\_abc/certificates/activate \\
