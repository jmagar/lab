...
[](<#(resource) beta.threads.runs > (method) create > (params) default.non_streaming > (param) include > (schema)>)
##### Body ParametersJSONExpand Collapse
assistant\_id: string
The ID of the [assistant](/docs/api-reference/assistants) to use to execute this run.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) assistant_id > (schema)>)
additional\_instructions: optional string
Appends additional instructions at the end of the instructions for the run. This is useful for modifying the behavior on a per-run basis without overriding other instructions.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_instructions > (schema)>)
...
TextContent = string
The text contents of the message.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) content > (variant) 0>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) content > (variant) 1>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) content>)
...
One of the following:
"user"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) role > (member) 0>)
"assistant"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) role > (member) 1>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) role>)
attachments: optional array of object { file\_id, tools }
A list of files attached to the message, and the tools they should be added to.
file\_id: optional string
The ID of the file to attach to the message.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) attachments > (items) > (property) file_id>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) attachments > (items) > (property) tools > (items) > (variant) 1 > (property) type>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) attachments > (items) > (property) tools > (items) > (variant) 1>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) attachments > (items) > (property) tools>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) attachments>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema) > (items) > (property) metadata>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) additional_messages > (schema)>)
instructions: optional string
Overrides the [instructions](/docs/api-reference/assistants/createAssistant) of the assistant. This is useful for modifying the behavior on a per-run basis.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) instructions > (schema)>)
...
minimum256
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) max_completion_tokens > (schema)>)
...
minimum256
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) max_prompt_tokens > (schema)>)
metadata: optional [Metadata](</api/reference/resources/$shared#(resource) $shared > (model) metadata > (schema)>)
Set of 16 key-value pairs that can be attached to an object. This can be
useful for storing additional information about the object in a structured
format, and querying for objects via API or the dashboard.
Keys are strings with a maximum length of 64 characters. Values are strings
with a maximum length of 512 characters.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) metadata > (schema)>)
model: optional string or "gpt-5" or "gpt-5-mini" or "gpt-5-nano" or 39 more
The ID of the [Model](/docs/api-reference/models) to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used.
One of the following:
string
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 0>)
AssistantSupportedModels = "gpt-5" or "gpt-5-mini" or "gpt-5-nano" or 39 more
The ID of the [Model](/docs/api-reference/models) to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used.
One of the following:
"gpt-5"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 0>)
"gpt-5-mini"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 1>)
"gpt-5-nano"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 2>)
"gpt-5-2025-08-07"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 3>)
"gpt-5-mini-2025-08-07"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 4>)
"gpt-5-nano-2025-08-07"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 5>)
"gpt-4.1"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 6>)
"gpt-4.1-mini"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 7>)
"gpt-4.1-nano"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 8>)
"gpt-4.1-2025-04-14"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 9>)
"gpt-4.1-mini-2025-04-14"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 10>)
"gpt-4.1-nano-2025-04-14"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 11>)
"o3-mini"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 12>)
"o3-mini-2025-01-31"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 13>)
"o1"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 14>)
"o1-2024-12-17"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 15>)
"gpt-4o"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 16>)
"gpt-4o-2024-11-20"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 17>)
"gpt-4o-2024-08-06"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 18>)
"gpt-4o-2024-05-13"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 19>)
"gpt-4o-mini"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 20>)
"gpt-4o-mini-2024-07-18"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 21>)
"gpt-4.5-preview"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 22>)
"gpt-4.5-preview-2025-02-27"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 23>)
"gpt-4-turbo"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 24>)
"gpt-4-turbo-2024-04-09"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 25>)
"gpt-4-0125-preview"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 26>)
"gpt-4-turbo-preview"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 27>)
"gpt-4-1106-preview"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 28>)
"gpt-4-vision-preview"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 29>)
"gpt-4"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 30>)
"gpt-4-0314"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 31>)
"gpt-4-0613"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 32>)
"gpt-4-32k"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 33>)
"gpt-4-32k-0314"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 34>)
"gpt-4-32k-0613"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 35>)
"gpt-3.5-turbo"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 36>)
"gpt-3.5-turbo-16k"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 37>)
"gpt-3.5-turbo-0613"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 38>)
"gpt-3.5-turbo-1106"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 39>)
"gpt-3.5-turbo-0125"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 40>)
"gpt-3.5-turbo-16k-0613"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1 > (member) 41>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema) > (variant) 1>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) model > (schema)>)
parallel\_tool\_calls: optional boolean
Whether to enable [parallel function calling](/docs/guides/function-calling#configuring-parallel-function-calling) during tool use.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) parallel_tool_calls > (schema)>)
...
One of the following:
"none"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 0>)
"minimal"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 1>)
"low"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 2>)
"medium"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 3>)
"high"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 4>)
"xhigh"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) reasoning_effort > (schema) + (resource) $shared > (model) reasoning_effort > (schema) > (member) 5>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) reasoning_effort > (schema)>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) beta.threads > (model) assistant_response_format_option > (schema) > (variant) 0>)
ResponseFormatText object { type }
Default response format. Used to generate text responses.
type: "text"
The type of response format being defined. Always `text`.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_text > (schema) > (property) type>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_text > (schema)>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_object > (schema) > (property) type>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_object > (schema)>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_schema > (schema) > (property) json_schema > (property) name>)
description: optional string
A description of what the response format is for, used by the model to
determine how to respond in the format.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_schema > (schema) > (property) json_schema > (property) description>)
schema: optional map[unknown]
The schema for the response format, described as a JSON Schema object.
Learn how to build JSON schemas [here](https://json-schema.org/).
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_schema > (schema) > (property) json_schema > (property) schema>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_schema > (schema) > (property) json_schema > (property) strict>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_schema > (schema) > (property) json_schema>)
type: "json\_schema"
The type of response format being defined. Always `json\_schema`.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_schema > (schema) > (property) type>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema) + (resource) $shared > (model) response_format_json_schema > (schema)>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) response_format > (schema)>)
stream: optional boolean
If `true`, returns a stream of events that happen during the Run as server-sent events, terminating when the Run enters a terminal state with a `data: [DONE]` message.
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) stream > (schema)>)
temperature: optional number
What sampling temperature to use, between 0 and 2. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic.
minimum0
maximum2
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) temperature > (schema)>)
...
One of the following:
"none"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice_option > (schema) > (variant) 0 > (member) 0>)
"auto"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice_option > (schema) > (variant) 0 > (member) 1>)
"required"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice_option > (schema) > (variant) 0 > (member) 2>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice_option > (schema) > (variant) 0>)
...
One of the following:
"function"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice > (schema) > (property) type > (member) 0>)
"code\_interpreter"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice > (schema) > (property) type > (member) 1>)
"file\_search"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice > (schema) > (property) type > (member) 2>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice > (schema) > (property) type>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice > (schema) > (property) function>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema) + (resource) beta.threads > (model) assistant_tool_choice > (schema)>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tool_choice > (schema)>)
...
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) tools > (schema)>)
top\_p: optional number
An alternative to sampling with temperature, called nucleus sampling, where the model considers the results of the tokens with top\_p probability mass. So 0.1 means only the tokens comprising the top 10% probability mass are considered.
We generally recommend altering this or temperature but not both.
minimum0
maximum1
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) top_p > (schema)>)
...
One of the following:
"auto"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) truncation_strategy > (schema) > (property) type > (member) 0>)
"last\_messages"
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) truncation_strategy > (schema) > (property) type > (member) 1>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) truncation_strategy > (schema) > (property) type>)
last\_messages: optional number
The number of most recent messages from the thread when constructing the context for the run.
minimum1
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) truncation_strategy > (schema) > (property) last_messages>)
[](<#(resource) beta.threads.runs > (method) create > (params) 0.non_streaming > (param) truncation_strategy > (schema)>)
...
Terraform
```
`curl https://api.openai.com/v1/threads/thread\_123/runs \\
-H "Authorization: Bearer $OPENAI\_API\_KEY" \\
-H "Content-Type: application/json" \\
-H "OpenAI-Beta: assistants=v2" \\
-d '{
...
data: {"id":"run\_123","object":"thread.run","created\_at":1710330640,"assistant\_id":"asst\_123","thread\_id":"thread\_123","status":"queued","started\_at":null,"expires\_at":1710331240,"cancelled\_at":null,"failed\_at":null,"completed\_at":null,"required\_action":null,"last\_error":null,"model":"gpt-4o","instructions":null,"tools":[],"metadata":{},"temperature":1.0,"top\_p":1.0,"max\_completion\_tokens":null,"max\_prompt\_tokens":null,"truncation\_strategy":{"type":"auto","last\_messages":null},"incomplete\_details":null,"usage":null,"response\_format":"auto","tool\_choice":"auto","parallel\_tool\_calls":true}}
event: thread.run.queued
data: {"id":"run\_123","object":"thread.run","created\_at":1710330640,"assistant\_id":"asst\_123","thread\_id":"thread\_123","status":"queued","started\_at":null,"expires\_at":1710331240,"cancelled\_at":null,"failed\_at":null,"completed\_at":null,"required\_action":null,"last\_error":null,"model":"gpt-4o","instructions":null,"tools":[],"metadata":{},"temperature":1.0,"top\_p":1.0,"max\_completion\_tokens":null,"max\_prompt\_tokens":null,"truncation\_strategy":{"type":"auto","last\_messages":null},"incomplete\_details":null,"usage":null,"response\_format":"auto","tool\_choice":"auto","parallel\_tool\_calls":true}}
event: thread.run.in\_progress
data: {"id":"run\_123","object":"thread.run","created\_at":1710330640,"assistant\_id":"asst\_123","thread\_id":"thread\_123","status":"in\_progress","started\_at":1710330641,"expires\_at":1710331240,"cancelled\_at":null,"failed\_at":null,"completed\_at":null,"required\_action":null,"last\_error":null,"model":"gpt-4o","instructions":null,"tools":[],"metadata":{},"temperature":1.0,"top\_p":1.0,"max\_completion\_tokens":null,"max\_prompt\_tokens":null,"truncation\_strategy":{"type":"auto","last\_messages":null},"incomplete\_details":null,"usage":null,"response\_format":"auto","tool\_choice":"auto","parallel\_tool\_calls":true}}
event: thread.run.step.created
data: {"id":"step\_001","object":"thread.run.step","created\_at":1710330641,"run\_id":"run\_123","assistant\_id":"asst\_123","thread\_id":"thread\_123","type":"message\_creation","status":"in\_progress","cancelled\_at":null,"completed\_at":null,"expires\_at":1710331240,"failed\_at":null,"last\_error":null,"step\_details":{"type":"message\_creation","message\_creation":{"message\_id":"msg\_001"}},"usage":null}
event: thread.run.step.in\_progress
data: {"id":"step\_001","object":"thread.run.step","created\_at":1710330641,"run\_id":"run\_123","assistant\_id":"asst\_123","thread\_id":"thread\_123","type":"message\_creation","status":"in\_progress","cancelled\_at":null,"completed\_at":null,"expires\_at":1710331240,"failed\_at":null,"last\_error":null,"step\_details":{"type":"message\_creation","message\_creation":{"message\_id":"msg\_001"}},"usage":null}
event: thread.message.created
data: {"id":"msg\_001","object":"thread.message","created\_at":1710330641,"assistant\_id":"asst\_123","thread\_id":"thread\_123","run\_id":"run\_123","status":"in\_progress","incomplete\_details":null,"incomplete\_at":null,"completed\_at":null,"role":"assistant","content":[],"metadata":{}}
...
data: {"id":"msg\_001","object":"thread.message","created\_at":1710330641,"assistant\_id":"asst\_123","thread\_id":"thread\_123","run\_id":"run\_123","status":"completed","incomplete\_details":null,"incomplete\_at":null,"completed\_at":1710330642,"role":"assistant","content":[{"type":"text","text":{"value":"Hello! How can I assist you today?","annotations":[]}}],"metadata":{}}
event: thread.run.step.completed
data: {"id":"step\_001","object":"thread.run.step","created\_at":1710330641,"run\_id":"run\_123","assistant\_id":"asst\_123","thread\_id":"thread\_123","type":"message\_creation","status":"completed","cancelled\_at":null,"completed\_at":1710330642,"expires\_at":1710331240,"failed\_at":null,"last\_error":null,"step\_details":{"type":"message\_creation","message\_creation":{"message\_id":"msg\_001"}},"usage":{"prompt\_tokens":20,"completion\_tokens":11,"total\_tokens":31}}
event: thread.run.completed
data: {"id":"run\_123","object":"thread.run","created\_at":1710330640,"assistant\_id":"asst\_123","thread\_id":"thread\_123","status":"completed","started\_at":1710330641,"expires\_at":null,"cancelled\_at":null,"failed\_at":null,"completed\_at":1710330642,"required\_action":null,"last\_error":null,"model":"gpt-4o","instructions":null,"tools":[],"metadata":{},"temperature":1.0,"top\_p":1.0,"max\_completion\_tokens":null,"max\_prompt\_tokens":null,"truncation\_strategy":{"type":"auto","last\_messages":null},"incomplete\_details":null,"usage":{"prompt\_tokens":20,"completion\_tokens":11,"total\_tokens":31},"response\_format":"auto","tool\_choice":"auto","parallel\_tool\_calls":true}}
event: done
data: [DONE]
`
```
...
data: {"id":"run\_123","object":"thread.run","created\_at":1710348075,"assistant\_id":"asst\_123","thread\_id":"thread\_123","status":"queued","started\_at":null,"expires\_at":1710348675,"cancelled\_at":null,"failed\_at":null,"completed\_at":null,"required\_action":null,"last\_error":null,"model":"gpt-4o","instructions":null,"tools":[],"metadata":{},"temperature":1.0,"top\_p":1.0,"max\_completion\_tokens":null,"max\_prompt\_tokens":null,"truncation\_strategy":{"type":"auto","last\_messages":null},"incomplete\_details":null,"usage":null,"response\_format":"auto","tool\_choice":"auto","parallel\_tool\_calls":true}}
event: thread.run.in\_progress
data: {"id":"run\_123","object":"thread.run","created\_at":1710348075,"assistant\_id":"asst\_123","thread\_id":"thread\_123","status":"in\_progress","started\_at":1710348075,"expires\_at":1710348675,"cancelled\_at":null,"failed\_at":null,"completed\_at":null,"required\_action":null,"last\_error":null,"model":"gpt-4o","instructions":null,"tools":[],"metadata":{},"temperature":1.0,"top\_p":1.0,"max\_completion\_tokens":null,"max\_prompt\_tokens":null,"truncation\_strategy":{"type":"auto","last\_messages":null},"incomplete\_details":null,"usage":null,"response\_format":"auto","tool\_choice":"auto","parallel\_tool\_calls":true}}
event: thread.run.step.created
...
event: thread.run.completed
data: {"id":"run\_123","object":"thread.run","created\_at":1710348075,"assistant\_id":"asst\_123","thread\_id":"thread\_123","status":"completed","started\_at":1710348075,"expires\_at":null,"cancelled\_at":null,"failed\_at":null,"completed\_at":1710348077,"required\_action":null,"last\_error":null,"model":"gpt-4o","instructions":null,"tools":[],"metadata":{},"temperature":1.0,"top\_p":1.0,"max\_completion\_tokens":null,"max\_prompt\_tokens":null,"truncation\_strategy":{"type":"auto","last\_messages":null},"incomplete\_details":null,"usage":{"prompt\_tokens":20,"completion\_tokens":11,"total\_tokens":31},"response\_format":"auto","tool\_choice":"auto","parallel\_tool\_calls":true}}
event: done
data: [DONE]
`
```
