...
[](<#(resource) fine_tuning.jobs > (method) list > (params) default > (param) after > (schema)>)
limit: optional number
Number of fine-tuning jobs to retrieve.
[](<#(resource) fine_tuning.jobs > (method) list > (params) default > (param) limit > (schema)>)
metadata: optional map[string]
Optional metadata filter. To filter, use the syntax `metadata[k]=v`. Alternatively, set `metadata=null` to indicate no metadata.
[](<#(resource) fine_tuning.jobs > (method) list > (params) default > (param) metadata > (schema)>)
##### ReturnsExpand Collapse
data: array of [FineTuningJob](</api/reference/resources/fine_tuning#(resource) fine_tuning.jobs > (model) fine_tuning_job > (schema)>) { id, created\_at, error, 16 more }
id: string
...
[](<#(resource) fine_tuning.jobs > (method) list > (network schema) > (property) data>)
has\_more: boolean
[](<#(resource) fine_tuning.jobs > (method) list > (network schema) > (property) has_more>)
object: "list"
[](<#(resource) fine_tuning.jobs > (method) list > (network schema) > (property) object>)
### List fine-tuning jobs
HTTP
HTTP
HTTP
...
Terraform
```
`curl https://api.openai.com/v1/fine\_tuning/jobs?limit=2&metadata[key]=value \\
