...
TextContent = string
The text contents of the message.
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) content > (schema) > (variant) 0>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) content > (schema) > (variant) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) content > (schema)>)
...
One of the following:
"user"
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) role > (schema) > (member) 0>)
"assistant"
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) role > (schema) > (member) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) role > (schema)>)
attachments: optional array of object { file\_id, tools }
A list of files attached to the message, and the tools they should be added to.
file\_id: optional string
The ID of the file to attach to the message.
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) attachments > (schema) > (items) > (property) file_id>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) attachments > (schema) > (items) > (property) tools > (items) > (variant) 1 > (property) type>)
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) attachments > (schema) > (items) > (property) tools > (items) > (variant) 1>)
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) attachments > (schema) > (items) > (property) tools>)
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) attachments > (schema)>)
...
[](<#(resource) beta.threads.messages > (method) create > (params) 0 > (param) metadata > (schema)>)
