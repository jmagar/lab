...
`create\_sampling\_callback` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/sampling/__init__.py#L44)
```
`create\_sampling\_callback(sampling\_handler: SamplingHandler) -\> SamplingFnT
`
```