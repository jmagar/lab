...
`fastmcp.server.providers.skills.vendor\_providers`
...
`CursorSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/vendor_providers.py#L11)
Cursor skills from \~/.cursor/skills/.
###
[​
](#vscodeskillsprovider)
`VSCodeSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/vendor_providers.py#L29)
VS Code skills from \~/.copilot/skills/.
###
[​
](#codexskillsprovider)
`CodexSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/vendor_providers.py#L47)
...
`GeminiSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/vendor_providers.py#L73)
Gemini skills from \~/.gemini/skills/.
###
[​
](#gooseskillsprovider)
`GooseSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/vendor_providers.py#L91)
Goose skills from \~/.config/agents/skills/.
###
[​
](#copilotskillsprovider)
`CopilotSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/vendor_providers.py#L109)
GitHub Copilot skills from \~/.copilot/skills/.
###
[​
](#opencodeskillsprovider)
`OpenCodeSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/vendor_providers.py#L127)
