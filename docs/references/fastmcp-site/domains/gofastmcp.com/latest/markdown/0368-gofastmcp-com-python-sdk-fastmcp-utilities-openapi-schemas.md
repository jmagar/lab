...
`clean\_schema\_for\_display` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/schemas.py#L12)
```
`clean\_schema\_for\_display(schema: JsonSchema | None) -\> JsonSchema | None
`
```
...
`extract\_output\_schema\_from\_responses` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/schemas.py#L474)
```
`extract\_output\_schema\_from\_responses(responses: dict[str, ResponseInfo], schema\_definitions: dict[str, Any] | None = None, openapi\_version: str | None = None) -\> dict[str, Any] | None
`
```
...
* `schema\_definitions`: Optional schema definitions to include in the output schema
* `openapi\_version`: OpenAPI version string, used to optimize nullable field handling
**Returns:**
