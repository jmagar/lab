...
`BearerAuth` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/auth/bearer.py#L11)
**Methods:**
####
[​
](#auth_flow)
`auth\_flow` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/auth/bearer.py#L15)
```
`auth\_flow(self, request)
`
```