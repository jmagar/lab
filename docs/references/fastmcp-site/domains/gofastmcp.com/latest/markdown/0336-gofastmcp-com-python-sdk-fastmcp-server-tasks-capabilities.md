...
`get\_task\_capabilities` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/tasks/capabilities.py#L20)
```
`get\_task\_capabilities() -\> ServerTasksCapability | None
`
```
