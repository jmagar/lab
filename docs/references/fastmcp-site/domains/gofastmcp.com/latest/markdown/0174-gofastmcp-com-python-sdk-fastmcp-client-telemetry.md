...
`client\_span` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/telemetry.py#L12)
```
`client\_span(name: str, method: str, component\_key: str, session\_id: str | None = None, resource\_uri: str | None = None) -\> Generator[Span, None, None]
`
```
