...
fastmcp install goose server.py:my\_custom\_server
`
```
...
name: Weather Server
cmd: uvx
args: [fastmcp, run, /path/to/weather\_server.py]
enabled: true
envs:
...
>
Goose will automatically detect your `roll\_dice` tool and use it to fulfill your request, returning something like:
>
