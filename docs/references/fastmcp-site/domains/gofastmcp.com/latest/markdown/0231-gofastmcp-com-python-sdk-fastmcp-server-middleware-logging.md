...
`default\_serializer` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/logging.py#L15)
```
`default\_serializer(data: Any) -\> str
`
```
...
`BaseLoggingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/logging.py#L20)
Base class for logging middleware.
**Methods:**
####
[​
](#on_message)
`on\_message` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/logging.py#L124)
```
`on\_message(self, context: MiddlewareContext[Any], call\_next: CallNext[Any, Any]) -\> Any
`
```
...
`LoggingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/logging.py#L148)
...
`StructuredLoggingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/logging.py#L203)
