...
`OpenAPIProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/provider.py#L51)
...
`lifespan` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/provider.py#L181)
```
...
`get\_tasks` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/provider.py#L431)
```
`get\_tasks(self) -\> Sequence[FastMCPComponent]
`
```
