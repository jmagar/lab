...
`fastmcp.server.middleware.rate\_limiting`
...
`RateLimitError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L15)
Error raised when rate limit is exceeded.
###
[​
](#tokenbucketratelimiter)
`TokenBucketRateLimiter` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L22)
Token bucket implementation for rate limiting.
**Methods:**
####
[​
](#consume)
`consume` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L38)
```
...
`SlidingWindowRateLimiter` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L61)
Sliding window rate limiter implementation.
**Methods:**
####
[​
](#is_allowed)
`is\_allowed` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L76)
```
`is\_allowed(self) -\> bool
`
```
...
`RateLimitingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L92)
...
`on\_request` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L152)
```
...
`SlidingWindowRateLimitingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L170)
...
`on\_request` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/rate_limiting.py#L219)
```
`on\_request(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
