...
`fastmcp.utilities.mcp\_server\_config.v1.environments.uv`
##
[​
](#classes)
Classes
...
`UVEnvironment` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/uv.py#L14)
Configuration for Python environment setup.
**Methods:**
####
[​
](#build_command)
`build\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/uv.py#L49)
```
`build\_command(self, command: list[str]) -\> list[str]
`
```
...
`prepare` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/uv.py#L109)
```
`prepare(self, output\_dir: Path | None = None) -\> None
`
```
Prepare the Python environment using uv.
**Args:**
* `output\_dir`: Directory where the persistent uv project will be created.
