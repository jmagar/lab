...
`default\_log\_handler` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/logging.py#L17)
```
`default\_log\_handler(message: LogMessage) -\> None
`
```
...
`create\_log\_callback` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/logging.py#L47)
```
`create\_log\_callback(handler: LogHandler | None = None) -\> LoggingFnT
`
```