...
`fastmcp.server.providers.skills.directory\_provider`
...
`SkillsDirectoryProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/directory_provider.py#L19)
...
* `main\_file\_name`: Name of the main skill file. Defaults to “SKILL.md”.
* `supporting\_files`: How supporting files are exposed in child SkillProviders:
