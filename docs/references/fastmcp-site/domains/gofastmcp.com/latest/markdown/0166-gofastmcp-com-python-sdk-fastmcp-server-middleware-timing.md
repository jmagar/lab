...
`TimingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L10)
...
`on\_request` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L39)
```
`on\_request(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
...
`DetailedTimingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L60)
...
`on\_call\_tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L111)
```
`on\_call\_tool(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
Time tool execution.
####
...
`on\_read\_resource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L118)
```
`on\_read\_resource(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
...
`on\_get\_prompt` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L127)
```
`on\_get\_prompt(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
...
`on\_list\_tools` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L134)
```
`on\_list\_tools(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
Time tool listing.
####
...
`on\_list\_resources` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L140)
```
`on\_list\_resources(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
...
`on\_list\_resource\_templates` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L146)
```
`on\_list\_resource\_templates(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
...
`on\_list\_prompts` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/timing.py#L152)
```
`on\_list\_prompts(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
Time prompt listing.