...
`inspect\_fastmcp\_v2` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L100)
```
`inspect\_fastmcp\_v2(mcp: FastMCP[Any]) -\> FastMCPInfo
`
```
...
`inspect\_fastmcp\_v1` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L236)
```
`inspect\_fastmcp\_v1(mcp: FastMCP1x) -\> FastMCPInfo
`
```
...
`inspect\_fastmcp` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L378)
```
`inspect\_fastmcp(mcp: FastMCP[Any] | FastMCP1x) -\> FastMCPInfo
`
```
...
`format\_fastmcp\_info` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L403)
```
`format\_fastmcp\_info(info: FastMCPInfo) -\> bytes
`
```
...
`format\_mcp\_info` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L432)
```
`format\_mcp\_info(mcp: FastMCP[Any] | FastMCP1x) -\> bytes
`
```
...
`format\_info` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L465)
```
`format\_info(mcp: FastMCP[Any] | FastMCP1x, format: InspectFormat | Literal['fastmcp', 'mcp'], info: FastMCPInfo | None = None) -\> bytes
`
```
...
`ToolInfo` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L19)
Information about a tool.
###
[​
](#promptinfo)
`PromptInfo` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L35)
Information about a prompt.
###
[​
](#resourceinfo)
`ResourceInfo` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L49)
Information about a resource.
###
[​
](#templateinfo)
`TemplateInfo` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L65)
Information about a resource template.
###
[​
](#fastmcpinfo)
`FastMCPInfo` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L82)
Information extracted from a FastMCP instance.
###
[​
](#inspectformat)
`InspectFormat` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/inspect.py#L396)
