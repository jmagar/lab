...
`fastmcp.utilities.mcp\_server\_config.v1.sources.filesystem`
##
[​
](#classes)
Classes
...
`FileSystemSource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/filesystem.py#L16)
Source for local Python files.
**Methods:**
####
[​
](#parse_path_with_object)
`parse\_path\_with\_object` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/filesystem.py#L29)
```
`parse\_path\_with\_object(cls, v: str) -\> str
`
```
...
`load\_server` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/filesystem.py#L64)
```
`load\_server(self) -\> Any
`
```
