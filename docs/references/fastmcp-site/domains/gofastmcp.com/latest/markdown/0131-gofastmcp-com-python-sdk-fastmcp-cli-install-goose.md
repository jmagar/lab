...
`generate\_goose\_deeplink` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/goose.py#L29)
```
`generate\_goose\_deeplink(name: str, command: str, args: list[str]) -\> str
`
```
...
`install\_goose` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/goose.py#L86)
```
`install\_goose(file: Path, server\_object: str | None, name: str) -\> bool
`
```
...
`goose\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/goose.py#L136)
```
`goose\_command(server\_spec: str) -\> None
`
```
