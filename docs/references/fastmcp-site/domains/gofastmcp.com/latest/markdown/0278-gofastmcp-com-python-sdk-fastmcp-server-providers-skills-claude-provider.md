...
`fastmcp.server.providers.skills.claude\_provider`
...
`ClaudeSkillsProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/skills/claude_provider.py#L11)
...
* `supporting\_files`: How supporting files are exposed:
