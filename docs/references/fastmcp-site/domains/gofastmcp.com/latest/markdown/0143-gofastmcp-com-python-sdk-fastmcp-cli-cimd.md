...
`create\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/cimd.py#L32)
```
`create\_command() -\> None
`
```
...
`validate\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/cimd.py#L144)
```
`validate\_command(url: Annotated[str, cyclopts.Parameter(help='URL of the CIMD document to validate')]) -\> None
`
```
