...
`resolve\_task\_config` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/decorators.py#L17)
```
`resolve\_task\_config(task: bool | TaskConfig | None) -\> bool | TaskConfig
`
```
...
`get\_fastmcp\_meta` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/decorators.py#L29)
```
`get\_fastmcp\_meta(fn: Any) -\> Any | None
`
```
...
`HasFastMCPMeta` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/decorators.py#L23)
