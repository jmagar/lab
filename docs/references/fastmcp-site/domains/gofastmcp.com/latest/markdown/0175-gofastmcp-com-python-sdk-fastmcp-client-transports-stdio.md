...
`StdioTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L22)
...
`connect\_session` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L72)
```
`connect\_session(self, \*\*session\_kwargs: Unpack[SessionKwargs]) -\> AsyncIterator[ClientSession]
`
```
####
[​
](#connect)
`connect` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L84)
```
`connect(self, \*\*session\_kwargs: Unpack[SessionKwargs]) -\> ClientSession | None
`
```
####
[​
](#disconnect)
`disconnect` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L127)
```
`disconnect(self)
`
```
...
`close` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L162)
```
`close(self)
`
```
...
`PythonStdioTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L232)
Transport for running Python scripts.
###
[​
](#fastmcpstdiotransport)
`FastMCPStdioTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L285)
Transport for running FastMCP servers using the FastMCP CLI.
###
[​
](#nodestdiotransport)
`NodeStdioTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L314)
Transport for running Node.js scripts.
###
[​
](#uvstdiotransport)
`UvStdioTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L367)
Transport for running commands via the uv tool.
###
[​
](#uvxstdiotransport)
`UvxStdioTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L446)
Transport for running commands via the uvx tool.
###
[​
](#npxstdiotransport)
`NpxStdioTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/stdio.py#L511)
