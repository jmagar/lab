...
`list\_skills` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/skills.py#L43)
```
`list\_skills(client: Client) -\> list[SkillSummary]
`
```
...
`get\_skill\_manifest` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/skills.py#L87)
```
`get\_skill\_manifest(client: Client, skill\_name: str) -\> SkillManifest
`
```
...
`download\_skill` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/skills.py#L127)
```
`download\_skill(client: Client, skill\_name: str, target\_dir: str | Path) -\> Path
`
```
...
**Args:**
* `client`: Connected FastMCP client
* `skill\_name`: Name of the skill to download
* `target\_dir`: Directory where skill folder will be created
...
`sync\_skills` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/skills.py#L218)
```
`sync\_skills(client: Client, target\_dir: str | Path) -\> list[Path]
`
```
Download all available skills from a server.
**Args:**
* `client`: Connected FastMCP client
* `target\_dir`: Directory where skill folders will be created
...
`SkillSummary` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/skills.py#L18)
Summary information about a skill available on a server.
###
[​
](#skillfile)
`SkillFile` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/skills.py#L27)
Information about a file within a skill.
###
[​
](#skillmanifest)
`SkillManifest` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/skills.py#L36)
