...
`fastmcp.tools.function\_parsing`
...
`ParsedFunction` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/tools/function_parsing.py#L117)
**Methods:**
####
[​
](#from_function)
`from\_function` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/tools/function_parsing.py#L126)
```
`from\_function(cls, fn: Callable[..., Any], exclude\_args: list[str] | None = None, validate: bool = True, wrap\_non\_object\_output\_schema: bool = True) -\> ParsedFunction
`
```