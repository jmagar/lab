...
`fastmcp.server.providers.local\_provider.decorators.tools`
...
`ToolDecoratorMixin` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/tools.py#L150)
...
`add\_tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/tools.py#L158)
```
`add\_tool(self: LocalProvider, tool: Tool | Callable[..., Any]) -\> Tool
`
```
...
`tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/tools.py#L210)
```
`tool(self: LocalProvider, name\_or\_fn: F) -\> F
`
```
####
[​
](#tool-2)
`tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/tools.py#L232)
```
`tool(self: LocalProvider, name\_or\_fn: str | None = None) -\> Callable[[F], F]
`
```
####
[​
](#tool-3)
`tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/tools.py#L257)
```
`tool(self: LocalProvider, name\_or\_fn: str | AnyFunction | None = None) -\> Callable[[AnyFunction], FunctionTool] | FunctionTool | partial[Callable[[AnyFunction], FunctionTool] | FunctionTool]
`
```
...
**Args:**
* `name\_or\_fn`: Either a function (when used as @tool), a string name, or None
...
* `output\_schema`: Optional JSON schema for the tool’s output
* `annotations`: Optional annotations about the tool’s behavior
* `exclude\_args`: Optional list of argument names to exclude from the tool schema
