...
`convert\_roots\_list` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/roots.py#L19)
```
`convert\_roots\_list(roots: RootsList) -\> list[mcp.types.Root]
`
```
###
[​
](#create_roots_callback)
`create\_roots\_callback` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/roots.py#L33)
```
`create\_roots\_callback(handler: RootsList | RootsHandler) -\> ListRootsFnT
`
```