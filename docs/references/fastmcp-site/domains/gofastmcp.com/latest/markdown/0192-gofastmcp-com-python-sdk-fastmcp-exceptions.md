...
`FastMCPDeprecationWarning` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L6)
...
`FastMCPError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L15)
Base error for FastMCP.
###
[​
](#validationerror)
`ValidationError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L19)
Error in validating parameters or return values.
###
[​
](#resourceerror)
`ResourceError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L23)
Error in resource operations.
###
[​
](#toolerror)
`ToolError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L27)
Error in tool operations.
###
[​
](#prompterror)
`PromptError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L31)
Error in prompt operations.
###
[​
](#invalidsignature)
`InvalidSignature` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L35)
Invalid signature for use with FastMCP.
###
[​
](#clienterror)
`ClientError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L39)
Error in client operations.
###
[​
](#notfounderror)
`NotFoundError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L43)
Object not found.
###
[​
](#disablederror)
`DisabledError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L47)
Object is disabled.
###
[​
](#authorizationerror)
`AuthorizationError` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/exceptions.py#L51)
