...
`SSETransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/sse.py#L25)
Transport implementation that connects to an MCP server via Server-Sent Events.
**Methods:**
####
[​
](#connect_session)
`connect\_session` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/sse.py#L115)
```
