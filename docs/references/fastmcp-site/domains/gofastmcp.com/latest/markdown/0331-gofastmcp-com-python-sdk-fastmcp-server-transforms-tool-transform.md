...
`fastmcp.server.transforms.tool\_transform`
...
`ToolTransform` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/tool_transform.py#L16)
...
`list\_tools` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/tool_transform.py#L64)
```
...
`get\_tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/tool_transform.py#L75)
```
