...
`MCPType` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/routing.py#L42)
Type of FastMCP component to create from a route.
###
[​
](#routemap)
`RouteMap` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/routing.py#L59)
