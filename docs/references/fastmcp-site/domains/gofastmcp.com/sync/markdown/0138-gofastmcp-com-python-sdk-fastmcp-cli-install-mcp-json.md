...
`install\_mcp\_json` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/mcp_json.py#L20)
```
`install\_mcp\_json(file: Path, server\_object: str | None, name: str) -\> bool
`
```
...
`mcp\_json\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/mcp_json.py#L98)
```
`mcp\_json\_command(server\_spec: str) -\> None
`
```
Generate MCP configuration JSON for manual installation.
**Args:**
