...
`create\_elicitation\_callback` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/elicitation.py#L38)
```
`create\_elicitation\_callback(elicitation\_handler: ElicitationHandler) -\> ElicitationFnT
`
```
##
[​
...
`ElicitResult` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/elicitation.py#L22)