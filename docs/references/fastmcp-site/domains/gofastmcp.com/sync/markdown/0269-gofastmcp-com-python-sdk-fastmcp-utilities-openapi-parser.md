...
`parse\_openapi\_to\_http\_routes` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/parser.py#L55)
```
`parse\_openapi\_to\_http\_routes(openapi\_dict: dict[str, Any]) -\> list[HTTPRoute]
`
```
...
`OpenAPIParser` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/parser.py#L109)
Unified parser for OpenAPI schemas with generic type parameters to handle both 3.0 and 3.1.
**Methods:**
####
[​
](#parse)
`parse` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/parser.py#L663)
```
