...
`discover\_files` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/filesystem_discovery.py#L34)
```
`discover\_files(root: Path) -\> list[Path]
`
```
...
`import\_module\_from\_file` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/filesystem_discovery.py#L119)
```
`import\_module\_from\_file(file\_path: Path, provider\_root: Path | None = None) -\> ModuleType
`
```
...
**Args:**
* `file\_path`: Path to the Python file.
* `provider\_root`: The provider’s root directory. Prevents package root
...
`extract\_components` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/filesystem_discovery.py#L235)
```
`extract\_components(module: ModuleType) -\> list[FastMCPComponent]
`
```
...
`discover\_and\_import` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/filesystem_discovery.py#L359)
```
`discover\_and\_import(root: Path) -\> DiscoveryResult
`
```
...
`DiscoveryResult` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/filesystem_discovery.py#L26)
