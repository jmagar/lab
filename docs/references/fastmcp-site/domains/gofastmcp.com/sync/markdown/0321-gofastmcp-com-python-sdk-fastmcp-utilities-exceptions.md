...
`iter\_exc` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/exceptions.py#L12)
```
`iter\_exc(group: BaseExceptionGroup)
`
```
###
[​
](#get_catch_handlers)
`get\_catch\_handlers` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/exceptions.py#L42)
```
`get\_catch\_handlers() -\> Mapping[type[BaseException] | Iterable[type[BaseException]], Callable[[BaseExceptionGroup[Any]], Any]]
`
```