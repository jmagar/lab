...
`combine\_lifespans` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/lifespan.py#L12)
```
`combine\_lifespans(\*lifespans: Callable[[AppT], AbstractAsyncContextManager[Mapping[str, Any] | None]]) -\> Callable[[AppT], AbstractAsyncContextManager[dict[str, Any]]]
`
```
