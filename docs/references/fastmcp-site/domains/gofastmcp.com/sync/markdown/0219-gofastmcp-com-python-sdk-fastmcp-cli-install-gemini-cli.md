...
`fastmcp.cli.install.gemini\_cli`
...
`find\_gemini\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L20)
```
`find\_gemini\_command() -\> str | None
`
```
...
`check\_gemini\_cli\_available` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L64)
```
`check\_gemini\_cli\_available() -\> bool
`
```
...
`install\_gemini\_cli` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L69)
```
`install\_gemini\_cli(file: Path, server\_object: str | None, name: str) -\> bool
`
```
...
`gemini\_cli\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L152)
```
`gemini\_cli\_command(server\_spec: str) -\> None
`
```
