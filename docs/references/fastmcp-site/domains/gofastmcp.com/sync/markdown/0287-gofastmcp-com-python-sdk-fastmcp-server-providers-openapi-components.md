...
`OpenAPITool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/components.py#L138)
Tool implementation for OpenAPI endpoints.
**Methods:**
####
[​
](#run)
`run` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/components.py#L180)
```
...
`OpenAPIResource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/components.py#L257)
Resource implementation for OpenAPI endpoints.
**Methods:**
####
[​
](#read)
`read` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/components.py#L287)
```
...
`OpenAPIResourceTemplate` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/components.py#L371)
Resource template implementation for OpenAPI endpoints.
**Methods:**
####
[​
](#create_resource)
`create\_resource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/openapi/components.py#L403)
```
`create\_resource(self, uri: str, params: dict[str, Any], context: Context | None = None) -\> Resource
`
```
