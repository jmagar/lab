...
`fastmcp.server.transforms.prompts\_as\_tools`
...
# Now has list\_prompts and get\_prompt tools
`
```
##
[​
...
`PromptsAsTools` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/prompts_as_tools.py#L38)
Transform that adds tools for listing and getting prompts.
Generates two tools:
* `list\_prompts`: Lists all prompts
* `get\_prompt`: Gets a specific prompt with optional arguments
...
`list\_tools` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/prompts_as_tools.py#L75)
```
...
`get\_tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/prompts_as_tools.py#L83)
```
