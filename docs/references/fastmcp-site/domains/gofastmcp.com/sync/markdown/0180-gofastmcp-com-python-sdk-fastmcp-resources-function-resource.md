...
`fastmcp.resources.function\_resource`
...
`resource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/resources/function_resource.py#L241)
```
...
`DecoratedResource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/resources/function_resource.py#L41)
Protocol for functions decorated with @resource.
###
[​
](#resourcemeta)
`ResourceMeta` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/resources/function_resource.py#L50)
Metadata attached to functions by the @resource decorator.
###
[​
](#functionresource)
`FunctionResource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/resources/function_resource.py#L69)
...
`from\_function` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/resources/function_resource.py#L85)
```
`from\_function(cls, fn: Callable[..., Any], uri: str | AnyUrl | None = None) -\> FunctionResource
`
```
...
`read` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/resources/function_resource.py#L209)
```
...
`register\_with\_docket` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/resources/function_resource.py#L230)
```
