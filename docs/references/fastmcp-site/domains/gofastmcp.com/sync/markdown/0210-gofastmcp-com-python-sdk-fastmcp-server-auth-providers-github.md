...
auth = GitHubProvider(
client\_id="your-github-client-id",
client\_secret="your-github-client-secret"
)
...
`GitHubTokenVerifier` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/github.py#L41)
...
Caching is disabled by default. Set `cache\_ttl\_seconds` to a positive
...
`verify\_token` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/github.py#L82)
```
...
`GitHubProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/github.py#L178)
