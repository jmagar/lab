...
`default\_progress\_handler` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/progress.py#L12)
```
`default\_progress\_handler(progress: float, total: float | None, message: str | None) -\> None
`
```
