...
`normalize\_timeout\_to\_timedelta` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/timeout.py#L8)
```
`normalize\_timeout\_to\_timedelta(value: int | float | datetime.timedelta | None) -\> datetime.timedelta | None
`
```
...
`normalize\_timeout\_to\_seconds` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/timeout.py#L28)
```
`normalize\_timeout\_to\_seconds(value: int | float | datetime.timedelta | None) -\> float | None
`
```
