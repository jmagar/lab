...
`fastmcp.cli.install.claude\_desktop`
...
`get\_claude\_config\_path` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/claude_desktop.py#L20)
```
`get\_claude\_config\_path(config\_path: Path | None = None) -\> Path | None
`
```
Get the Claude config directory based on platform.
**Args:**
* `config\_path`: Optional custom path to the Claude Desktop config directory
###
[​
](#install_claude_desktop)
`install\_claude\_desktop` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/claude_desktop.py#L49)
```
`install\_claude\_desktop(file: Path, server\_object: str | None, name: str) -\> bool
`
```
...
* `config\_path`: Optional custom path to Claude Desktop config directory
**Returns:**
* True if installation was successful, False otherwise
###
[​
](#claude_desktop_command)
`claude\_desktop\_command` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/cli/install/claude_desktop.py#L139)
```
`claude\_desktop\_command(server\_spec: str) -\> None
`
```
