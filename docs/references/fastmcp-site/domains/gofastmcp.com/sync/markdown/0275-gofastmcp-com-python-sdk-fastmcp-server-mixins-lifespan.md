...
`LifespanMixin` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/mixins/lifespan.py#L25)
Mixin providing lifespan and Docket task infrastructure for FastMCP.
**Methods:**
####
[​
](#docket)
`docket` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/mixins/lifespan.py#L29)
```
