...
`get\_auth\_span\_attributes` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/telemetry.py#L13)
```
`get\_auth\_span\_attributes() -\> dict[str, str]
`
```
...
`get\_session\_span\_attributes` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/telemetry.py#L30)
```
`get\_session\_span\_attributes() -\> dict[str, str]
`
```
...
`server\_span` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/telemetry.py#L56)
```
`server\_span(name: str, method: str, server\_name: str, component\_type: str, component\_key: str, resource\_uri: str | None = None) -\> Generator[Span, None, None]
`
```
...
`delegate\_span` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/telemetry.py#L100)
```
`delegate\_span(name: str, provider\_type: str, component\_key: str) -\> Generator[Span, None, None]
`
```
