...
`fastmcp.utilities.async\_utils`
...
`is\_coroutine\_function` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/async_utils.py#L15)
```
`is\_coroutine\_function(fn: Any) -\> bool
`
```
...
`call\_sync\_fn\_in\_threadpool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/async_utils.py#L27)
```
`call\_sync\_fn\_in\_threadpool(fn: Callable[..., Any], \*args: Any, \*\*kwargs: Any) -\> Any
`
```
...
`gather` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/async_utils.py#L52)
```
...
* `return\_exceptions`: If True, exceptions are returned in results.
