...
`StreamableHttpTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/http.py#L27)
Transport implementation that connects to an MCP server via Streamable HTTP Requests.
**Methods:**
####
[​
](#connect_session)
`connect\_session` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/http.py#L148)
```
...
`get\_session\_id` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/http.py#L201)
```
...
`close` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/http.py#L209)
```
`close(self)
`
```