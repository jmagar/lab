...
`fastmcp.server.middleware.response\_limiting`
...
`ResponseLimitingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/response_limiting.py#L20)
...
`on\_call\_tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/response_limiting.py#L93)
```
