...
`decode\_jwt\_header` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/auth.py#L32)
```
`decode\_jwt\_header(token: str) -\> dict[str, Any]
`
```
...
`decode\_jwt\_payload` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/auth.py#L49)
```
`decode\_jwt\_payload(token: str) -\> dict[str, Any]
`
```
...
`parse\_scopes` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/auth.py#L66)
```
`parse\_scopes(value: Any) -\> list[str] | None
`
```
