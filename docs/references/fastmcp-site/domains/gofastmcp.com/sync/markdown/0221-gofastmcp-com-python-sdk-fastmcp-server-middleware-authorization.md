...
AuthMiddleware(auth=require\_scopes("api"))
])
...
`AuthMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L51)
...
`on\_list\_tools` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L85)
```
`on\_list\_tools(self, context: MiddlewareContext[mt.ListToolsRequest], call\_next: CallNext[mt.ListToolsRequest, Sequence[Tool]]) -\> Sequence[Tool]
`
```
...
`on\_call\_tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L113)
```
`on\_call\_tool(self, context: MiddlewareContext[mt.CallToolRequestParams], call\_next: CallNext[mt.CallToolRequestParams, ToolResult]) -\> ToolResult
`
```
...
`on\_list\_resources` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L156)
```
`on\_list\_resources(self, context: MiddlewareContext[mt.ListResourcesRequest], call\_next: CallNext[mt.ListResourcesRequest, Sequence[Resource]]) -\> Sequence[Resource]
`
```
...
`on\_read\_resource` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L183)
```
`on\_read\_resource(self, context: MiddlewareContext[mt.ReadResourceRequestParams], call\_next: CallNext[mt.ReadResourceRequestParams, ResourceResult]) -\> ResourceResult
`
```
...
`on\_list\_resource\_templates` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L226)
```
`on\_list\_resource\_templates(self, context: MiddlewareContext[mt.ListResourceTemplatesRequest], call\_next: CallNext[mt.ListResourceTemplatesRequest, Sequence[ResourceTemplate]]) -\> Sequence[ResourceTemplate]
`
```
...
`on\_list\_prompts` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L255)
```
`on\_list\_prompts(self, context: MiddlewareContext[mt.ListPromptsRequest], call\_next: CallNext[mt.ListPromptsRequest, Sequence[Prompt]]) -\> Sequence[Prompt]
`
```
...
`on\_get\_prompt` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/authorization.py#L282)
```
`on\_get\_prompt(self, context: MiddlewareContext[mt.GetPromptRequestParams], call\_next: CallNext[mt.GetPromptRequestParams, PromptResult]) -\> PromptResult
`
```
