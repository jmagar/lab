...
`SessionKwargs` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/base.py#L23)
Keyword arguments for the MCP ClientSession constructor.
###
[​
](#clienttransport)
`ClientTransport` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/base.py#L36)
...
`connect\_session` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/base.py#L47)
```
...
within this context.
**Args:**
* `\*\*session\_kwargs`: Keyword arguments to pass to the ClientSession
constructor (e.g., callbacks, timeouts).
####
[​
](#close)
`close` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/base.py#L73)
```
`close(self)
`
```
...
`get\_session\_id` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/transports/base.py#L76)
```
`get\_session\_id(self) -\> str | None
`
```
