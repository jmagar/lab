...
auth = GoogleProvider(
client\_id="your-google-client-id.apps.googleusercontent.com",
client\_secret="your-google-client-secret"
)
...
`GoogleTokenVerifier` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/google.py#L57)
...
`verify\_token` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/google.py#L92)
```
`verify\_token(self, token: str) -\> AccessToken | None
`
```
Verify a Google OAuth token using the tokeninfo endpoint.
Calls `https://oauth2.googleapis.com/tokeninfo?access\_token=TOKEN`
...
`GoogleProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/google.py#L204)
