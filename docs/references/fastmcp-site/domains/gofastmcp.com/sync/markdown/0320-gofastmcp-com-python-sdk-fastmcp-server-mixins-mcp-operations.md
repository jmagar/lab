...
`fastmcp.server.mixins.mcp\_operations`
...
`MCPOperationsMixin` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/mixins/mcp_operations.py#L44)
...
cannot use `self: FastMCP` type hints because the SDK’s `get\_type\_hints()` fails
