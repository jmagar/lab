...
`RequestDirector` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/director.py#L28)
Builds httpx.Request objects from HTTPRoute and arguments using openapi-core.
**Methods:**
####
[​
](#build)
`build` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/openapi/director.py#L35)
```
`build(self, route: HTTPRoute, flat\_args: dict[str, Any], base\_url: str = 'http://localhost') -\> httpx.Request
`
```
...
* `flat\_args`: Flattened arguments from LLM (may include suffixed parameters)
* `base\_url`: Base URL for the request
**Returns:**
