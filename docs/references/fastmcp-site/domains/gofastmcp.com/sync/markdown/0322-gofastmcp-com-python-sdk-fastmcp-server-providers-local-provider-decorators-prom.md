...
`fastmcp.server.providers.local\_provider.decorators.prompts`
...
`PromptDecoratorMixin` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/prompts.py#L29)
...
`add\_prompt` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/prompts.py#L37)
```
`add\_prompt(self: LocalProvider, prompt: Prompt | Callable[..., Any]) -\> Prompt
`
```
...
`prompt` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/prompts.py#L74)
```
`prompt(self: LocalProvider, name\_or\_fn: F) -\> F
`
```
####
[​
](#prompt-2)
`prompt` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/prompts.py#L91)
```
`prompt(self: LocalProvider, name\_or\_fn: str | None = None) -\> Callable[[F], F]
`
```
####
[​
](#prompt-3)
`prompt` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/providers/local_provider/decorators/prompts.py#L107)
```
`prompt(self: LocalProvider, name\_or\_fn: str | AnyFunction | None = None) -\> Callable[[AnyFunction], FunctionPrompt] | FunctionPrompt | partial[Callable[[AnyFunction], FunctionPrompt] | FunctionPrompt]
`
```
