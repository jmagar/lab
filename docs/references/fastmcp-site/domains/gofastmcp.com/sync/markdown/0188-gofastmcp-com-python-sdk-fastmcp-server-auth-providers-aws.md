...
from fastmcp.server.auth.providers.aws\_cognito import AWSCognitoProvider
# Simple AWS Cognito OAuth protection
auth = AWSCognitoProvider(
user\_pool\_id="your-user-pool-id",
aws\_region="eu-central-1",
client\_id="your-cognito-client-id",
client\_secret="your-cognito-client-secret"
)
...
`AWSCognitoTokenVerifier` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/aws.py#L40)
Token verifier that filters claims to Cognito-specific subset.
**Methods:**
####
[​
](#verify_token)
`verify\_token` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/aws.py#L43)
```
`verify\_token(self, token: str) -\> AccessToken | None
`
```
...
`AWSCognitoProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/aws.py#L67)
...
`get\_token\_verifier` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/aws.py#L178)
```
`get\_token\_verifier(self) -\> AWSCognitoTokenVerifier
`
```
...
* `required\_scopes`: Optional token verifier required\_scopes
* `timeout\_seconds`: HTTP request timeout in seconds