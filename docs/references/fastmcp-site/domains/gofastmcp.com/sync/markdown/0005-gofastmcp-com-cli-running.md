...
`
```
`fastmcp run` completely ignores the `if \_\_name\_\_ == "\_\_main\_\_"` block. Any setup code in that block won’t execute. If you need initialization logic to run, use a [factory function](/cli/overview#factory-functions).
###
[​
](#options)
Options
