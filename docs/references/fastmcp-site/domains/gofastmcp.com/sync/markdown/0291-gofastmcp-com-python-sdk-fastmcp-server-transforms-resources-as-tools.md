...
`fastmcp.server.transforms.resources\_as\_tools`
...
# Now has list\_resources and read\_resource tools
`
```
##
[​
...
`ResourcesAsTools` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/resources_as_tools.py#L41)
Transform that adds tools for listing and reading resources.
Generates two tools:
* `list\_resources`: Lists all resources and templates
* `read\_resource`: Reads a resource by URI
...
`list\_tools` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/resources_as_tools.py#L78)
```
...
`get\_tool` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/transforms/resources_as_tools.py#L86)
```
