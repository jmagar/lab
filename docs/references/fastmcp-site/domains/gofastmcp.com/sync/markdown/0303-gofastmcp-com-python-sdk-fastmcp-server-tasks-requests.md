...
`tasks\_get\_handler` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/tasks/requests.py#L137)
```
`tasks\_get\_handler(server: FastMCP, params: dict[str, Any]) -\> GetTaskResult
`
```
...
`tasks\_result\_handler` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/tasks/requests.py#L222)
```
`tasks\_result\_handler(server: FastMCP, params: dict[str, Any]) -\> Any
`
```
...
`tasks\_list\_handler` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/tasks/requests.py#L403)
```
`tasks\_list\_handler(server: FastMCP, params: dict[str, Any]) -\> ListTasksResult
`
```
...
`tasks\_cancel\_handler` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/tasks/requests.py#L421)
```
`tasks\_cancel\_handler(server: FastMCP, params: dict[str, Any]) -\> CancelTaskResult
`
```
