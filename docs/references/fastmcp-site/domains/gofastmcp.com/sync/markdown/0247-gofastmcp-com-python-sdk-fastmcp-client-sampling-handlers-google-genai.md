...
`fastmcp.client.sampling.handlers.google\_genai`
...
`GoogleGenaiSamplingHandler` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/client/sampling/handlers/google_genai.py#L56)
