...
`fastmcp.server.middleware.error\_handling`
...
`ErrorHandlingMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/error_handling.py#L18)
...
`on\_message` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/error_handling.py#L120)
```
`on\_message(self, context: MiddlewareContext, call\_next: CallNext) -\> Any
`
```
...
`get\_error\_stats` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/error_handling.py#L131)
```
`get\_error\_stats(self) -\> dict[str, int]
`
```
...
`RetryMiddleware` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/error_handling.py#L136)
...
`on\_request` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/middleware/error_handling.py#L192)
```
