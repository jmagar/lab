...
auth\_url="https://auth.yourdomain.com",
introspection\_client\_id="your-client-id",
introspection\_client\_secret="your-client-secret",
...
`PropelAuthTokenIntrospectionOverrides` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/propelauth.py#L36)
###
[​
](#propelauthprovider)
`PropelAuthProvider` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/propelauth.py#L43)
...
`get\_routes` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/propelauth.py#L141)
```
`get\_routes(self, mcp\_path: str | None = None) -\> list[Route]
`
```
...
**Args:**
* `mcp\_path`: The path where the MCP endpoint is mounted (e.g., “/mcp”)
This is used to advertise the resource URL in metadata.
####
[​
](#verify_token)
`verify\_token` [](https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/server/auth/providers/propelauth.py#L185)
```
