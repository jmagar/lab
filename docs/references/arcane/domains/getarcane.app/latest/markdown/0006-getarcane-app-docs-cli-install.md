...
> [!NOTE]The Arcane CLI is a very new feature and may be buggy. Feedback is greatly appreciated!
...
## Installation
### Manual Download
You can download the latest binary for your platform from our [GitHub Releases](https://github.com/getarcaneapp/arcane/releases/latest)
### Curl Install Script
...
> [!NOTE]
`> --beta
`> always installs the latest
`> cli-next
`> binary from R2. It does not use a versioned beta release path.
### Homebrew
Copy
### Go Install
Copy
