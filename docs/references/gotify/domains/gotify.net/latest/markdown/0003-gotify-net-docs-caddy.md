Caddy 2 reverse proxy | Gotify
[Skip to content](#VPContent)
Menu
Return to top
# Caddy 2 reverse proxy [​](#caddy-2-reverse-proxy)
Setting up [Caddy](https://caddyserver.com) as a reverse proxy is very straightforward. Here are two config examples.
## As a standalone domain [​](#as-a-standalone-domain)
