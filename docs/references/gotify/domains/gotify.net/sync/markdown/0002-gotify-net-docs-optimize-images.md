Optimize uploaded images | Gotify
[Skip to content](#VPContent)
Menu
Return to top
# Optimize uploaded images [​](#optimize-uploaded-images)
...
* [optipng](https://optipng.sourceforge.net/)## Script [​](#script)
...
```
Note that if `$DATA/images-optimized` is missing, all files are selected for rescaling and optimization.
