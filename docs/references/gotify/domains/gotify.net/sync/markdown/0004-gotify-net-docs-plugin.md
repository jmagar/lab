Intro to Gotify Plugins | Gotify
[Skip to content](#VPContent)
Menu
Return to top
# Intro to Gotify Plugins [​](#intro-to-gotify-plugins)
WARNING
Plugins are currently only supported on Linux and MacOS due to a current limitation of golang.
## Description [​](#description)
*This documentation is generally designed for plugin developers. If you just wanted to use an existing plugin, you would need to refer to the documentation from the plugin maintainer.*
...
* Displaying dynamically generated instructions to users## Applications [​](#applications)
...
* Delivering alarm notifications.## Get Started [​](#get-started)
