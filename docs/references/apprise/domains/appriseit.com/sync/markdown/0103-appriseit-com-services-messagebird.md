MessageBird Notifications | Apprise Documentation
[Skip to content](#_top)
If Apprise helps you, please consider supporting the project: [GitHub Sponsors](https://github.com/sponsors/caronc) or [PayPal](https://www.paypal.com/donate/?hosted_button_id=CR6YF7KLQWQ5E).
# MessageBird Notifications
## Overview
* **Source:** [https://messagebird.com](https://messagebird.com)
* **Image Support:** No
* **Attachment Support:** No
* **Message Character Limits:**
* Body: 160
* [ Build Your Apprise URL](/url-builder/?schema=msgbird)
## Account Setup
[Section titled “Account Setup”](#account-setup)
To use MessageBird, you will need to acquire your *API Key*. This is accessible via the [MessageBird Dashboard](https://dashboard.messagebird.com/en/user/index).
## Syntax
...
|ApiKey|Yes|The *API Key* associated with your MessageBird account. This is available to you via the [MessageBird Dashboard](https://dashboard.messagebird.com/en/user/index).|
