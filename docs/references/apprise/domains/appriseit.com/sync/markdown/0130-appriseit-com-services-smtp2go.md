SMTP2Go Notifications | Apprise Documentation
[Skip to content](#_top)
If Apprise helps you, please consider supporting the project: [GitHub Sponsors](https://github.com/sponsors/caronc) or [PayPal](https://www.paypal.com/donate/?hosted_button_id=CR6YF7KLQWQ5E).
# SMTP2Go Notifications
## Overview
* **Source:** [https://www.smtp2go.com/](https://www.smtp2go.com/)
* **Image Support:** No
* **Attachment Support:** Yes
* **Message Character Limits:**
* Body: 32768
* [ Build Your Apprise URL](/url-builder/?schema=smtp2go)
## Account Setup
...
Send a SMTP2Go notification to the email address [bill.gates@microsoft.com](mailto:bill.gates@microsoft.com)
Terminal window
```
`
