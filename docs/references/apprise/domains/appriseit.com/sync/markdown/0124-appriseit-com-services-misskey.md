Misskey Notifications | Apprise Documentation
[Skip to content](#_top)
If Apprise helps you, please consider supporting the project: [GitHub Sponsors](https://github.com/sponsors/caronc) or [PayPal](https://www.paypal.com/donate/?hosted_button_id=CR6YF7KLQWQ5E).
# Misskey Notifications
## Overview
* **Source:** [https://misskey-hub.net/](https://misskey-hub.net/)
* **Image Support:** No
* **Attachment Support:** No
* **Message Character Limits:**
* Body: 500
* [ Build Your Apprise URL](/url-builder/?schema=misskey)
## Account Setup
...
* `WARNING - Failed to send Misskey notification: error=403.`
