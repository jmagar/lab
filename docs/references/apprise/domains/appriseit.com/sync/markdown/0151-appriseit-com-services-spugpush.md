SpugPush Notifications | Apprise Documentation
[Skip to content](#_top)
If Apprise helps you, please consider supporting the project: [GitHub Sponsors](https://github.com/sponsors/caronc) or [PayPal](https://www.paypal.com/donate/?hosted_button_id=CR6YF7KLQWQ5E).
# SpugPush Notifications
## Overview
* **Source:** [https://push.spug.dev/](https://push.spug.dev/)
* **Image Support:** No
* **Attachment Support:** No
* **Message Character Limits:**
* Body: 10000
* [ Build Your Apprise URL](/url-builder/?schema=spugpush)
## Account Setup
...
### Apprise Support
[Section titled “Apprise Support”](#apprise-support)
...
You may also use the query format: `spugpush://?token=YOUR\_TOKEN`.
### Global Parameters
