Version 7.2.0 2025-10-29 | Unraid Docs
...
For other known issues, see the [7.1.4 release notes](/unraid-os/release-notes/7.1.4/#known-issues).
### Rolling back[​](#rolling-back)
If rolling back earlier than 7.1.4, also see the [7.1.4 release notes](/unraid-os/release-notes/7.1.4/#rolling-back).
## Changes vs. [7.1.4](/unraid-os/release-notes/7.1.4/)[​](#changes-vs-714)
### Storage[​](#storage)
#### ZFS RAIDZ expansion[​](#zfs-raidz-expansion)
...
#### Other networking changes[​](#other-networking-changes)
...
#### Other VM changes[​](#other-vm-changes)
...
The Unraid API is fully open source: [https://github.com/unraid/api](https://github.com/unraid/api). Get started in the [API docs](/API/).
The Unraid Connect plugin adds functionality which communicates with our cloud servers; it remains completely optional.
#### Other Unraid API changes[​](#other-unraid-api-changes)
...
#### Login to the webGUI via SSO[​](#login-to-the-webgui-via-sso)
Login to the Unraid webGUI using Single Sign-On (SSO) with your Unraid.net account or any other OIDC-compliant provider. For details on this *optional* feature, see [OIDC Provider Setup](/API/oidc-provider-setup/) in the Docs.
#### Other WebGUI changes[​](#other-webgui-changes)
...
* [Known issues](#known-issues)
* [Rolling back](#rolling-back)
* [Changes vs. 7.1.4](#changes-vs-714)
* [Storage](#storage)
* [Networking](#networking)
* [VM Manager](#vm-manager)
* [Unraid API](#unraid-api)
