...
```
`{
"access\_token": "eyJhbGciOiJSUzI1NiIs...",
...
OAUTH\_CLIENT\_SECRET: str = os.getenv("OAUTH\_CLIENT\_SECRET", "UO3rmozkFFkXr0QxPTkzZ0LMXDidIikB")
# Server settings
