...
* PR for creation of WG into `docs/community//overview.mdx`, gated by CODEOWNERS requiring approval by Maintainers
\* PR for charter into `docs/community//charter.mdx`, gated by CODEOWNERS requiring approval from a single Core Maintainer (who should notify all Core Maintainers)
...
4. Existing WGs and IGs must create conforming charters at `docs/community//charter.mdx` within 8 weeks of acceptance