SEP-2148: MCP Contributor Ladder - Model Context Protocol
## > Documentation Index
...
2. Creating nomination issue templates in `.github/ISSUE\_TEMPLATE/` (see Appendix for checklist templates)
