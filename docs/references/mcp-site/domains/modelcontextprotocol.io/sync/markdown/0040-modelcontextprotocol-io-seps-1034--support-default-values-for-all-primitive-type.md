SEP-1034: Support default values for all primitive types in elicitation schemas - Model Context Protocol
## > Documentation Index
...
```
`def reply\_to\_email\_thread(
thread\_id: str,
content: str,
recipient\_list: List[str] = [],
cc\_list: List[str] = []
) -\> None:
