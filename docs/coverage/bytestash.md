...
**Source spec:** docs/api-specs/bytestash.md
...
|---------|----------------|
| How to fetch the spec from your own instance | See source file |
| Quick reference (high-level endpoint groups) | See source file |
| Implementation note for `lab-apis` | See source file |
