...
Updates a bundle. When using PUT, all fields except read-only ones should be provided. When using PATCH, only the fields that should be updated need to be provided.
