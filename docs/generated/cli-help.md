...
Generated by `lab docs generate` from clap command definitions. Do not edit by hand.
...
Options:
      ...
      --log-level <LOG_LEVEL>
          Override the log filter level for this process. Sets `LAB_LOG=lab=<level>,warn` before tracing init. Example: `--log-level debug`
