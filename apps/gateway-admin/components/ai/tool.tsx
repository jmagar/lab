...
export const ToolHeader = ({ className, title, type, state, ...props }: ToolHeaderProps) => (
  ...
  >
    <div className="flex items-center gap-2">
      <WrenchIcon className="size-4 text-aurora-text-muted" />
...
export const ToolInput = ({ className, input, ...props }: ToolInputProps) => (
  <div className={cn("space-y-2 overflow-hidden p-4", className)} {...props}>
    <h4 className="font-medium text-aurora-text-muted text-xs uppercase tracking-wide">
      Parameters
    </h4>
    ...
    <div className={cn("space-y-2 p-4", className)} {...props}>
      ...
      <div
        className={cn(
          ...
          errorText ? "bg-destructive/10 text-destructive" : "bg-aurora-panel-muted/50 text-aurora-text",
        )}
      >
