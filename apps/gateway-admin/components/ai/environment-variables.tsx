...
export const EnvironmentVariablesToggle = ({
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <span className="text-aurora-text-muted text-xs">
...
export const EnvironmentVariableValue = ({
  ...
  return (
    <span
      className={cn(
        "truncate font-mono text-aurora-text-muted text-sm",
    ...
    <div className="w-full max-w-lg p-4">
      <EnvironmentVariables>
        ...
        <EnvironmentVariablesContent>
          <EnvironmentVariable name="OPENAI_API_KEY" value="openai-api-key-placeholder">
