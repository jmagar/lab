...
pub fn mcp_help(catalog: &crate::catalog::Catalog) -> String {
    let mut out = header("mcp-help", "lab docs generate");
...
pub fn cli_help() -> String {
    ...
    write_cli_command(&mut out, &mut command, "lab");
    out
}

pub fn service_catalog(services: &[ServiceDoc]) -> String {
    let mut out = header("service-catalog", "lab docs generate");
...
pub fn env_reference(vars: &[EnvDoc]) -> String {
    let mut out = header("env-reference", "lab docs generate");
...
pub fn action_catalog(actions: &[ActionDoc]) -> String {
    let mut out = header("action-catalog", "lab docs generate");
    out.push_str(
...
pub fn feature_matrix(matrix: &FeatureMatrix) -> String {
    let mut out = header("feature-matrix", "lab docs generate");
...
pub fn api_routes(routes: &[RouteDoc]) -> String {
    let mut out = header("api-routes", "lab docs generate");
    out.push_str(
...
pub fn onboarding_audit(report: &crate::audit::AuditReport) -> String {
    let mut out = header("onboarding-audit", "lab docs generate");
...
pub fn generated_readme() -> String {
    ...
    for artifact in [
        ...
        writeln!(out, "| `{artifact}` | `lab docs generate` |").ok();
    }
    out
}
